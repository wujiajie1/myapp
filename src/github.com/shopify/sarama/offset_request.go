...
func (b *offsetRequestBlock) encode(pe vendor.packetEncoder, version int16) error {
...
func (b *offsetRequestBlock) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (r *OffsetRequest) encode(pe vendor.packetEncoder) error {
	if r.isReplicaIDSet {
...
func (r *OffsetRequest) decode(pd vendor.packetDecoder, version int16) error {
	r.Version = version
...
func (r *OffsetRequest) requiredVersion() vendor.KafkaVersion {
	switch r.Version {
	case 1:
