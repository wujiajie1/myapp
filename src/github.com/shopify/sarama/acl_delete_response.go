...
func (d *DeleteAclsResponse) encode(pe vendor.packetEncoder) error {
...
func (d *DeleteAclsResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (d *DeleteAclsResponse) requiredVersion() vendor.KafkaVersion {
...
func (f *FilterResponse) encode(pe vendor.packetEncoder, version int16) error {
...
func (f *FilterResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
	kerr, err := pd.getInt16()
	if err != nil {
		return err
	}
	f.Err = vendor.KError(kerr)
...
func (m *MatchingAcl) encode(pe vendor.packetEncoder, version int16) error {
...
func (m *MatchingAcl) decode(pd vendor.packetDecoder, version int16) (err error) {
	kerr, err := pd.getInt16()
	if err != nil {
		return err
	}
	m.Err = vendor.KError(kerr)
