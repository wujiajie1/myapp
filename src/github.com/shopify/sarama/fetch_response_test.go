...
func TestEmptyFetchResponse(t *testing.T) {
	response := vendor.FetchResponse{}
	vendor.testVersionDecodable(t, "empty", &response, emptyFetchResponse, 0)
...
func TestOneMessageFetchResponse(t *testing.T) {
	response := vendor.FetchResponse{}
	vendor.testVersionDecodable(t, "one message", &response, oneMessageFetchResponse, 0)
	...
	if block.Err != vendor.ErrOffsetOutOfRange {
	...
	msg := msgBlock.Msg
	if msg.Codec != vendor.CompressionNone {
...
func TestOverflowMessageFetchResponse(t *testing.T) {
	response := vendor.FetchResponse{}
	vendor.testVersionDecodable(t, "overflow message", &response, overflowMessageFetchResponse, 0)
...
func TestOneRecordFetchResponse(t *testing.T) {
	response := vendor.FetchResponse{}
	vendor.testVersionDecodable(t, "one record", &response, oneRecordFetchResponse, 4)
...
func TestOneMessageFetchResponseV4(t *testing.T) {
	response := vendor.FetchResponse{}
	vendor.testVersionDecodable(t, "one message v4", &response, oneMessageFetchResponseV4, 4)
