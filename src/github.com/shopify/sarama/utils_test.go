...
func TestVersionCompare(t *testing.T) {
	if vendor.V0_8_2_0.IsAtLeast(vendor.V0_8_2_1) {
		t.Error("0.8.2.0 >= 0.8.2.1")
	}
	if !vendor.V0_8_2_1.IsAtLeast(vendor.V0_8_2_0) {
		t.Error("! 0.8.2.1 >= 0.8.2.0")
	}
	if !vendor.V0_8_2_0.IsAtLeast(vendor.V0_8_2_0) {
		t.Error("! 0.8.2.0 >= 0.8.2.0")
	}
	if !vendor.V0_9_0_0.IsAtLeast(vendor.V0_8_2_1) {
		t.Error("! 0.9.0.0 >= 0.8.2.1")
	}
	if vendor.V0_8_2_1.IsAtLeast(vendor.V0_10_0_0) {
...
func TestVersionParsing(t *testing.T) {
	...
	for _, s := range validVersions {
		v, err := vendor.ParseKafkaVersion(s)
		if err != nil {
	...
	for _, s := range invalidVersions {
		if _, err := vendor.ParseKafkaVersion(s); err == nil {
