...
func (a *EndTxnRequest) encode(pe vendor.packetEncoder) error {
...
func (a *EndTxnRequest) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (a *EndTxnRequest) requiredVersion() vendor.KafkaVersion {
