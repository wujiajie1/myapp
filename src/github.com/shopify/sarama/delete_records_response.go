...
func (d *DeleteRecordsResponse) encode(pe vendor.packetEncoder) error {
...
func (d *DeleteRecordsResponse) decode(pd vendor.packetDecoder, version int16) error {
	d.Version = version
...
func (d *DeleteRecordsResponse) requiredVersion() vendor.KafkaVersion {
...
func (t *DeleteRecordsResponseTopic) encode(pe vendor.packetEncoder) error {
...
func (t *DeleteRecordsResponseTopic) decode(pd vendor.packetDecoder, version int16) error {
	n, err := pd.getArrayLength()
	if err != nil {
		return err
	}
...
func (t *DeleteRecordsResponsePartition) encode(pe vendor.packetEncoder) error {
	pe.putInt64(t.LowWatermark)
	pe.putInt16(int16(t.Err))
	return nil
}

func (t *DeleteRecordsResponsePartition) decode(pd vendor.packetDecoder, version int16) error {
