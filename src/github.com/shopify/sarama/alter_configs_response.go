...
func (a *AlterConfigsResponse) encode(pe vendor.packetEncoder) error {
...
func (a *AlterConfigsResponse) decode(pd vendor.packetDecoder, version int16) error {
	...
	for i := range a.Resources {
		...
		a.Resources[i].Type = vendor.ConfigResourceType(t)
...
func (a *AlterConfigsResponse) requiredVersion() vendor.KafkaVersion {
