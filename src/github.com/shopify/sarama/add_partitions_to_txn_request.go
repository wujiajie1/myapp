...
func (a *AddPartitionsToTxnRequest) encode(pe vendor.packetEncoder) error {
...
func (a *AddPartitionsToTxnRequest) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (a *AddPartitionsToTxnRequest) requiredVersion() vendor.KafkaVersion {
