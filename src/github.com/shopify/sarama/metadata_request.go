...
func (r *MetadataRequest) encode(pe vendor.packetEncoder) error {
	if r.Version < 0 || r.Version > 5 {
		return vendor.PacketEncodingError{"invalid or unsupported MetadataRequest version field"}
	}
...
func (r *MetadataRequest) decode(pd vendor.packetDecoder, version int16) error {
	r.Version = version
...
func (r *MetadataRequest) requiredVersion() vendor.KafkaVersion {
	switch r.Version {
	case 1:
