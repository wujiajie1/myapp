...
type Partitioner interface {
	...
	Partition(message *vendor.ProducerMessage, numPartitions int32) (int32, error)
...
type DynamicConsistencyPartitioner interface {
	...
	MessageRequiresConsistency(message *vendor.ProducerMessage) bool
}
...
func (p *manualPartitioner) Partition(message *vendor.ProducerMessage, numPartitions int32) (int32, error) {
...
func (p *randomPartitioner) Partition(message *vendor.ProducerMessage, numPartitions int32) (int32, error) {
...
func (p *roundRobinPartitioner) Partition(message *vendor.ProducerMessage, numPartitions int32) (int32, error) {
...
func (p *hashPartitioner) Partition(message *vendor.ProducerMessage, numPartitions int32) (int32, error) {
	if message.Key == nil {
...
func (p *hashPartitioner) MessageRequiresConsistency(message *vendor.ProducerMessage) bool {
