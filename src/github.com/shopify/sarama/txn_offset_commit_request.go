...
func (t *TxnOffsetCommitRequest) encode(pe vendor.packetEncoder) error {
...
func (t *TxnOffsetCommitRequest) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (a *TxnOffsetCommitRequest) requiredVersion() vendor.KafkaVersion {
...
func (p *PartitionOffsetMetadata) encode(pe vendor.packetEncoder) error {
...
func (p *PartitionOffsetMetadata) decode(pd vendor.packetDecoder, version int16) (err error) {
