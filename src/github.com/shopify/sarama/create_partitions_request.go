...
func (c *CreatePartitionsRequest) encode(pe vendor.packetEncoder) error {
...
func (c *CreatePartitionsRequest) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (r *CreatePartitionsRequest) requiredVersion() vendor.KafkaVersion {
...
func (t *TopicPartition) encode(pe vendor.packetEncoder) error {
	pe.putInt32(t.Count)
...
func (t *TopicPartition) decode(pd vendor.packetDecoder, version int16) (err error) {
