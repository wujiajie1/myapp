...
func (d *DeleteRecordsRequest) encode(pe vendor.packetEncoder) error {
...
func (d *DeleteRecordsRequest) decode(pd vendor.packetDecoder, version int16) error {
...
func (d *DeleteRecordsRequest) requiredVersion() vendor.KafkaVersion {
...
func (t *DeleteRecordsRequestTopic) encode(pe vendor.packetEncoder) error {
...
func (t *DeleteRecordsRequestTopic) decode(pd vendor.packetDecoder, version int16) error {
	n, err := pd.getArrayLength()
	if err != nil {
		return err
	}
