...
func (l *lengthField) decode(pd vendor.packetDecoder) error {
	var err error
...
func (l *lengthField) check(curOffset int, buf []byte) error {
	if int32(curOffset-l.startOffset-4) != l.length {
		return vendor.PacketDecodingError{"length field invalid"}
	}
...
func (l *varintLengthField) decode(pd vendor.packetDecoder) error {
	var err error
