...
type BalanceStrategy interface {
	...
	Plan(members map[string]vendor.ConsumerGroupMemberMetadata, topics map[string][]int32) (BalanceStrategyPlan, error)
}
...
func (s *balanceStrategy) Plan(members map[string]vendor.ConsumerGroupMemberMetadata, topics map[string][]int32) (BalanceStrategyPlan, error) {
