...
func (a *AddPartitionsToTxnResponse) encode(pe vendor.packetEncoder) error {
...
func (a *AddPartitionsToTxnResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (a *AddPartitionsToTxnResponse) requiredVersion() vendor.KafkaVersion {
...
func (p *PartitionError) encode(pe vendor.packetEncoder) error {
	pe.putInt32(p.Partition)
	pe.putInt16(int16(p.Err))
	return nil
}

func (p *PartitionError) decode(pd vendor.packetDecoder, version int16) (err error) {
