...
func (a *AddOffsetsToTxnRequest) encode(pe vendor.packetEncoder) error {
...
func (a *AddOffsetsToTxnRequest) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (a *AddOffsetsToTxnRequest) requiredVersion() vendor.KafkaVersion {
