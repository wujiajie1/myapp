...
func (r *DescribeGroupsResponse) encode(pe vendor.packetEncoder) error {
...
func (r *DescribeGroupsResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (r *DescribeGroupsResponse) requiredVersion() vendor.KafkaVersion {
...
func (gd *GroupDescription) encode(pe vendor.packetEncoder) error {
...
func (gd *GroupDescription) decode(pd vendor.packetDecoder) (err error) {
	kerr, err := pd.getInt16()
	if err != nil {
		return err
	}

	gd.Err = vendor.KError(kerr)
...
func (gmd *GroupMemberDescription) encode(pe vendor.packetEncoder) error {
...
func (gmd *GroupMemberDescription) decode(pd vendor.packetDecoder) (err error) {
...
func (gmd *GroupMemberDescription) GetMemberAssignment() (*vendor.ConsumerGroupMemberAssignment, error) {
	assignment := new(vendor.ConsumerGroupMemberAssignment)
	err := vendor.decode(gmd.MemberAssignment, assignment)
	return assignment, err
}

func (gmd *GroupMemberDescription) GetMemberMetadata() (*vendor.ConsumerGroupMemberMetadata, error) {
	metadata := new(vendor.ConsumerGroupMemberMetadata)
	err := vendor.decode(gmd.MemberMetadata, metadata)
	return metadata, err
}
