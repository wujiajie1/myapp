...
func (c *CreatePartitionsResponse) encode(pe vendor.packetEncoder) error {
...
func (c *CreatePartitionsResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (r *CreatePartitionsResponse) requiredVersion() vendor.KafkaVersion {
...
func (t *TopicPartitionError) encode(pe vendor.packetEncoder) error {
...
func (t *TopicPartitionError) decode(pd vendor.packetDecoder, version int16) (err error) {
