...
func (c *CreateTopicsRequest) encode(pe vendor.packetEncoder) error {
...
func (c *CreateTopicsRequest) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (c *CreateTopicsRequest) requiredVersion() vendor.KafkaVersion {
	switch c.Version {
	case 2:
...
func (t *TopicDetail) encode(pe vendor.packetEncoder) error {
...
func (t *TopicDetail) decode(pd vendor.packetDecoder, version int16) (err error) {
