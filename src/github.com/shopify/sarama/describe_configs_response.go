...
func (r *DescribeConfigsResponse) encode(pe vendor.packetEncoder) (err error) {
...
func (r *DescribeConfigsResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
	r.Version = version
...
func (r *DescribeConfigsResponse) requiredVersion() vendor.KafkaVersion {
	switch r.Version {
	case 1:
...
func (r *ResourceResponse) encode(pe vendor.packetEncoder, version int16) (err error) {
...
func (r *ResourceResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
	ec, err := pd.getInt16()
	if err != nil {
		return err
	}
	...
	r.Type = vendor.ConfigResourceType(t)
...
func (r *ConfigEntry) encode(pe vendor.packetEncoder, version int16) (err error) {
	if err = pe.putString(r.Name); err != nil {
		return err
	}
...
func (r *ConfigEntry) decode(pd vendor.packetDecoder, version int16) (err error) {
	if version == 0 {
...
func (c *ConfigSynonym) encode(pe vendor.packetEncoder, version int16) (err error) {
...
func (c *ConfigSynonym) decode(pd vendor.packetDecoder, version int16) error {
	name, err := pd.getString()
	if err != nil {
		return nil
	}
