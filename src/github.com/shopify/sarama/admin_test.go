...
func TestClusterAdmin(t *testing.T) {
	...
	admin, err := vendor.NewClusterAdmin([]string{seedBroker.Addr()}, config)
	if err != nil {
		t.Fatal(err)
	}
...
func TestClusterAdminInvalidController(t *testing.T) {
	...
	config := vendor.NewConfig()
	config.Version = vendor.V1_0_0_0
	_, err := vendor.NewClusterAdmin([]string{seedBroker.Addr()}, config)
	if err == nil {
		t.Fatal(errors.New("controller not set still cluster admin was created"))
	}

	if err != vendor.ErrControllerNotAvailable {
		t.Fatal(err)
	}
}
...
func TestClusterAdminCreateTopic(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"CreateTopicsRequest": vendor.NewMockCreateTopicsResponse(t),
	})

	config := vendor.NewConfig()
	config.Version = vendor.V0_10_2_0
	admin, err := vendor.NewClusterAdmin([]string{seedBroker.Addr()}, config)
	if err != nil {
		t.Fatal(err)
	}
	err = admin.CreateTopic("my_topic", &vendor.TopicDetail{NumPartitions: 1, ReplicationFactor: 1}, false)
	if err != nil {
		t.Fatal(err)
	}
...
func TestClusterAdminCreateTopicWithoutAuthorization(t *testing.T) {
	...
	err = admin.CreateTopic("_internal_topic", &vendor.TopicDetail{NumPartitions: 1, ReplicationFactor: 1}, false)
...
func TestClusterAdminListTopics(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		...
		"DescribeConfigsRequest": vendor.NewMockDescribeConfigsResponse(t),
	})
...
func TestClusterAdminDeleteTopic(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"DeleteTopicsRequest": vendor.NewMockDeleteTopicsResponse(t),
	})
...
func TestClusterAdminCreatePartitions(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"CreatePartitionsRequest": vendor.NewMockCreatePartitionsResponse(t),
	})
...
func TestClusterAdminCreatePartitionsWithDiffVersion(t *testing.T) {
	...
	err = admin.CreatePartitions("my_topic", 3, nil, false)
	if err != vendor.ErrUnsupportedVersion {
		t.Fatal(err)
	}
...
func TestClusterAdminDeleteRecords(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"DeleteRecordsRequest": vendor.NewMockDeleteRecordsResponse(t),
	})
...
func TestClusterAdminDescribeConfig(t *testing.T) {
	...
	resource := vendor.ConfigResource{Name: "r1", Type: vendor.TopicResource, ConfigNames: []string{"my_topic"}}
...
func TestClusterAdminAlterConfig(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"AlterConfigsRequest": vendor.NewMockAlterConfigsResponse(t),
	})
	...
	err = admin.AlterConfig(vendor.TopicResource, "my_topic", entries, false)
	if err != nil {
		t.Fatal(err)
	}
...
func TestClusterAdminCreateAcl(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"CreateAclsRequest": vendor.NewMockCreateAclsResponse(t),
	})
	...
	r := vendor.Resource{ResourceType: vendor.AclResourceTopic, ResourceName: "my_topic"}
	a := vendor.Acl{Host: "localhost", Operation: vendor.AclOperationAlter, PermissionType: vendor.AclPermissionAny}
...
func TestClusterAdminListAcls(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"DescribeAclsRequest": vendor.NewMockListAclsResponse(t),
		"CreateAclsRequest":   vendor.NewMockCreateAclsResponse(t),
	})
	...
	filter := vendor.AclFilter{
		ResourceType: vendor.AclResourceTopic,
		Operation:    vendor.AclOperationRead,
...
func TestClusterAdminDeleteAcl(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"DeleteAclsRequest": vendor.NewMockDeleteAclsResponse(t),
	})
	...
	filter := vendor.AclFilter{
		ResourceType: vendor.AclResourceTopic,
		Operation:    vendor.AclOperationAlter,
		ResourceName: &resourceName,
	}
...
func TestDescribeConsumerGroup(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"DescribeGroupsRequest": vendor.NewMockDescribeGroupsResponse(t).AddGroupDescription(expectedGroupID, &vendor.GroupDescription{
			GroupId: expectedGroupID,
		}),
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"FindCoordinatorRequest": vendor.NewMockFindCoordinatorResponse(t).SetCoordinator(vendor.CoordinatorGroup, expectedGroupID, seedBroker),
	})
...
func TestListConsumerGroups(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"ListGroupsRequest": vendor.NewMockListGroupsResponse(t).
...
func TestListConsumerGroupsMultiBroker(t *testing.T) {
	...
	secondBroker := vendor.NewMockBroker(t, 2)
	...
	secondBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()).
			SetBroker(secondBroker.Addr(), secondBroker.BrokerID()),
...
func TestListConsumerGroupOffsets(t *testing.T) {
	...
	seedBroker.SetHandlerByMap(map[string]vendor.MockResponse{
		"OffsetFetchRequest": vendor.NewMockOffsetFetchResponse(t).SetOffset(group, "my-topic", partition, expectedOffset, "", vendor.ErrNoError),
		"MetadataRequest": vendor.NewMockMetadataResponse(t).
			SetController(seedBroker.BrokerID()).
			SetBroker(seedBroker.Addr(), seedBroker.BrokerID()),
		"FindCoordinatorRequest": vendor.NewMockFindCoordinatorResponse(t).SetCoordinator(vendor.CoordinatorGroup, group, seedBroker),
	})
