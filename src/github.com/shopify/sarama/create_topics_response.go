...
func (c *CreateTopicsResponse) encode(pe vendor.packetEncoder) error {
	if c.Version >= 2 {
...
func (c *CreateTopicsResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
	c.Version = version
...
func (c *CreateTopicsResponse) requiredVersion() vendor.KafkaVersion {
	switch c.Version {
	case 2:
...
func (t *TopicError) encode(pe vendor.packetEncoder, version int16) error {
...
func (t *TopicError) decode(pd vendor.packetDecoder, version int16) (err error) {
