...
type Broker struct {
	...
	incomingByteRate       vendor.Meter
	requestRate            vendor.Meter
	requestSize            vendor.Histogram
	requestLatency         vendor.Histogram
	outgoingByteRate       vendor.Meter
	responseRate           vendor.Meter
	responseSize           vendor.Histogram
	brokerIncomingByteRate vendor.Meter
	brokerRequestRate      vendor.Meter
	brokerRequestSize      vendor.Histogram
	brokerRequestLatency   vendor.Histogram
	brokerOutgoingByteRate vendor.Meter
	brokerResponseRate     vendor.Meter
	brokerResponseSize     vendor.Histogram
}
...
func (b *Broker) Open(conf *vendor.Config) error {
	if !atomic.CompareAndSwapInt32(&b.opened, 0, 1) {
		return vendor.ErrAlreadyConnected
	}
	...
	go vendor.withRecover(func() {
		...
		if b.connErr != nil {
			vendor.Logger.Printf("Failed to connect to broker %s: %s\n", b.addr, b.connErr)
			b.conn = nil
			atomic.StoreInt32(&b.opened, 0)
			return
		}
		b.conn = vendor.newBufConn(b.conn)

		b.conf = conf

		// Create or reuse the global metrics shared between brokers
		b.incomingByteRate = vendor.GetOrRegisterMeter("incoming-byte-rate", conf.MetricRegistry)
		b.requestRate = vendor.GetOrRegisterMeter("request-rate", conf.MetricRegistry)
		b.requestSize = vendor.getOrRegisterHistogram("request-size", conf.MetricRegistry)
		b.requestLatency = vendor.getOrRegisterHistogram("request-latency-in-ms", conf.MetricRegistry)
		b.outgoingByteRate = vendor.GetOrRegisterMeter("outgoing-byte-rate", conf.MetricRegistry)
		b.responseRate = vendor.GetOrRegisterMeter("response-rate", conf.MetricRegistry)
		b.responseSize = vendor.getOrRegisterHistogram("response-size", conf.MetricRegistry)
		...
		if conf.Net.SASL.Enable {
			...
			if b.connErr != nil {
				err = b.conn.Close()
				if err == nil {
					vendor.Logger.Printf("Closed connection to broker %s\n", b.addr)
				} else {
					vendor.Logger.Printf("Error while closing connection to broker %s: %s\n", b.addr, err)
				}
				b.conn = nil
				atomic.StoreInt32(&b.opened, 0)
				return
		...
		if b.id >= 0 {
			vendor.Logger.Printf("Connected to broker at %s (registered as #%d)\n", b.addr, b.id)
		} else {
			vendor.Logger.Printf("Connected to broker at %s (unregistered)\n", b.addr)
		}
		go vendor.withRecover(b.responseReceiver)
	})
...
func (b *Broker) GetMetadata(request *vendor.MetadataRequest) (*vendor.MetadataResponse, error) {
	response := new(vendor.MetadataResponse)
...
func (b *Broker) GetConsumerMetadata(request *vendor.ConsumerMetadataRequest) (*vendor.ConsumerMetadataResponse, error) {
	response := new(vendor.ConsumerMetadataResponse)
...
func (b *Broker) FindCoordinator(request *vendor.FindCoordinatorRequest) (*vendor.FindCoordinatorResponse, error) {
	response := new(vendor.FindCoordinatorResponse)
...
func (b *Broker) GetAvailableOffsets(request *vendor.OffsetRequest) (*vendor.OffsetResponse, error) {
	response := new(vendor.OffsetResponse)
...
func (b *Broker) Produce(request *vendor.ProduceRequest) (*vendor.ProduceResponse, error) {
	var (
		response *vendor.ProduceResponse
		err      error
	)

	if request.RequiredAcks == vendor.NoResponse {
		err = b.sendAndReceive(request, nil)
	} else {
		response = new(vendor.ProduceResponse)
		err = b.sendAndReceive(request, response)
	}
...
func (b *Broker) Fetch(request *vendor.FetchRequest) (*vendor.FetchResponse, error) {
	response := new(vendor.FetchResponse)
...
func (b *Broker) CommitOffset(request *vendor.OffsetCommitRequest) (*vendor.OffsetCommitResponse, error) {
	response := new(vendor.OffsetCommitResponse)
...
func (b *Broker) FetchOffset(request *vendor.OffsetFetchRequest) (*vendor.OffsetFetchResponse, error) {
	response := new(vendor.OffsetFetchResponse)
...
func (b *Broker) JoinGroup(request *vendor.JoinGroupRequest) (*vendor.JoinGroupResponse, error) {
	response := new(vendor.JoinGroupResponse)
...
func (b *Broker) SyncGroup(request *vendor.SyncGroupRequest) (*vendor.SyncGroupResponse, error) {
...
func (b *Broker) LeaveGroup(request *vendor.LeaveGroupRequest) (*vendor.LeaveGroupResponse, error) {
...
func (b *Broker) Heartbeat(request *vendor.HeartbeatRequest) (*vendor.HeartbeatResponse, error) {
...
func (b *Broker) ListGroups(request *vendor.ListGroupsRequest) (*vendor.ListGroupsResponse, error) {
...
func (b *Broker) DescribeGroups(request *vendor.DescribeGroupsRequest) (*vendor.DescribeGroupsResponse, error) {
	response := new(vendor.DescribeGroupsResponse)
...
func (b *Broker) ApiVersions(request *vendor.ApiVersionsRequest) (*vendor.ApiVersionsResponse, error) {
	response := new(vendor.ApiVersionsResponse)
...
func (b *Broker) CreateTopics(request *vendor.CreateTopicsRequest) (*vendor.CreateTopicsResponse, error) {
	response := new(vendor.CreateTopicsResponse)
...
func (b *Broker) DeleteTopics(request *vendor.DeleteTopicsRequest) (*vendor.DeleteTopicsResponse, error) {
	response := new(vendor.DeleteTopicsResponse)
...
func (b *Broker) CreatePartitions(request *vendor.CreatePartitionsRequest) (*vendor.CreatePartitionsResponse, error) {
	response := new(vendor.CreatePartitionsResponse)
...
//response or error
func (b *Broker) DeleteRecords(request *vendor.DeleteRecordsRequest) (*vendor.DeleteRecordsResponse, error) {
	response := new(vendor.DeleteRecordsResponse)
...
func (b *Broker) DescribeAcls(request *vendor.DescribeAclsRequest) (*vendor.DescribeAclsResponse, error) {
	response := new(vendor.DescribeAclsResponse)
...
func (b *Broker) CreateAcls(request *vendor.CreateAclsRequest) (*vendor.CreateAclsResponse, error) {
	response := new(vendor.CreateAclsResponse)
...
func (b *Broker) DeleteAcls(request *vendor.DeleteAclsRequest) (*vendor.DeleteAclsResponse, error) {
	response := new(vendor.DeleteAclsResponse)
...
func (b *Broker) InitProducerID(request *vendor.InitProducerIDRequest) (*vendor.InitProducerIDResponse, error) {
	response := new(vendor.InitProducerIDResponse)
...
//a response or error
func (b *Broker) AddPartitionsToTxn(request *vendor.AddPartitionsToTxnRequest) (*vendor.AddPartitionsToTxnResponse, error) {
	response := new(vendor.AddPartitionsToTxnResponse)
...
//or error
func (b *Broker) AddOffsetsToTxn(request *vendor.AddOffsetsToTxnRequest) (*vendor.AddOffsetsToTxnResponse, error) {
	response := new(vendor.AddOffsetsToTxnResponse)
...
func (b *Broker) EndTxn(request *vendor.EndTxnRequest) (*vendor.EndTxnResponse, error) {
	response := new(vendor.EndTxnResponse)
...
//a response or error
func (b *Broker) TxnOffsetCommit(request *vendor.TxnOffsetCommitRequest) (*vendor.TxnOffsetCommitResponse, error) {
	response := new(vendor.TxnOffsetCommitResponse)
...
//error
func (b *Broker) DescribeConfigs(request *vendor.DescribeConfigsRequest) (*vendor.DescribeConfigsResponse, error) {
	response := new(vendor.DescribeConfigsResponse)
...
func (b *Broker) AlterConfigs(request *vendor.AlterConfigsRequest) (*vendor.AlterConfigsResponse, error) {
	response := new(vendor.AlterConfigsResponse)
...
func (b *Broker) DeleteGroups(request *vendor.DeleteGroupsRequest) (*vendor.DeleteGroupsResponse, error) {
...
func (b *Broker) send(rb vendor.protocolBody, promiseResponse bool) (*responsePromise, error) {
	b.lock.Lock()
	defer b.lock.Unlock()
	...
	if b.conn == nil {
		...
		return nil, vendor.ErrNotConnected
	}

	if !b.conf.Version.IsAtLeast(rb.requiredVersion()) {
		return nil, vendor.ErrUnsupportedVersion
	}

	req := &vendor.request{correlationID: b.correlationID, clientID: b.conf.ClientID, body: rb}
	buf, err := vendor.encode(req, b.conf.MetricRegistry)
	if err != nil {
		return nil, err
	}
...
func (b *Broker) sendAndReceive(req vendor.protocolBody, res vendor.versionedDecoder) error {
	...
	case buf := <-promise.packets:
		return vendor.versionedDecode(buf, res, req.version())
	case err = <-promise.errors:
		return err
	}
}

func (b *Broker) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (b *Broker) encode(pe vendor.packetEncoder, version int16) (err error) {
...
func (b *Broker) responseReceiver() {
	...
	for response := range b.responses {
		...
		decodedHeader := vendor.responseHeader{}
		err = vendor.decode(header, &decodedHeader)
		if err != nil {
			b.updateIncomingCommunicationMetrics(bytesReadHeader, requestLatency)
			dead = err
			response.errors <- err
		...
		if decodedHeader.correlationID != response.correlationID {
			...
			dead = vendor.PacketDecodingError{fmt.Sprintf("correlation ID didn't match, wanted %d, got %d", response.correlationID, decodedHeader.correlationID)}
			response.errors <- dead
			continue
		}
...
func (b *Broker) sendAndReceiveSASLHandshake(saslType SASLMechanism, version int16) error {
	rb := &vendor.SaslHandshakeRequest{Mechanism: string(saslType), Version: version}
	...
	if err != nil {
		vendor.Logger.Printf("Failed to send SASL handshake %s: %s\n", b.addr, err.Error())
		return err
	}
	b.correlationID++
	...
	if err != nil {
		vendor.Logger.Printf("Failed to read SASL handshake header : %s\n", err.Error())
		return err
	}
	...
	if err != nil {
		vendor.Logger.Printf("Failed to read SASL handshake payload : %s\n", err.Error())
		return err
	}
	...
	err = vendor.versionedDecode(payload, res, 0)
	if err != nil {
		vendor.Logger.Printf("Failed to parse SASL handshake : %s\n", err.Error())
		return err
	}

	if res.Err != vendor.ErrNoError {
		vendor.Logger.Printf("Invalid SASL Mechanism : %s\n", res.Err.Error())
		return res.Err
	}

	vendor.Logger.Print("Successful SASL handshake. Available mechanisms: ", res.EnabledMechanisms)
	return nil
}
...
func (b *Broker) sendAndReceiveSASLPlainAuth() error {
	...
	if b.conf.Net.SASL.Handshake {
		if b.conf.Version.IsAtLeast(vendor.V1_0_0_0) {
			saslHandshake = SASLHandshakeV1
		}
		handshakeErr := b.sendAndReceiveSASLHandshake(SASLTypePlaintext, saslHandshake)
		if handshakeErr != nil {
			vendor.Logger.Printf("Error while performing SASL handshake %s\n", b.addr)
			return handshakeErr
		}
	}
...
func (b *Broker) sendAndReceiveV0SASLPlainAuth() error {
	...
	err := b.conn.SetWriteDeadline(time.Now().Add(b.conf.Net.WriteTimeout))
	if err != nil {
		vendor.Logger.Printf("Failed to set write deadline when doing SASL auth with broker %s: %s\n", b.addr, err.Error())
		return err
	}
	...
	if err != nil {
		vendor.Logger.Printf("Failed to write SASL auth header to broker %s: %s\n", b.addr, err.Error())
		return err
	}
	...
	if err != nil {
		vendor.Logger.Printf("Failed to read response while authenticating with SASL to broker %s: %s\n", b.addr, err.Error())
		return err
	}

	vendor.Logger.Printf("SASL authentication successful with broker %s:%v - %v\n", b.addr, n, header)
	return nil
}
...
func (b *Broker) sendAndReceiveV1SASLPlainAuth() error {
	...
	if err != nil {
		vendor.Logger.Printf("Error returned from broker during SASL flow %s: %s\n", b.addr, err.Error())
		return err
	}
...
func (b *Broker) sendAndReceiveSASLSCRAMv1() error {
	...
	for !scramClient.Done() {
		...
		if err != nil {
			vendor.Logger.Println("SASL authentication failed", err)
			return err
		}
	}

	vendor.Logger.Println("SASL authentication succeeded")
	return nil
}

func (b *Broker) sendSaslAuthenticateRequest(correlationID int32, msg []byte) (int, error) {
	rb := &vendor.SaslAuthenticateRequest{msg}
	req := &vendor.request{correlationID: correlationID, clientID: b.conf.ClientID, body: rb}
	buf, err := vendor.encode(req, b.conf.MetricRegistry)
	if err != nil {
		return 0, err
	}
...
func (b *Broker) receiveSaslAuthenticateResponse(correlationID int32) ([]byte, error) {
	buf := make([]byte, vendor.responseLengthSize+vendor.correlationIDSize)
	_, err := io.ReadFull(b.conn, buf)
	if err != nil {
		return nil, err
	}

	header := vendor.responseHeader{}
	err = vendor.decode(buf, &header)
	if err != nil {
		return nil, err
	}
	...
	buf = make([]byte, header.length-vendor.correlationIDSize)
	_, err = io.ReadFull(b.conn, buf)
	if err != nil {
		return nil, err
	}
	...
	if err := vendor.versionedDecode(buf, res, 0); err != nil {
		return nil, err
	}
	if res.Err != vendor.ErrNoError {
		return nil, res.Err
...
func (b *Broker) sendSASLPlainAuthClientResponse(correlationID int32) (int, error) {
	...
	rb := &vendor.SaslAuthenticateRequest{authBytes}
	req := &vendor.request{correlationID: correlationID, clientID: b.conf.ClientID, body: rb}
	buf, err := vendor.encode(req, b.conf.MetricRegistry)
	if err != nil {
		return 0, err
...
func (b *Broker) sendSASLOAuthBearerClientResponse(token *AccessToken, correlationID int32) (int, error) {
	...
	rb := &vendor.SaslAuthenticateRequest{initialResp}
...
func (b *Broker) receiveSASLServerResponse(correlationID int32) (int, error) {
	...
	if len(res.SaslAuthBytes) > 0 {
		vendor.Logger.Printf("Received SASL auth response: %s", res.SaslAuthBytes)
	}
...
func (b *Broker) registerMeter(name string) vendor.Meter {
	nameForBroker := vendor.getMetricNameForBroker(name, b)
	b.registeredMetrics = append(b.registeredMetrics, nameForBroker)
	return vendor.GetOrRegisterMeter(nameForBroker, b.conf.MetricRegistry)
}

func (b *Broker) registerHistogram(name string) vendor.Histogram {
	nameForBroker := vendor.getMetricNameForBroker(name, b)
	b.registeredMetrics = append(b.registeredMetrics, nameForBroker)
	return vendor.getOrRegisterHistogram(nameForBroker, b.conf.MetricRegistry)
}
