...
func (c *CreateAclsResponse) encode(pe vendor.packetEncoder) error {
...
func (c *CreateAclsResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
...
func (c *CreateAclsResponse) requiredVersion() vendor.KafkaVersion {
...
func (a *AclCreationResponse) encode(pe vendor.packetEncoder) error {
...
func (a *AclCreationResponse) decode(pd vendor.packetDecoder, version int16) (err error) {
