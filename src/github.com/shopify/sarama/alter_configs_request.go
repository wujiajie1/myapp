...
func (a *AlterConfigsRequest) encode(pe vendor.packetEncoder) error {
...
func (a *AlterConfigsRequest) decode(pd vendor.packetDecoder, version int16) error {
...
func (a *AlterConfigsResource) encode(pe vendor.packetEncoder) error {
...
func (a *AlterConfigsResource) decode(pd vendor.packetDecoder, version int16) error {
	t, err := pd.getInt8()
	if err != nil {
		return err
	}
	a.Type = vendor.ConfigResourceType(t)
...
func (a *AlterConfigsRequest) requiredVersion() vendor.KafkaVersion {
