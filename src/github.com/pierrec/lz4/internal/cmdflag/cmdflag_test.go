...
func TestOnecmdflag(t *testing.T) {
	h1 := 0
	handle1 := func(fset *flag.FlagSet) vendor.Handler {
		return func(args ...string) error {
			h1++
			return nil
		}
	}
	vendor.New("sub1", "", "", flag.ExitOnError, handle1)
...
func TestOnecmdflagOneFlag(t *testing.T) {
	...
	vendor.New("sub1flag", "", "", flag.ExitOnError, handle1)
...
func TestGlobalFlagOnecmdflag(t *testing.T) {
	...
	vendor.New("subglobal", "", "", flag.ExitOnError, handle1)
...
func TestGlobalFlagOnecmdflagOneFlag(t *testing.T) {
	...
	vendor.New("subglobal1flag", "", "", flag.ExitOnError, handle1)
