...
func (x NullValue) String() string {
	return vendor.EnumName(NullValue_name, int32(x))
}
...
func (m *Struct) String() string { return vendor.CompactTextString(m) }
...
func (m *Struct) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Struct vendor.InternalMessageInfo
...
func (m *Value) String() string { return vendor.CompactTextString(m) }
...
func (m *Value) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Value vendor.InternalMessageInfo
...
func (m *ListValue) String() string { return vendor.CompactTextString(m) }
...
func (m *ListValue) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ListValue vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("google.protobuf.NullValue", NullValue_name, NullValue_value)
	vendor.RegisterType((*Struct)(nil), "google.protobuf.Struct")
	vendor.RegisterMapType((map[string]*Value)(nil), "google.protobuf.Struct.FieldsEntry")
	vendor.RegisterType((*Value)(nil), "google.protobuf.Value")
	vendor.RegisterType((*ListValue)(nil), "google.protobuf.ListValue")
}

func init() { vendor.RegisterFile("google/protobuf/struct.proto", fileDescriptor_df322afd6c9fb402) }
