...
func (m *DoubleValue) String() string { return vendor.CompactTextString(m) }
...
func (m *DoubleValue) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DoubleValue vendor.InternalMessageInfo
...
func (m *FloatValue) String() string { return vendor.CompactTextString(m) }
...
func (m *FloatValue) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_FloatValue vendor.InternalMessageInfo
...
func (m *Int64Value) String() string { return vendor.CompactTextString(m) }
...
func (m *Int64Value) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Int64Value vendor.InternalMessageInfo
...
func (m *UInt64Value) String() string { return vendor.CompactTextString(m) }
...
func (m *UInt64Value) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UInt64Value vendor.InternalMessageInfo
...
func (m *Int32Value) String() string { return vendor.CompactTextString(m) }
...
func (m *Int32Value) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Int32Value vendor.InternalMessageInfo
...
func (m *UInt32Value) String() string { return vendor.CompactTextString(m) }
...
func (m *UInt32Value) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UInt32Value vendor.InternalMessageInfo
...
func (m *BoolValue) String() string { return vendor.CompactTextString(m) }
...
func (m *BoolValue) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_BoolValue vendor.InternalMessageInfo
...
func (m *StringValue) String() string { return vendor.CompactTextString(m) }
...
func (m *StringValue) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StringValue vendor.InternalMessageInfo
...
func (m *BytesValue) String() string { return vendor.CompactTextString(m) }
...
func (m *BytesValue) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_BytesValue vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*DoubleValue)(nil), "google.protobuf.DoubleValue")
	vendor.RegisterType((*FloatValue)(nil), "google.protobuf.FloatValue")
	vendor.RegisterType((*Int64Value)(nil), "google.protobuf.Int64Value")
	vendor.RegisterType((*UInt64Value)(nil), "google.protobuf.UInt64Value")
	vendor.RegisterType((*Int32Value)(nil), "google.protobuf.Int32Value")
	vendor.RegisterType((*UInt32Value)(nil), "google.protobuf.UInt32Value")
	vendor.RegisterType((*BoolValue)(nil), "google.protobuf.BoolValue")
	vendor.RegisterType((*StringValue)(nil), "google.protobuf.StringValue")
	vendor.RegisterType((*BytesValue)(nil), "google.protobuf.BytesValue")
}

func init() { vendor.RegisterFile("google/protobuf/wrappers.proto", fileDescriptor_5377b62bda767935) }
