...
func (m *Version) String() string            { return vendor.CompactTextString(m) }
...
func (dst *Version) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Version vendor.InternalMessageInfo
...
type CodeGeneratorRequest struct {
	...
	// fully qualified.
	ProtoFile []*vendor.FileDescriptorProto `protobuf:"bytes,15,rep,name=proto_file,json=protoFile" json:"proto_file,omitempty"`
	// The version number of protocol compiler.
...
func (m *CodeGeneratorRequest) String() string            { return vendor.CompactTextString(m) }
...
func (dst *CodeGeneratorRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CodeGeneratorRequest vendor.InternalMessageInfo
...
func (m *CodeGeneratorRequest) GetProtoFile() []*vendor.FileDescriptorProto {
	if m != nil {
		return m.ProtoFile
	}
	return nil
...
func (m *CodeGeneratorResponse) String() string            { return vendor.CompactTextString(m) }
...
func (dst *CodeGeneratorResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CodeGeneratorResponse vendor.InternalMessageInfo
...
func (m *CodeGeneratorResponse_File) String() string            { return vendor.CompactTextString(m) }
...
func (dst *CodeGeneratorResponse_File) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CodeGeneratorResponse_File vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Version)(nil), "google.protobuf.compiler.Version")
	vendor.RegisterType((*CodeGeneratorRequest)(nil), "google.protobuf.compiler.CodeGeneratorRequest")
	vendor.RegisterType((*CodeGeneratorResponse)(nil), "google.protobuf.compiler.CodeGeneratorResponse")
	vendor.RegisterType((*CodeGeneratorResponse_File)(nil), "google.protobuf.compiler.CodeGeneratorResponse.File")
}

func init() { vendor.RegisterFile("google/protobuf/compiler/plugin.proto", fileDescriptor0) }
