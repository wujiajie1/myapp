...
func (m *UserMessage) String() string { return vendor.CompactTextString(m) }
...
func (m *UserMessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UserMessage vendor.InternalMessageInfo
...
func (m *LoudMessage) String() string { return vendor.CompactTextString(m) }
func (*LoudMessage) ProtoMessage()    {}
func (*LoudMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_359ba8abf543ca10, []int{1}
}

var extRange_LoudMessage = []vendor.ExtensionRange{
	{Start: 100, End: 536870911},
}

func (*LoudMessage) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *LoudMessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoudMessage vendor.InternalMessageInfo

var E_LoudMessage_Volume = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.BaseMessage)(nil),
...
func (m *LoginMessage) String() string { return vendor.CompactTextString(m) }
...
func (m *LoginMessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoginMessage vendor.InternalMessageInfo

var E_LoginMessage_UserMessage = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.BaseMessage)(nil),
...
func (m *Detail) String() string { return vendor.CompactTextString(m) }
...
func (m *Detail) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Detail vendor.InternalMessageInfo
...
func (m *Announcement) String() string { return vendor.CompactTextString(m) }
...
func (m *Announcement) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Announcement vendor.InternalMessageInfo
...
var E_Announcement_LoudExt = &vendor.ExtensionDesc{
...
func (m *OldStyleParcel) String() string { return vendor.CompactTextString(m) }
...
func (m *OldStyleParcel) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_OldStyleParcel vendor.InternalMessageInfo
...
var E_OldStyleParcel_MessageSetExtension = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.OldStyleMessage)(nil),
...
var E_UserMessage = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.BaseMessage)(nil),
	ExtensionType: (*UserMessage)(nil),
	Field:         5,
...
var E_ExtraMessage = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.BaseMessage)(nil),
	ExtensionType: (*vendor.ExtraMessage)(nil),
	Field:         9,
...
var E_Width = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.BaseMessage)(nil),
...
var E_Area = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.BaseMessage)(nil),
...
var E_Detail = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.BaseMessage)(nil),
...
func init() {
	vendor.RegisterType((*UserMessage)(nil), "extension_user.UserMessage")
	vendor.RegisterExtension(E_LoudMessage_Volume)
	vendor.RegisterType((*LoudMessage)(nil), "extension_user.LoudMessage")
	vendor.RegisterExtension(E_LoginMessage_UserMessage)
	vendor.RegisterType((*LoginMessage)(nil), "extension_user.LoginMessage")
	vendor.RegisterType((*Detail)(nil), "extension_user.Detail")
	vendor.RegisterExtension(E_Announcement_LoudExt)
	vendor.RegisterType((*Announcement)(nil), "extension_user.Announcement")
	vendor.RegisterExtension(E_OldStyleParcel_MessageSetExtension)
	vendor.RegisterType((*OldStyleParcel)(nil), "extension_user.OldStyleParcel")
	vendor.RegisterExtension(E_UserMessage)
	vendor.RegisterExtension(E_ExtraMessage)
	vendor.RegisterExtension(E_Width)
	vendor.RegisterExtension(E_Area)
	vendor.RegisterExtension(E_Detail)
}

func init() {
	vendor.RegisterFile("extension_user/extension_user.proto", fileDescriptor_359ba8abf543ca10)
}
