...
func (m *ExtraMessage) String() string { return vendor.CompactTextString(m) }
...
func (m *ExtraMessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ExtraMessage vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*ExtraMessage)(nil), "extension_extra.ExtraMessage")
}

func init() {
	vendor.RegisterFile("extension_extra/extension_extra.proto", fileDescriptor_fce75f5a63502cd5)
}
