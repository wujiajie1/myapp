...
func (m *BaseMessage) String() string { return vendor.CompactTextString(m) }
func (*BaseMessage) ProtoMessage()    {}
func (*BaseMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_2fbd53bac0b7ca8a, []int{0}
}

var extRange_BaseMessage = []vendor.ExtensionRange{
	{Start: 4, End: 9},
	{Start: 16, End: 536870911},
}

func (*BaseMessage) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *BaseMessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_BaseMessage vendor.InternalMessageInfo
...
func (m *OldStyleMessage) String() string { return vendor.CompactTextString(m) }
func (*OldStyleMessage) ProtoMessage()    {}
func (*OldStyleMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_2fbd53bac0b7ca8a, []int{1}
}

var extRange_OldStyleMessage = []vendor.ExtensionRange{
	{Start: 100, End: 2147483646},
}

func (*OldStyleMessage) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *OldStyleMessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_OldStyleMessage vendor.InternalMessageInfo

func init() {
	vendor.RegisterType((*BaseMessage)(nil), "extension_base.BaseMessage")
	vendor.RegisterType((*OldStyleMessage)(nil), "extension_base.OldStyleMessage")
}

func init() {
	vendor.RegisterFile("extension_base/extension_base.proto", fileDescriptor_2fbd53bac0b7ca8a)
}
