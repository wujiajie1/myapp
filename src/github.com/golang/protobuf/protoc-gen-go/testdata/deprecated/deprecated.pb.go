...
func (x DeprecatedEnum) String() string {
	return vendor.EnumName(DeprecatedEnum_name, int32(x))
}
...
func (m *DeprecatedRequest) String() string { return vendor.CompactTextString(m) }
...
func (m *DeprecatedRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DeprecatedRequest vendor.InternalMessageInfo
...
func (m *DeprecatedResponse) String() string { return vendor.CompactTextString(m) }
...
func (m *DeprecatedResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DeprecatedResponse vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("deprecated.DeprecatedEnum", DeprecatedEnum_name, DeprecatedEnum_value)
	vendor.RegisterType((*DeprecatedRequest)(nil), "deprecated.DeprecatedRequest")
	vendor.RegisterType((*DeprecatedResponse)(nil), "deprecated.DeprecatedResponse")
}

func init() { vendor.RegisterFile("deprecated/deprecated.proto", fileDescriptor_f64ba265cd7eae3f) }
