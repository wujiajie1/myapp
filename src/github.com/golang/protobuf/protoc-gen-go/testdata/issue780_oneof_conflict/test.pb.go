...
func (m *Foo) String() string { return vendor.CompactTextString(m) }
...
func (m *Foo) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Foo vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Foo)(nil), "oneoftest.Foo")
}

func init() { vendor.RegisterFile("issue780_oneof_conflict/test.proto", fileDescriptor_48462cafc802a68e) }
