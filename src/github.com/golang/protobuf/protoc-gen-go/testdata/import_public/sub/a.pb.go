...
func (x E) String() string {
	return vendor.EnumName(E_name, int32(x))
}

func (x *E) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(E_value, data, "E")
	if err != nil {
		return err
	}
	*x = E(value)
...
func (x M_Subenum) String() string {
	return vendor.EnumName(M_Subenum_name, int32(x))
}

func (x *M_Subenum) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(M_Subenum_value, data, "M_Subenum")
	if err != nil {
		return err
	}
	*x = M_Subenum(value)
...
func (x M_Submessage_Submessage_Subenum) String() string {
	return vendor.EnumName(M_Submessage_Submessage_Subenum_name, int32(x))
}

func (x *M_Submessage_Submessage_Subenum) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(M_Submessage_Submessage_Subenum_value, data, "M_Submessage_Submessage_Subenum")
	if err != nil {
		return err
	}
...
type M struct {
	...
	M2 *vendor.M2 `protobuf:"bytes,1,opt,name=m2" json:"m2,omitempty"`
...
func (m *M) Reset()         { *m = M{} }
func (m *M) String() string { return vendor.CompactTextString(m) }
func (*M) ProtoMessage()    {}
...
func (m *M) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M vendor.InternalMessageInfo

const Default_M_DefaultField string = "def"

func (m *M) GetM2() *vendor.M2 {
	if m != nil {
		return m.M2
	}
	return nil
...
func (m *M_Grouping) String() string { return vendor.CompactTextString(m) }
...
func (m *M_Grouping) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M_Grouping vendor.InternalMessageInfo
...
func (m *M_Submessage) String() string { return vendor.CompactTextString(m) }
...
func (m *M_Submessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M_Submessage vendor.InternalMessageInfo
...
var E_ExtensionField = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.M2)(nil),
...
func init() {
	vendor.RegisterEnum("goproto.test.import_public.sub.E", E_name, E_value)
	vendor.RegisterEnum("goproto.test.import_public.sub.M_Subenum", M_Subenum_name, M_Subenum_value)
	vendor.RegisterEnum("goproto.test.import_public.sub.M_Submessage_Submessage_Subenum", M_Submessage_Submessage_Subenum_name, M_Submessage_Submessage_Subenum_value)
	vendor.RegisterType((*M)(nil), "goproto.test.import_public.sub.M")
	vendor.RegisterType((*M_Grouping)(nil), "goproto.test.import_public.sub.M.Grouping")
	vendor.RegisterType((*M_Submessage)(nil), "goproto.test.import_public.sub.M.Submessage")
	vendor.RegisterExtension(E_ExtensionField)
}

func init() { vendor.RegisterFile("import_public/sub/a.proto", fileDescriptor_382f7805394b5c4e) }
