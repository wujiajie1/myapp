...
func (m *M2) String() string { return vendor.CompactTextString(m) }
func (*M2) ProtoMessage()    {}
func (*M2) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc66afda3d7c2232, []int{0}
}

var extRange_M2 = []vendor.ExtensionRange{
	{Start: 1, End: 536870911},
}

func (*M2) ExtensionRangeArray() []vendor.ExtensionRange {
	return extRange_M2
}
...
func (m *M2) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M2 vendor.InternalMessageInfo

func init() {
	vendor.RegisterType((*M2)(nil), "goproto.test.import_public.sub.M2")
}

func init() { vendor.RegisterFile("import_public/sub/b.proto", fileDescriptor_fc66afda3d7c2232) }
