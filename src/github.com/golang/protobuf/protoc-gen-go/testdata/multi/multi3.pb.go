...
func (x Multi3_HatType) String() string {
	return vendor.EnumName(Multi3_HatType_name, int32(x))
}

func (x *Multi3_HatType) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(Multi3_HatType_value, data, "Multi3_HatType")
	if err != nil {
		return err
	}
...
func (m *Multi3) String() string { return vendor.CompactTextString(m) }
...
func (m *Multi3) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Multi3 vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("multitest.Multi3_HatType", Multi3_HatType_name, Multi3_HatType_value)
	vendor.RegisterType((*Multi3)(nil), "multitest.Multi3")
}

func init() { vendor.RegisterFile("multi/multi3.proto", fileDescriptor_580398fc0bbeeaa7) }
