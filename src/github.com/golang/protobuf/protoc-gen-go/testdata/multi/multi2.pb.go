...
func (x Multi2_Color) String() string {
	return vendor.EnumName(Multi2_Color_name, int32(x))
}

func (x *Multi2_Color) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(Multi2_Color_value, data, "Multi2_Color")
	if err != nil {
		return err
	}
...
func (m *Multi2) String() string { return vendor.CompactTextString(m) }
...
func (m *Multi2) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Multi2 vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("multitest.Multi2_Color", Multi2_Color_name, Multi2_Color_value)
	vendor.RegisterType((*Multi2)(nil), "multitest.Multi2")
}

func init() { vendor.RegisterFile("multi/multi2.proto", fileDescriptor_a2aebe588a0b2853) }
