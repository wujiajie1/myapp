...
func (x Request_Flavour) String() string {
	return vendor.EnumName(Request_Flavour_name, int32(x))
}
...
func (m *Book) String() string { return vendor.CompactTextString(m) }
...
func (m *Book) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Book vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("proto3.Request_Flavour", Request_Flavour_name, Request_Flavour_value)
	vendor.RegisterType((*Request)(nil), "proto3.Request")
	vendor.RegisterType((*Book)(nil), "proto3.Book")
}

func init() { vendor.RegisterFile("proto3/proto3.proto", fileDescriptor_ab04eb4084a521db) }
