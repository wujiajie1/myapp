...
func (m *SimpleRequest) XXX_Merge(src vendor.Message) {
...
func (m *SimpleResponse) XXX_Merge(src vendor.Message) {
...
func (m *StreamMsg) String() string { return vendor.CompactTextString(m) }
...
func (m *StreamMsg) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StreamMsg vendor.InternalMessageInfo
...
func (m *StreamMsg2) String() string { return vendor.CompactTextString(m) }
...
func (m *StreamMsg2) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StreamMsg2 vendor.InternalMessageInfo
...
func init() {
	...
	vendor.RegisterType((*StreamMsg)(nil), "grpc.testing.StreamMsg")
	vendor.RegisterType((*StreamMsg2)(nil), "grpc.testing.StreamMsg2")
}

func init() { vendor.RegisterFile("grpc/grpc.proto", fileDescriptor_81ea47a3f88c2082) }
