...
func (x HatType) String() string {
	return vendor.EnumName(HatType_name, int32(x))
}

func (x *HatType) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(HatType_value, data, "HatType")
	if err != nil {
		return err
	}
	*x = HatType(value)
...
func (x Days) String() string {
	return vendor.EnumName(Days_name, int32(x))
}

func (x *Days) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(Days_value, data, "Days")
	if err != nil {
		return err
	}
	*x = Days(value)
...
func (x Request_Color) String() string {
	return vendor.EnumName(Request_Color_name, int32(x))
}

func (x *Request_Color) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(Request_Color_value, data, "Request_Color")
	if err != nil {
		return err
	}
...
func (x Reply_Entry_Game) String() string {
	return vendor.EnumName(Reply_Entry_Game_name, int32(x))
}

func (x *Reply_Entry_Game) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(Reply_Entry_Game_value, data, "Reply_Entry_Game")
	if err != nil {
		return err
	}
...
func (m *Request) String() string { return vendor.CompactTextString(m) }
...
func (m *Request) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Request vendor.InternalMessageInfo
...
func (m *Request_SomeGroup) String() string { return vendor.CompactTextString(m) }
...
func (m *Request_SomeGroup) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Request_SomeGroup vendor.InternalMessageInfo
...
func (m *Reply) String() string { return vendor.CompactTextString(m) }
func (*Reply) ProtoMessage()    {}
func (*Reply) Descriptor() ([]byte, []int) {
	return fileDescriptor_2c9b60a40d5131b9, []int{1}
}

var extRange_Reply = []vendor.ExtensionRange{
	{Start: 100, End: 536870911},
}

func (*Reply) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *Reply) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Reply vendor.InternalMessageInfo
...
func (m *Reply_Entry) String() string { return vendor.CompactTextString(m) }
...
func (m *Reply_Entry) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Reply_Entry vendor.InternalMessageInfo
...
func (m *OtherBase) String() string { return vendor.CompactTextString(m) }
func (*OtherBase) ProtoMessage()    {}
func (*OtherBase) Descriptor() ([]byte, []int) {
	return fileDescriptor_2c9b60a40d5131b9, []int{2}
}

var extRange_OtherBase = []vendor.ExtensionRange{
	{Start: 100, End: 536870911},
}

func (*OtherBase) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *OtherBase) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_OtherBase vendor.InternalMessageInfo
...
func (m *ReplyExtensions) String() string { return vendor.CompactTextString(m) }
...
func (m *ReplyExtensions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ReplyExtensions vendor.InternalMessageInfo

var E_ReplyExtensions_Time = &vendor.ExtensionDesc{
...
var E_ReplyExtensions_Carrot = &vendor.ExtensionDesc{
	ExtendedType:  (*Reply)(nil),
...
var E_ReplyExtensions_Donut = &vendor.ExtensionDesc{
...
func (m *OtherReplyExtensions) String() string { return vendor.CompactTextString(m) }
...
func (m *OtherReplyExtensions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_OtherReplyExtensions vendor.InternalMessageInfo
...
func (m *OldReply) String() string { return vendor.CompactTextString(m) }
func (*OldReply) ProtoMessage()    {}
func (*OldReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_2c9b60a40d5131b9, []int{5}
}

var extRange_OldReply = []vendor.ExtensionRange{
	{Start: 100, End: 2147483646},
}

func (*OldReply) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *OldReply) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_OldReply vendor.InternalMessageInfo
...
func (m *Communique_SomeGroup) String() string { return vendor.CompactTextString(m) }
...
func (m *Communique_SomeGroup) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Communique_SomeGroup vendor.InternalMessageInfo
...
func (m *Communique_Delta) String() string { return vendor.CompactTextString(m) }
...
func (m *Communique_Delta) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Communique_Delta vendor.InternalMessageInfo

var E_Tag = &vendor.ExtensionDesc{
	ExtendedType:  (*Reply)(nil),
...
var E_Donut = &vendor.ExtensionDesc{
	ExtendedType:  (*Reply)(nil),
...
func init() {
	vendor.RegisterEnum("my.test.HatType", HatType_name, HatType_value)
	vendor.RegisterEnum("my.test.Days", Days_name, Days_value)
	vendor.RegisterEnum("my.test.Request_Color", Request_Color_name, Request_Color_value)
	vendor.RegisterEnum("my.test.Reply_Entry_Game", Reply_Entry_Game_name, Reply_Entry_Game_value)
	vendor.RegisterType((*Request)(nil), "my.test.Request")
	vendor.RegisterMapType((map[int64]*Reply)(nil), "my.test.Request.MsgMappingEntry")
	vendor.RegisterMapType((map[int32]string)(nil), "my.test.Request.NameMappingEntry")
	vendor.RegisterType((*Request_SomeGroup)(nil), "my.test.Request.SomeGroup")
	vendor.RegisterType((*Reply)(nil), "my.test.Reply")
	vendor.RegisterType((*Reply_Entry)(nil), "my.test.Reply.Entry")
	vendor.RegisterType((*OtherBase)(nil), "my.test.OtherBase")
	vendor.RegisterExtension(E_ReplyExtensions_Time)
	vendor.RegisterExtension(E_ReplyExtensions_Carrot)
	vendor.RegisterExtension(E_ReplyExtensions_Donut)
	vendor.RegisterType((*ReplyExtensions)(nil), "my.test.ReplyExtensions")
	vendor.RegisterType((*OtherReplyExtensions)(nil), "my.test.OtherReplyExtensions")
	vendor.RegisterType((*OldReply)(nil), "my.test.OldReply")
	vendor.RegisterType((*Communique)(nil), "my.test.Communique")
	vendor.RegisterType((*Communique_SomeGroup)(nil), "my.test.Communique.SomeGroup")
	vendor.RegisterType((*Communique_Delta)(nil), "my.test.Communique.Delta")
	vendor.RegisterExtension(E_Tag)
	vendor.RegisterExtension(E_Donut)
}

func init() { vendor.RegisterFile("my_test/test.proto", fileDescriptor_2c9b60a40d5131b9) }
