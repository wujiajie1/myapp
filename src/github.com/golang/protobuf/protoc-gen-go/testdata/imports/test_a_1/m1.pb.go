...
func (x E1) String() string {
	return vendor.EnumName(E1_name, int32(x))
}
...
func (m *M1) String() string { return vendor.CompactTextString(m) }
...
func (m *M1) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M1 vendor.InternalMessageInfo
...
func (m *M1_1) String() string { return vendor.CompactTextString(m) }
...
func (m *M1_1) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M1_1 vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("test.a.E1", E1_name, E1_value)
	vendor.RegisterType((*M1)(nil), "test.a.M1")
	vendor.RegisterType((*M1_1)(nil), "test.a.M1_1")
}

func init() { vendor.RegisterFile("imports/test_a_1/m1.proto", fileDescriptor_c1091de3fa870a14) }
