...
func (m *M3) String() string { return vendor.CompactTextString(m) }
...
func (m *M3) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M3 vendor.InternalMessageInfo

func init() {
	vendor.RegisterType((*M3)(nil), "test.a.M3")
}

func init() { vendor.RegisterFile("imports/test_a_2/m3.proto", fileDescriptor_ff9d8f834875c9c5) }
