...
func (m *M4) String() string { return vendor.CompactTextString(m) }
...
func (m *M4) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_M4 vendor.InternalMessageInfo

func init() {
	vendor.RegisterType((*M4)(nil), "test.a.M4")
}

func init() { vendor.RegisterFile("imports/test_a_2/m4.proto", fileDescriptor_fdd24f82f6c5a786) }
