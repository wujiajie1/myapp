...
func (x Numeral) String() string {
	return vendor.EnumName(Numeral_name, int32(x))
}
...
func (m *Simple3) String() string { return vendor.CompactTextString(m) }
...
func (m *Simple3) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Simple3 vendor.InternalMessageInfo
...
func (m *SimpleSlice3) String() string { return vendor.CompactTextString(m) }
...
func (m *SimpleSlice3) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SimpleSlice3 vendor.InternalMessageInfo
...
func (m *SimpleMap3) String() string { return vendor.CompactTextString(m) }
...
func (m *SimpleMap3) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SimpleMap3 vendor.InternalMessageInfo
...
func (m *SimpleNull3) String() string { return vendor.CompactTextString(m) }
...
func (m *SimpleNull3) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SimpleNull3 vendor.InternalMessageInfo
...
func (m *Mappy) String() string { return vendor.CompactTextString(m) }
...
func (m *Mappy) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Mappy vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("jsonpb.Numeral", Numeral_name, Numeral_value)
	vendor.RegisterType((*Simple3)(nil), "jsonpb.Simple3")
	vendor.RegisterType((*SimpleSlice3)(nil), "jsonpb.SimpleSlice3")
	vendor.RegisterType((*SimpleMap3)(nil), "jsonpb.SimpleMap3")
	vendor.RegisterMapType((map[string]string)(nil), "jsonpb.SimpleMap3.StringyEntry")
	vendor.RegisterType((*SimpleNull3)(nil), "jsonpb.SimpleNull3")
	vendor.RegisterType((*Mappy)(nil), "jsonpb.Mappy")
	vendor.RegisterMapType((map[bool]bool)(nil), "jsonpb.Mappy.BoolyEntry")
	vendor.RegisterMapType((map[int64]string)(nil), "jsonpb.Mappy.BuggyEntry")
	vendor.RegisterMapType((map[string]Numeral)(nil), "jsonpb.Mappy.EnumyEntry")
	vendor.RegisterMapType((map[int64]int32)(nil), "jsonpb.Mappy.NummyEntry")
	vendor.RegisterMapType((map[int32]*Simple3)(nil), "jsonpb.Mappy.ObjjyEntry")
	vendor.RegisterMapType((map[int32]bool)(nil), "jsonpb.Mappy.S32boolyEntry")
	vendor.RegisterMapType((map[int64]bool)(nil), "jsonpb.Mappy.S64boolyEntry")
	vendor.RegisterMapType((map[string]string)(nil), "jsonpb.Mappy.StrryEntry")
	vendor.RegisterMapType((map[uint32]bool)(nil), "jsonpb.Mappy.U32boolyEntry")
	vendor.RegisterMapType((map[uint64]bool)(nil), "jsonpb.Mappy.U64boolyEntry")
}

func init() { vendor.RegisterFile("more_test_objects.proto", fileDescriptor_e6c135db3023e377) }
