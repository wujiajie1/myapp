...
func (x Widget_Color) String() string {
	return vendor.EnumName(Widget_Color_name, int32(x))
}

func (x *Widget_Color) UnmarshalJSON(data []byte) error {
	value, err := vendor.UnmarshalJSONEnum(Widget_Color_value, data, "Widget_Color")
	if err != nil {
		return err
	}
...
func (m *Simple) String() string { return vendor.CompactTextString(m) }
...
func (m *Simple) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Simple vendor.InternalMessageInfo
...
func (m *NonFinites) String() string { return vendor.CompactTextString(m) }
...
func (m *NonFinites) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_NonFinites vendor.InternalMessageInfo
...
func (m *Repeats) String() string { return vendor.CompactTextString(m) }
...
func (m *Repeats) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Repeats vendor.InternalMessageInfo
...
func (m *Widget) String() string { return vendor.CompactTextString(m) }
...
func (m *Widget) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Widget vendor.InternalMessageInfo
...
func (m *Maps) String() string { return vendor.CompactTextString(m) }
...
func (m *Maps) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Maps vendor.InternalMessageInfo
...
func (m *MsgWithOneof) String() string { return vendor.CompactTextString(m) }
...
func (m *MsgWithOneof) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_MsgWithOneof vendor.InternalMessageInfo
...
func (m *Real) String() string { return vendor.CompactTextString(m) }
func (*Real) ProtoMessage()    {}
func (*Real) Descriptor() ([]byte, []int) {
	return fileDescriptor_e97c739a0ce14cc6, []int{6}
}

var extRange_Real = []vendor.ExtensionRange{
	{Start: 100, End: 536870911},
}

func (*Real) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *Real) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Real vendor.InternalMessageInfo
...
func (m *Complex) String() string { return vendor.CompactTextString(m) }
func (*Complex) ProtoMessage()    {}
func (*Complex) Descriptor() ([]byte, []int) {
	return fileDescriptor_e97c739a0ce14cc6, []int{7}
}

var extRange_Complex = []vendor.ExtensionRange{
	{Start: 100, End: 536870911},
}

func (*Complex) ExtensionRangeArray() []vendor.ExtensionRange {
...
func (m *Complex) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Complex vendor.InternalMessageInfo
...
var E_Complex_RealExtension = &vendor.ExtensionDesc{
...
type KnownTypes struct {
	An                   *vendor.Any         `protobuf:"bytes,14,opt,name=an" json:"an,omitempty"`
	Dur                  *vendor.Duration    `protobuf:"bytes,1,opt,name=dur" json:"dur,omitempty"`
	St                   *vendor.Struct      `protobuf:"bytes,12,opt,name=st" json:"st,omitempty"`
	Ts                   *vendor.Timestamp   `protobuf:"bytes,2,opt,name=ts" json:"ts,omitempty"`
	Lv                   *vendor.ListValue   `protobuf:"bytes,15,opt,name=lv" json:"lv,omitempty"`
	Val                  *vendor.Value       `protobuf:"bytes,16,opt,name=val" json:"val,omitempty"`
	Dbl                  *vendor.DoubleValue `protobuf:"bytes,3,opt,name=dbl" json:"dbl,omitempty"`
	Flt                  *vendor.FloatValue  `protobuf:"bytes,4,opt,name=flt" json:"flt,omitempty"`
	I64                  *vendor.Int64Value  `protobuf:"bytes,5,opt,name=i64" json:"i64,omitempty"`
	U64                  *vendor.UInt64Value `protobuf:"bytes,6,opt,name=u64" json:"u64,omitempty"`
	I32                  *vendor.Int32Value  `protobuf:"bytes,7,opt,name=i32" json:"i32,omitempty"`
	U32                  *vendor.UInt32Value `protobuf:"bytes,8,opt,name=u32" json:"u32,omitempty"`
	Bool                 *vendor.BoolValue   `protobuf:"bytes,9,opt,name=bool" json:"bool,omitempty"`
	Str                  *vendor.StringValue `protobuf:"bytes,10,opt,name=str" json:"str,omitempty"`
	Bytes                *vendor.BytesValue  `protobuf:"bytes,11,opt,name=bytes" json:"bytes,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *KnownTypes) String() string { return vendor.CompactTextString(m) }
...
func (m *KnownTypes) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_KnownTypes vendor.InternalMessageInfo

func (m *KnownTypes) GetAn() *vendor.Any {
	if m != nil {
		return m.An
	}
	return nil
...
func (m *KnownTypes) GetDur() *vendor.Duration {
	if m != nil {
		return m.Dur
	}
	return nil
...
func (m *KnownTypes) GetSt() *vendor.Struct {
	if m != nil {
		return m.St
	}
	return nil
...
func (m *KnownTypes) GetTs() *vendor.Timestamp {
	if m != nil {
		return m.Ts
	}
	return nil
...
func (m *KnownTypes) GetLv() *vendor.ListValue {
	if m != nil {
		return m.Lv
	}
	return nil
...
func (m *KnownTypes) GetVal() *vendor.Value {
	if m != nil {
		return m.Val
	}
	return nil
...
func (m *KnownTypes) GetDbl() *vendor.DoubleValue {
	if m != nil {
		return m.Dbl
	}
	return nil
...
func (m *KnownTypes) GetFlt() *vendor.FloatValue {
	if m != nil {
		return m.Flt
	}
	return nil
...
func (m *KnownTypes) GetI64() *vendor.Int64Value {
	if m != nil {
		return m.I64
	}
	return nil
...
func (m *KnownTypes) GetU64() *vendor.UInt64Value {
	if m != nil {
		return m.U64
	}
	return nil
...
func (m *KnownTypes) GetI32() *vendor.Int32Value {
	if m != nil {
		return m.I32
	}
	return nil
...
func (m *KnownTypes) GetU32() *vendor.UInt32Value {
	if m != nil {
		return m.U32
	}
	return nil
...
func (m *KnownTypes) GetBool() *vendor.BoolValue {
	if m != nil {
		return m.Bool
	}
	return nil
...
func (m *KnownTypes) GetStr() *vendor.StringValue {
	if m != nil {
		return m.Str
	}
	return nil
...
func (m *KnownTypes) GetBytes() *vendor.BytesValue {
	if m != nil {
		return m.Bytes
	}
	return nil
...
func (m *MsgWithRequired) String() string { return vendor.CompactTextString(m) }
...
func (m *MsgWithRequired) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_MsgWithRequired vendor.InternalMessageInfo
...
func (m *MsgWithIndirectRequired) String() string { return vendor.CompactTextString(m) }
...
func (m *MsgWithIndirectRequired) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_MsgWithIndirectRequired vendor.InternalMessageInfo
...
func (m *MsgWithRequiredBytes) String() string { return vendor.CompactTextString(m) }
...
func (m *MsgWithRequiredBytes) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_MsgWithRequiredBytes vendor.InternalMessageInfo
...
type MsgWithRequiredWKT struct {
	Str                  *vendor.StringValue `protobuf:"bytes,1,req,name=str" json:"str,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *MsgWithRequiredWKT) String() string { return vendor.CompactTextString(m) }
...
func (m *MsgWithRequiredWKT) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_MsgWithRequiredWKT vendor.InternalMessageInfo

func (m *MsgWithRequiredWKT) GetStr() *vendor.StringValue {
	if m != nil {
		return m.Str
	}
	return nil
...
var E_Name = &vendor.ExtensionDesc{
	ExtendedType:  (*Real)(nil),
...
var E_Extm = &vendor.ExtensionDesc{
	ExtendedType:  (*Real)(nil),
...
func init() {
	vendor.RegisterEnum("jsonpb.Widget_Color", Widget_Color_name, Widget_Color_value)
	vendor.RegisterType((*Simple)(nil), "jsonpb.Simple")
	vendor.RegisterType((*NonFinites)(nil), "jsonpb.NonFinites")
	vendor.RegisterType((*Repeats)(nil), "jsonpb.Repeats")
	vendor.RegisterType((*Widget)(nil), "jsonpb.Widget")
	vendor.RegisterType((*Maps)(nil), "jsonpb.Maps")
	vendor.RegisterMapType((map[bool]*Simple)(nil), "jsonpb.Maps.MBoolSimpleEntry")
	vendor.RegisterMapType((map[int64]string)(nil), "jsonpb.Maps.MInt64StrEntry")
	vendor.RegisterType((*MsgWithOneof)(nil), "jsonpb.MsgWithOneof")
	vendor.RegisterType((*Real)(nil), "jsonpb.Real")
	vendor.RegisterExtension(E_Complex_RealExtension)
	vendor.RegisterType((*Complex)(nil), "jsonpb.Complex")
	vendor.RegisterType((*KnownTypes)(nil), "jsonpb.KnownTypes")
	vendor.RegisterType((*MsgWithRequired)(nil), "jsonpb.MsgWithRequired")
	vendor.RegisterType((*MsgWithIndirectRequired)(nil), "jsonpb.MsgWithIndirectRequired")
	vendor.RegisterMapType((map[string]*MsgWithRequired)(nil), "jsonpb.MsgWithIndirectRequired.MapFieldEntry")
	vendor.RegisterType((*MsgWithRequiredBytes)(nil), "jsonpb.MsgWithRequiredBytes")
	vendor.RegisterType((*MsgWithRequiredWKT)(nil), "jsonpb.MsgWithRequiredWKT")
	vendor.RegisterExtension(E_Name)
	vendor.RegisterExtension(E_Extm)
}

func init() { vendor.RegisterFile("test_objects.proto", fileDescriptor_e97c739a0ce14cc6) }
