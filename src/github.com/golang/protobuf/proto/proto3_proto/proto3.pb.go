...
func (x Message_Humour) String() string {
	return vendor.EnumName(Message_Humour_name, int32(x))
}
...
type Message struct {
	...
	Proto2Field          *vendor.SubDefaults            `protobuf:"bytes,11,opt,name=proto2_field,json=proto2Field,proto3" json:"proto2_field,omitempty"`
	Proto2Value          map[string]*vendor.SubDefaults `protobuf:"bytes,13,rep,name=proto2_value,json=proto2Value,proto3" json:"proto2_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Anything             *vendor.Any                    `protobuf:"bytes,14,opt,name=anything,proto3" json:"anything,omitempty"`
	ManyThings           []*vendor.Any                  `protobuf:"bytes,15,rep,name=many_things,json=manyThings,proto3" json:"many_things,omitempty"`
...
func (m *Message) XXX_Merge(src vendor.Message) {
...
func (m *Message) GetProto2Field() *vendor.SubDefaults {
	if m != nil {
...
func (m *Message) GetProto2Value() map[string]*vendor.SubDefaults {
	if m != nil {
...
func (m *Message) GetAnything() *vendor.Any {
	if m != nil {
		return m.Anything
	}
	return nil
...
func (m *Message) GetManyThings() []*vendor.Any {
	if m != nil {
		return m.ManyThings
	}
	return nil
...
func (m *Nested) String() string { return vendor.CompactTextString(m) }
...
func (m *Nested) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Nested vendor.InternalMessageInfo
...
func (m *IntMap) String() string { return vendor.CompactTextString(m) }
...
func (m *IntMap) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_IntMap vendor.InternalMessageInfo
...
func (m *IntMaps) String() string { return vendor.CompactTextString(m) }
...
func (m *IntMaps) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_IntMaps vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterEnum("proto3_proto.Message_Humour", Message_Humour_name, Message_Humour_value)
	vendor.RegisterType((*Message)(nil), "proto3_proto.Message")
	vendor.RegisterMapType((map[string]*vendor.SubDefaults)(nil), "proto3_proto.Message.Proto2ValueEntry")
	vendor.RegisterMapType((map[string]string)(nil), "proto3_proto.Message.StringMapEntry")
	vendor.RegisterMapType((map[string]*Nested)(nil), "proto3_proto.Message.TerrainEntry")
	vendor.RegisterType((*Nested)(nil), "proto3_proto.Nested")
	vendor.RegisterType((*MessageWithMap)(nil), "proto3_proto.MessageWithMap")
	vendor.RegisterMapType((map[bool][]byte)(nil), "proto3_proto.MessageWithMap.ByteMappingEntry")
	vendor.RegisterType((*IntMap)(nil), "proto3_proto.IntMap")
	vendor.RegisterMapType((map[int32]int32)(nil), "proto3_proto.IntMap.RttEntry")
	vendor.RegisterType((*IntMaps)(nil), "proto3_proto.IntMaps")
	vendor.RegisterType((*TestUTF8)(nil), "proto3_proto.TestUTF8")
	vendor.RegisterMapType((map[string]int64)(nil), "proto3_proto.TestUTF8.MapKeyEntry")
	vendor.RegisterMapType((map[int64]string)(nil), "proto3_proto.TestUTF8.MapValueEntry")
}

func init() { vendor.RegisterFile("proto3_proto/proto3.proto", fileDescriptor_1c50d9b824d4ac38) }
