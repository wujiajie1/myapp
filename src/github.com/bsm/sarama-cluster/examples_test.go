...
func ExampleConsumer() {
	...
	consumer, err := vendor.NewConsumer(brokers, "my-consumer-group", topics, config)
	if err != nil {
		panic(err)
	}
...
func ExampleConfig_whitelist() {
	...
	// init consumer
	consumer, err := vendor.NewConsumer([]string{"127.0.0.1:9092"}, "my-consumer-group", nil, config)
	if err != nil {
		panic(err)
	}
	defer consumer.Close()
