...
func TestBatcherSuccess(t *testing.T) {
	b := vendor.New(10*time.Millisecond, returnsSuccess)
...
func TestBatcherError(t *testing.T) {
	b := vendor.New(10*time.Millisecond, returnsError)
...
func TestBatcherPrefilter(t *testing.T) {
	b := vendor.New(1*time.Millisecond, returnsSuccess)
...
func TestBatcherMultipleBatches(t *testing.T) {
	...
	b := vendor.New(10*time.Millisecond, func(params []interface{}) error {
