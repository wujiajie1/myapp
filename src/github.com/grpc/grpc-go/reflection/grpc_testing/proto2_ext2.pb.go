...
func (m *AnotherExtension) String() string { return vendor.CompactTextString(m) }
...
func (dst *AnotherExtension) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_AnotherExtension vendor.InternalMessageInfo
...
var E_Frob = &vendor.ExtensionDesc{
...
var E_Nitz = &vendor.ExtensionDesc{
	ExtendedType:  (*vendor.ToBeExtended)(nil),
...
func init() {
	vendor.RegisterType((*AnotherExtension)(nil), "grpc.testing.AnotherExtension")
	vendor.RegisterExtension(E_Frob)
	vendor.RegisterExtension(E_Nitz)
}

func init() { vendor.RegisterFile("proto2_ext2.proto", fileDescriptor_proto2_ext2_039d342873655470) }
