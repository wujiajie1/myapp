...
func (m *SearchResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *SearchResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SearchResponse vendor.InternalMessageInfo
...
func (m *SearchResponse_Result) String() string { return vendor.CompactTextString(m) }
...
func (dst *SearchResponse_Result) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SearchResponse_Result vendor.InternalMessageInfo
...
func (m *SearchRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *SearchRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SearchRequest vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*SearchResponse)(nil), "grpc.testing.SearchResponse")
	vendor.RegisterType((*SearchResponse_Result)(nil), "grpc.testing.SearchResponse.Result")
	vendor.RegisterType((*SearchRequest)(nil), "grpc.testing.SearchRequest")
}
...
type SearchServiceClient interface {
	Search(ctx vendor.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error)
	StreamingSearch(ctx vendor.Context, opts ...grpc.CallOption) (SearchService_StreamingSearchClient, error)
}
...
func (c *searchServiceClient) Search(ctx vendor.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
...
func (c *searchServiceClient) StreamingSearch(ctx vendor.Context, opts ...grpc.CallOption) (SearchService_StreamingSearchClient, error) {
...
type SearchServiceServer interface {
	Search(vendor.Context, *SearchRequest) (*SearchResponse, error)
...
func _SearchService_Search_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func init() { vendor.RegisterFile("test.proto", fileDescriptor_test_a0c753075da50dd4) }
