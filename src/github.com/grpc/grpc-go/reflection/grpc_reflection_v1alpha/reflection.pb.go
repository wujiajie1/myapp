...
func (m *ServerReflectionRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerReflectionRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerReflectionRequest vendor.InternalMessageInfo
...
func (*ServerReflectionRequest) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _ServerReflectionRequest_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _ServerReflectionRequest_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*ServerReflectionRequest)
	switch tag {
...
func _ServerReflectionRequest_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*ServerReflectionRequest)
	// message_request
	switch x := m.MessageRequest.(type) {
	case *ServerReflectionRequest_FileByFilename:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.FileByFilename)))
		n += len(x.FileByFilename)
	case *ServerReflectionRequest_FileContainingSymbol:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.FileContainingSymbol)))
		n += len(x.FileContainingSymbol)
	case *ServerReflectionRequest_FileContainingExtension:
		s := vendor.Size(x.FileContainingExtension)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *ServerReflectionRequest_AllExtensionNumbersOfType:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.AllExtensionNumbersOfType)))
		n += len(x.AllExtensionNumbersOfType)
	case *ServerReflectionRequest_ListServices:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.ListServices)))
...
func (m *ExtensionRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *ExtensionRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ExtensionRequest vendor.InternalMessageInfo
...
func (m *ServerReflectionResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerReflectionResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerReflectionResponse vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ServerReflectionResponse) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _ServerReflectionResponse_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _ServerReflectionResponse_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*ServerReflectionResponse)
	switch tag {
...
func _ServerReflectionResponse_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*ServerReflectionResponse)
	// message_response
	switch x := m.MessageResponse.(type) {
	case *ServerReflectionResponse_FileDescriptorResponse:
		s := vendor.Size(x.FileDescriptorResponse)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *ServerReflectionResponse_AllExtensionNumbersResponse:
		s := vendor.Size(x.AllExtensionNumbersResponse)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *ServerReflectionResponse_ListServicesResponse:
		s := vendor.Size(x.ListServicesResponse)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *ServerReflectionResponse_ErrorResponse:
		s := vendor.Size(x.ErrorResponse)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *FileDescriptorResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *FileDescriptorResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_FileDescriptorResponse vendor.InternalMessageInfo
...
func (m *ExtensionNumberResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *ExtensionNumberResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ExtensionNumberResponse vendor.InternalMessageInfo
...
func (m *ListServiceResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *ListServiceResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ListServiceResponse vendor.InternalMessageInfo
...
func (m *ServiceResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServiceResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServiceResponse vendor.InternalMessageInfo
...
func (m *ErrorResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *ErrorResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ErrorResponse vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*ServerReflectionRequest)(nil), "grpc.reflection.v1alpha.ServerReflectionRequest")
	vendor.RegisterType((*ExtensionRequest)(nil), "grpc.reflection.v1alpha.ExtensionRequest")
	vendor.RegisterType((*ServerReflectionResponse)(nil), "grpc.reflection.v1alpha.ServerReflectionResponse")
	vendor.RegisterType((*FileDescriptorResponse)(nil), "grpc.reflection.v1alpha.FileDescriptorResponse")
	vendor.RegisterType((*ExtensionNumberResponse)(nil), "grpc.reflection.v1alpha.ExtensionNumberResponse")
	vendor.RegisterType((*ListServiceResponse)(nil), "grpc.reflection.v1alpha.ListServiceResponse")
	vendor.RegisterType((*ServiceResponse)(nil), "grpc.reflection.v1alpha.ServiceResponse")
	vendor.RegisterType((*ErrorResponse)(nil), "grpc.reflection.v1alpha.ErrorResponse")
}
...
type ServerReflectionClient interface {
	...
	ServerReflectionInfo(ctx vendor.Context, opts ...grpc.CallOption) (ServerReflection_ServerReflectionInfoClient, error)
}
...
func (c *serverReflectionClient) ServerReflectionInfo(ctx vendor.Context, opts ...grpc.CallOption) (ServerReflection_ServerReflectionInfoClient, error) {
...
func init() {
	vendor.RegisterFile("grpc_reflection_v1alpha/reflection.proto", fileDescriptor_reflection_178bd1e101bf8b63)
}
