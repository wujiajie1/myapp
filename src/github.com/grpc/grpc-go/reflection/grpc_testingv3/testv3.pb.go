...
func (x SearchResponseV3_State) String() string {
	return vendor.EnumName(SearchResponseV3_State_name, int32(x))
}
...
func (m *SearchResponseV3) String() string            { return vendor.CompactTextString(m) }
...
func (m *SearchResponseV3_Result) String() string            { return vendor.CompactTextString(m) }
...
func (m *SearchResponseV3_Result_Value) String() string { return vendor.CompactTextString(m) }
...
func (*SearchResponseV3_Result_Value) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _SearchResponseV3_Result_Value_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	...
	case *SearchResponseV3_Result_Value_Real:
		b.EncodeVarint(3<<3 | vendor.WireFixed64)
...
func _SearchResponseV3_Result_Value_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*SearchResponseV3_Result_Value)
	switch tag {
	case 1: // val.str
...
func _SearchResponseV3_Result_Value_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*SearchResponseV3_Result_Value)
	// val
	switch x := m.Val.(type) {
	case *SearchResponseV3_Result_Value_Str:
		n += vendor.SizeVarint(1<<3 | vendor.WireBytes)
		n += vendor.SizeVarint(uint64(len(x.Str)))
		n += len(x.Str)
	case *SearchResponseV3_Result_Value_Int:
		n += vendor.SizeVarint(2<<3 | vendor.WireVarint)
		n += vendor.SizeVarint(uint64(x.Int))
	case *SearchResponseV3_Result_Value_Real:
		n += vendor.SizeVarint(3<<3 | vendor.WireFixed64)
		n += 8
	case nil:
	default:
...
func (m *SearchRequestV3) String() string            { return vendor.CompactTextString(m) }
...
func init() {
	vendor.RegisterType((*SearchResponseV3)(nil), "grpc.testingv3.SearchResponseV3")
	vendor.RegisterType((*SearchResponseV3_Result)(nil), "grpc.testingv3.SearchResponseV3.Result")
	vendor.RegisterType((*SearchResponseV3_Result_Value)(nil), "grpc.testingv3.SearchResponseV3.Result.Value")
	vendor.RegisterType((*SearchRequestV3)(nil), "grpc.testingv3.SearchRequestV3")
	vendor.RegisterEnum("grpc.testingv3.SearchResponseV3_State", SearchResponseV3_State_name, SearchResponseV3_State_value)
}
...
type SearchServiceV3Client interface {
	Search(ctx vendor.Context, in *SearchRequestV3, opts ...grpc.CallOption) (*SearchResponseV3, error)
	StreamingSearch(ctx vendor.Context, opts ...grpc.CallOption) (SearchServiceV3_StreamingSearchClient, error)
}
...
func (c *searchServiceV3Client) Search(ctx vendor.Context, in *SearchRequestV3, opts ...grpc.CallOption) (*SearchResponseV3, error) {
...
func (c *searchServiceV3Client) StreamingSearch(ctx vendor.Context, opts ...grpc.CallOption) (SearchServiceV3_StreamingSearchClient, error) {
...
type SearchServiceV3Server interface {
	Search(vendor.Context, *SearchRequestV3) (*SearchResponseV3, error)
...
func _SearchServiceV3_Search_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func init() { vendor.RegisterFile("testv3.proto", fileDescriptor0) }
