...
// CallOption.
func AuthInfoFromContext(ctx context.Context) (vendor.AuthInfo, error) {
...
func AuthInfoFromPeer(p *peer.Peer) (vendor.AuthInfo, error) {
	altsAuthInfo, ok := p.AuthInfo.(vendor.AuthInfo)
	if !ok {
