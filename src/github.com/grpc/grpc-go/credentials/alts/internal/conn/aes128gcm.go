...
func NewAES128GCM(side core.Side, key []byte) (vendor.ALTSRecordCrypto, error) {
	...
	return &aes128gcm{
		inCounter:  vendor.NewInCounter(side, overflowLenAES128GCM),
		outCounter: vendor.NewOutCounter(side, overflowLenAES128GCM),
		aead:       a,
	}, nil
}
