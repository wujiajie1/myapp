...
func (x HandshakeProtocol) String() string {
	return vendor.EnumName(HandshakeProtocol_name, int32(x))
}
...
func (x NetworkProtocol) String() string {
	return vendor.EnumName(NetworkProtocol_name, int32(x))
}
...
func (m *Endpoint) String() string { return vendor.CompactTextString(m) }
...
func (dst *Endpoint) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Endpoint vendor.InternalMessageInfo
...
func (m *Identity) String() string { return vendor.CompactTextString(m) }
...
func (dst *Identity) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Identity vendor.InternalMessageInfo
...
func (*Identity) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _Identity_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*Identity)
	// identity_oneof
...
func _Identity_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*Identity)
	switch tag {
...
func _Identity_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*Identity)
	// identity_oneof
	switch x := m.IdentityOneof.(type) {
	case *Identity_ServiceAccount:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.ServiceAccount)))
		n += len(x.ServiceAccount)
	case *Identity_Hostname:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.Hostname)))
		n += len(x.Hostname)
	case nil:
	default:
...
type StartClientHandshakeReq struct {
	...
	RpcVersions          *vendor.RpcProtocolVersions `protobuf:"bytes,9,opt,name=rpc_versions,json=rpcVersions,proto3" json:"rpc_versions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *StartClientHandshakeReq) String() string { return vendor.CompactTextString(m) }
...
func (dst *StartClientHandshakeReq) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StartClientHandshakeReq vendor.InternalMessageInfo
...
func (m *StartClientHandshakeReq) GetRpcVersions() *vendor.RpcProtocolVersions {
	if m != nil {
...
func (m *ServerHandshakeParameters) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerHandshakeParameters) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerHandshakeParameters vendor.InternalMessageInfo
...
type StartServerHandshakeReq struct {
	...
	RpcVersions          *vendor.RpcProtocolVersions `protobuf:"bytes,6,opt,name=rpc_versions,json=rpcVersions,proto3" json:"rpc_versions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *StartServerHandshakeReq) String() string { return vendor.CompactTextString(m) }
...
func (dst *StartServerHandshakeReq) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StartServerHandshakeReq vendor.InternalMessageInfo
...
func (m *StartServerHandshakeReq) GetRpcVersions() *vendor.RpcProtocolVersions {
	if m != nil {
		return m.RpcVersions
	}
	return nil
...
func (m *NextHandshakeMessageReq) String() string { return vendor.CompactTextString(m) }
...
func (dst *NextHandshakeMessageReq) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_NextHandshakeMessageReq vendor.InternalMessageInfo
...
func (m *HandshakerReq) String() string { return vendor.CompactTextString(m) }
...
func (dst *HandshakerReq) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HandshakerReq vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*HandshakerReq) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _HandshakerReq_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*HandshakerReq)
	// req_oneof
...
func _HandshakerReq_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*HandshakerReq)
	switch tag {
...
func _HandshakerReq_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*HandshakerReq)
	// req_oneof
	switch x := m.ReqOneof.(type) {
	case *HandshakerReq_ClientStart:
		s := vendor.Size(x.ClientStart)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *HandshakerReq_ServerStart:
		s := vendor.Size(x.ServerStart)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *HandshakerReq_Next:
		s := vendor.Size(x.Next)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
type HandshakerResult struct {
	...
	PeerRpcVersions      *vendor.RpcProtocolVersions `protobuf:"bytes,7,opt,name=peer_rpc_versions,json=peerRpcVersions,proto3" json:"peer_rpc_versions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *HandshakerResult) String() string { return vendor.CompactTextString(m) }
...
func (dst *HandshakerResult) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HandshakerResult vendor.InternalMessageInfo
...
func (m *HandshakerResult) GetPeerRpcVersions() *vendor.RpcProtocolVersions {
	if m != nil {
...
func (m *HandshakerStatus) String() string { return vendor.CompactTextString(m) }
...
func (dst *HandshakerStatus) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HandshakerStatus vendor.InternalMessageInfo
...
func (m *HandshakerResp) String() string { return vendor.CompactTextString(m) }
...
func (dst *HandshakerResp) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HandshakerResp vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Endpoint)(nil), "grpc.gcp.Endpoint")
	vendor.RegisterType((*Identity)(nil), "grpc.gcp.Identity")
	vendor.RegisterMapType((map[string]string)(nil), "grpc.gcp.Identity.AttributesEntry")
	vendor.RegisterType((*StartClientHandshakeReq)(nil), "grpc.gcp.StartClientHandshakeReq")
	vendor.RegisterType((*ServerHandshakeParameters)(nil), "grpc.gcp.ServerHandshakeParameters")
	vendor.RegisterType((*StartServerHandshakeReq)(nil), "grpc.gcp.StartServerHandshakeReq")
	vendor.RegisterMapType((map[int32]*ServerHandshakeParameters)(nil), "grpc.gcp.StartServerHandshakeReq.HandshakeParametersEntry")
	vendor.RegisterType((*NextHandshakeMessageReq)(nil), "grpc.gcp.NextHandshakeMessageReq")
	vendor.RegisterType((*HandshakerReq)(nil), "grpc.gcp.HandshakerReq")
	vendor.RegisterType((*HandshakerResult)(nil), "grpc.gcp.HandshakerResult")
	vendor.RegisterType((*HandshakerStatus)(nil), "grpc.gcp.HandshakerStatus")
	vendor.RegisterType((*HandshakerResp)(nil), "grpc.gcp.HandshakerResp")
	vendor.RegisterEnum("grpc.gcp.HandshakeProtocol", HandshakeProtocol_name, HandshakeProtocol_value)
	vendor.RegisterEnum("grpc.gcp.NetworkProtocol", NetworkProtocol_name, NetworkProtocol_value)
}
...
type HandshakerServiceClient interface {
	...
	DoHandshake(ctx vendor.Context, opts ...grpc.CallOption) (HandshakerService_DoHandshakeClient, error)
}
...
func (c *handshakerServiceClient) DoHandshake(ctx vendor.Context, opts ...grpc.CallOption) (HandshakerService_DoHandshakeClient, error) {
...
func init() {
	vendor.RegisterFile("grpc/gcp/handshaker.proto", fileDescriptor_handshaker_1dfe659b12ea825e)
}
