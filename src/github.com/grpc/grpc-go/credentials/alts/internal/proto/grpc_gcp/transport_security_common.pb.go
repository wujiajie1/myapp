...
func (x SecurityLevel) String() string {
	return vendor.EnumName(SecurityLevel_name, int32(x))
}
...
func (m *RpcProtocolVersions) String() string { return vendor.CompactTextString(m) }
...
func (dst *RpcProtocolVersions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_RpcProtocolVersions vendor.InternalMessageInfo
...
func (m *RpcProtocolVersions_Version) String() string { return vendor.CompactTextString(m) }
...
func (dst *RpcProtocolVersions_Version) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_RpcProtocolVersions_Version vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*RpcProtocolVersions)(nil), "grpc.gcp.RpcProtocolVersions")
	vendor.RegisterType((*RpcProtocolVersions_Version)(nil), "grpc.gcp.RpcProtocolVersions.Version")
	vendor.RegisterEnum("grpc.gcp.SecurityLevel", SecurityLevel_name, SecurityLevel_value)
}

func init() {
	vendor.RegisterFile("grpc/gcp/transport_security_common.proto", fileDescriptor_transport_security_common_71945991f2c3b4a6)
}
