...
type AltsContext struct {
	...
	SecurityLevel vendor.SecurityLevel `protobuf:"varint,3,opt,name=security_level,json=securityLevel,proto3,enum=grpc.gcp.SecurityLevel" json:"security_level,omitempty"`
	...
	PeerRpcVersions *vendor.RpcProtocolVersions `protobuf:"bytes,6,opt,name=peer_rpc_versions,json=peerRpcVersions,proto3" json:"peer_rpc_versions,omitempty"`
...
func (m *AltsContext) String() string { return vendor.CompactTextString(m) }
...
func (dst *AltsContext) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_AltsContext vendor.InternalMessageInfo
...
func (m *AltsContext) GetSecurityLevel() vendor.SecurityLevel {
	if m != nil {
		return m.SecurityLevel
	}
	return vendor.SecurityLevel_SECURITY_NONE
}
...
func (m *AltsContext) GetPeerRpcVersions() *vendor.RpcProtocolVersions {
	if m != nil {
...
func init() {
	vendor.RegisterType((*AltsContext)(nil), "grpc.gcp.AltsContext")
	vendor.RegisterMapType((map[string]string)(nil), "grpc.gcp.AltsContext.PeerAttributesEntry")
}

func init() {
	vendor.RegisterFile("grpc/gcp/altscontext.proto", fileDescriptor_altscontext_f6b7868f9a30497f)
}
