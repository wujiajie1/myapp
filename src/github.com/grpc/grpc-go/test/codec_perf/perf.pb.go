...
func (m *Buffer) String() string { return vendor.CompactTextString(m) }
...
func (dst *Buffer) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Buffer vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Buffer)(nil), "codec.perf.Buffer")
}

func init() { vendor.RegisterFile("codec_perf/perf.proto", fileDescriptor_perf_6cc81a33b24d08e7) }
