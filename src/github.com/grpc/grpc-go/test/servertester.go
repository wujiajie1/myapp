...
func newServerTesterFromConn(t testing.TB, cc io.ReadWriteCloser) *serverTester {
	...
	st.fr.ReadMetaHeaders = vendor.NewDecoder(4096 /*initialHeaderTableSize*/, nil)
...
func (st *serverTester) writePreface() {
	n, err := st.cc.Write([]byte(vendor.ClientPreface))
	if err != nil {
...
func (st *serverTester) wantAnyFrame() vendor.Frame {
...
func (st *serverTester) writeRSTStream(streamID uint32, code vendor.ErrCode) {
