...
func (x HealthCheckResponse_ServingStatus) String() string {
	return vendor.EnumName(HealthCheckResponse_ServingStatus_name, int32(x))
}
...
func (m *HealthCheckRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheckRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheckRequest vendor.InternalMessageInfo
...
func (m *HealthCheckResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheckResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheckResponse vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*HealthCheckRequest)(nil), "grpc.health.v1.HealthCheckRequest")
	vendor.RegisterType((*HealthCheckResponse)(nil), "grpc.health.v1.HealthCheckResponse")
	vendor.RegisterEnum("grpc.health.v1.HealthCheckResponse_ServingStatus", HealthCheckResponse_ServingStatus_name, HealthCheckResponse_ServingStatus_value)
}
...
type HealthClient interface {
	...
	// NOT_FOUND.
	Check(ctx vendor.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error)
	...
	Watch(ctx vendor.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (Health_WatchClient, error)
}
...
func (c *healthClient) Check(ctx vendor.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
...
func (c *healthClient) Watch(ctx vendor.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (Health_WatchClient, error) {
...
type HealthServer interface {
	// If the requested service is unknown, the call will fail with status
	// NOT_FOUND.
	Check(vendor.Context, *HealthCheckRequest) (*HealthCheckResponse, error)
	// Performs a watch for the serving status of the requested service.
	// The server will immediately send back a message indicating the current
	// serving status.  It will then subsequently send a new message whenever
	// the service's serving status changes.
...
func _Health_Check_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func init() { vendor.RegisterFile("grpc/health/v1/health.proto", fileDescriptor_health_6b1a06aa67f91efd) }
