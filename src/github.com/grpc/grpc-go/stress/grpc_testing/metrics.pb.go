...
func (m *GaugeResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GaugeResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GaugeResponse vendor.InternalMessageInfo
...
func (*GaugeResponse) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _GaugeResponse_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*GaugeResponse)
	// value
...
func _GaugeResponse_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*GaugeResponse)
	switch tag {
...
func _GaugeResponse_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*GaugeResponse)
	// value
	switch x := m.Value.(type) {
	case *GaugeResponse_LongValue:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(x.LongValue))
	case *GaugeResponse_DoubleValue:
		n += 1 // tag and wire
		n += 8
	case *GaugeResponse_StringValue:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.StringValue)))
		n += len(x.StringValue)
	case nil:
	default:
...
func (m *GaugeRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GaugeRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GaugeRequest vendor.InternalMessageInfo
...
func (m *EmptyMessage) String() string { return vendor.CompactTextString(m) }
...
func (dst *EmptyMessage) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_EmptyMessage vendor.InternalMessageInfo

func init() {
	vendor.RegisterType((*GaugeResponse)(nil), "grpc.testing.GaugeResponse")
	vendor.RegisterType((*GaugeRequest)(nil), "grpc.testing.GaugeRequest")
	vendor.RegisterType((*EmptyMessage)(nil), "grpc.testing.EmptyMessage")
}
...
type MetricsServiceClient interface {
	...
	// the service
	GetAllGauges(ctx vendor.Context, in *EmptyMessage, opts ...grpc.CallOption) (MetricsService_GetAllGaugesClient, error)
	// Returns the value of one gauge
	GetGauge(ctx vendor.Context, in *GaugeRequest, opts ...grpc.CallOption) (*GaugeResponse, error)
}
...
func (c *metricsServiceClient) GetAllGauges(ctx vendor.Context, in *EmptyMessage, opts ...grpc.CallOption) (MetricsService_GetAllGaugesClient, error) {
...
func (c *metricsServiceClient) GetGauge(ctx vendor.Context, in *GaugeRequest, opts ...grpc.CallOption) (*GaugeResponse, error) {
...
type MetricsServiceServer interface {
	...
	// Returns the value of one gauge
	GetGauge(vendor.Context, *GaugeRequest) (*GaugeResponse, error)
}
...
func _MetricsService_GetGauge_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GaugeRequest)
...
func init() { vendor.RegisterFile("metrics.proto", fileDescriptor_metrics_c9a45afc44ac5637) }
