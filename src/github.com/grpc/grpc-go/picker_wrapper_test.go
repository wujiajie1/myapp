...
var (
	testT  = &testTransport{}
	testSC = &vendor.acBalancerWrapper{ac: &vendor.addrConn{
		state:     connectivity.Ready,
		transport: testT,
	}}
	testSCNotReady = &vendor.acBalancerWrapper{ac: &vendor.addrConn{
...
func (vendor.s) TestBlockingPickTimeout(t *testing.T) {
	bp := vendor.newPickerWrapper()
...
func (vendor.s) TestBlockingPick(t *testing.T) {
	bp := vendor.newPickerWrapper()
...
func (vendor.s) TestBlockingPickNoSubAvailable(t *testing.T) {
	bp := vendor.newPickerWrapper()
	var finishedCount uint64
...
func (vendor.s) TestBlockingPickTransientWaitforready(t *testing.T) {
	bp := vendor.newPickerWrapper()
...
func (vendor.s) TestBlockingPickSCNotReady(t *testing.T) {
	bp := vendor.newPickerWrapper()
