...
// used instead.
func newCCResolverWrapper(cc *vendor.ClientConn) (*ccResolverWrapper, error) {
...
func (ccr *ccResolverWrapper) NewAddress(addrs []resolver.Address) {
	...
	if channelz.IsOn() {
		ccr.addChannelzTraceEvent(resolver.State{Addresses: addrs, vendor.ServiceConfig: ccr.curState.ServiceConfig})
	}
...
func (ccr *ccResolverWrapper) NewServiceConfig(sc string) {
	...
	if channelz.IsOn() {
		ccr.addChannelzTraceEvent(resolver.State{Addresses: ccr.curState.Addresses, vendor.ServiceConfig: sc})
	}
