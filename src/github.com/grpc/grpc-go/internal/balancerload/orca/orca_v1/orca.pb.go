...
func (m *LoadReport) String() string { return vendor.CompactTextString(m) }
...
func (dst *LoadReport) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoadReport vendor.InternalMessageInfo
...
type LoadReportRequest struct {
	...
	ReportInterval *vendor.Duration `protobuf:"bytes,1,opt,name=report_interval,json=reportInterval,proto3" json:"report_interval,omitempty"`
...
func (m *LoadReportRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *LoadReportRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoadReportRequest vendor.InternalMessageInfo

func (m *LoadReportRequest) GetReportInterval() *vendor.Duration {
	if m != nil {
...
func init() {
	vendor.RegisterType((*LoadReport)(nil), "orca.v1.LoadReport")
	vendor.RegisterMapType((map[string]float64)(nil), "orca.v1.LoadReport.RequestCostOrUtilizationEntry")
	vendor.RegisterType((*LoadReportRequest)(nil), "orca.v1.LoadReportRequest")
}
...
type OpenRCAServiceClient interface {
	StreamCoreMetrics(ctx vendor.Context, in *LoadReportRequest, opts ...grpc.CallOption) (OpenRCAService_StreamCoreMetricsClient, error)
}
...
func (c *openRCAServiceClient) StreamCoreMetrics(ctx vendor.Context, in *LoadReportRequest, opts ...grpc.CallOption) (OpenRCAService_StreamCoreMetricsClient, error) {
...
func init() { vendor.RegisterFile("orca.proto", fileDescriptor_orca_542539e3bf435293) }
