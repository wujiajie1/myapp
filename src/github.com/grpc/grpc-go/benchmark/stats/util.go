...
var (
	curB         *testing.B
	curBenchName string
	curStats     map[string]*vendor.Stats
...
func AddStats(b *testing.B, numBuckets int) *vendor.Stats {
...
func AddStatsWithName(b *testing.B, name string, numBuckets int) *vendor.Stats {
	...
	stats := vendor.NewStats(numBuckets)
...
func resetCurBenchStats() {
	curB = nil
	curBenchName = ""
	curStats = make(map[string]*vendor.Stats)
}
