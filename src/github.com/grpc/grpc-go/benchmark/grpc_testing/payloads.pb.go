...
func (m *ByteBufferParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *ByteBufferParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ByteBufferParams vendor.InternalMessageInfo
...
func (m *SimpleProtoParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *SimpleProtoParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SimpleProtoParams vendor.InternalMessageInfo
...
func (m *ComplexProtoParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *ComplexProtoParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ComplexProtoParams vendor.InternalMessageInfo
...
func (m *PayloadConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *PayloadConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_PayloadConfig vendor.InternalMessageInfo
...
func (*PayloadConfig) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _PayloadConfig_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*PayloadConfig)
	// payload
...
func _PayloadConfig_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*PayloadConfig)
	switch tag {
...
func _PayloadConfig_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*PayloadConfig)
	// payload
	switch x := m.Payload.(type) {
	case *PayloadConfig_BytebufParams:
		s := vendor.Size(x.BytebufParams)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *PayloadConfig_SimpleParams:
		s := vendor.Size(x.SimpleParams)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *PayloadConfig_ComplexParams:
		s := vendor.Size(x.ComplexParams)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func init() {
	vendor.RegisterType((*ByteBufferParams)(nil), "grpc.testing.ByteBufferParams")
	vendor.RegisterType((*SimpleProtoParams)(nil), "grpc.testing.SimpleProtoParams")
	vendor.RegisterType((*ComplexProtoParams)(nil), "grpc.testing.ComplexProtoParams")
	vendor.RegisterType((*PayloadConfig)(nil), "grpc.testing.PayloadConfig")
}

func init() { vendor.RegisterFile("payloads.proto", fileDescriptor_payloads_3abc71de35f06c83) }
