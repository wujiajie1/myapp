...
func (m *ServerStats) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerStats) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerStats vendor.InternalMessageInfo
...
func (m *HistogramParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *HistogramParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HistogramParams vendor.InternalMessageInfo
...
func (m *HistogramData) String() string { return vendor.CompactTextString(m) }
...
func (dst *HistogramData) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HistogramData vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*ServerStats)(nil), "grpc.testing.ServerStats")
	vendor.RegisterType((*HistogramParams)(nil), "grpc.testing.HistogramParams")
	vendor.RegisterType((*HistogramData)(nil), "grpc.testing.HistogramData")
	vendor.RegisterType((*ClientStats)(nil), "grpc.testing.ClientStats")
}

func init() { vendor.RegisterFile("stats.proto", fileDescriptor_stats_8ba831c0cb3c3440) }
