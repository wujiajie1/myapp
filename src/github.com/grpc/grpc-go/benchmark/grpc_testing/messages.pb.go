...
func (x CompressionType) String() string {
	return vendor.EnumName(CompressionType_name, int32(x))
}
...
func (m *ReconnectParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *ReconnectParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ReconnectParams vendor.InternalMessageInfo
...
func (m *ReconnectInfo) String() string { return vendor.CompactTextString(m) }
...
func (dst *ReconnectInfo) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ReconnectInfo vendor.InternalMessageInfo
...
func init() {
	...
	vendor.RegisterType((*ReconnectParams)(nil), "grpc.testing.ReconnectParams")
	vendor.RegisterType((*ReconnectInfo)(nil), "grpc.testing.ReconnectInfo")
	vendor.RegisterEnum("grpc.testing.PayloadType", PayloadType_name, PayloadType_value)
	vendor.RegisterEnum("grpc.testing.CompressionType", CompressionType_name, CompressionType_value)
}

func init() { vendor.RegisterFile("messages.proto", fileDescriptor_messages_5c70222ad96bf232) }
