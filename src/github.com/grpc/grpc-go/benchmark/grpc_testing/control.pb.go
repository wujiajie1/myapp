...
func (x ClientType) String() string {
	return vendor.EnumName(ClientType_name, int32(x))
}
...
func (x ServerType) String() string {
	return vendor.EnumName(ServerType_name, int32(x))
}
...
func (x RpcType) String() string {
	return vendor.EnumName(RpcType_name, int32(x))
}
...
func (m *PoissonParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *PoissonParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_PoissonParams vendor.InternalMessageInfo
...
func (m *UniformParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *UniformParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UniformParams vendor.InternalMessageInfo
...
func (m *DeterministicParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *DeterministicParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DeterministicParams vendor.InternalMessageInfo
...
func (m *ParetoParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *ParetoParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ParetoParams vendor.InternalMessageInfo
...
func (m *ClosedLoopParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClosedLoopParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClosedLoopParams vendor.InternalMessageInfo
...
func (m *LoadParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *LoadParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoadParams vendor.InternalMessageInfo
...
func (*LoadParams) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _LoadParams_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*LoadParams)
	// load
...
func _LoadParams_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*LoadParams)
	switch tag {
...
func _LoadParams_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*LoadParams)
	// load
	switch x := m.Load.(type) {
	case *LoadParams_ClosedLoop:
		s := vendor.Size(x.ClosedLoop)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *LoadParams_Poisson:
		s := vendor.Size(x.Poisson)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *LoadParams_Uniform:
		s := vendor.Size(x.Uniform)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *LoadParams_Determ:
		s := vendor.Size(x.Determ)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *LoadParams_Pareto:
		s := vendor.Size(x.Pareto)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *SecurityParams) String() string { return vendor.CompactTextString(m) }
...
func (dst *SecurityParams) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SecurityParams vendor.InternalMessageInfo
...
type ClientConfig struct {
	...
	PayloadConfig   *vendor.PayloadConfig   `protobuf:"bytes,11,opt,name=payload_config,json=payloadConfig,proto3" json:"payload_config,omitempty"`
	HistogramParams *vendor.HistogramParams `protobuf:"bytes,12,opt,name=histogram_params,json=histogramParams,proto3" json:"histogram_params,omitempty"`
...
func (m *ClientConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClientConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClientConfig vendor.InternalMessageInfo
...
func (m *ClientConfig) GetPayloadConfig() *vendor.PayloadConfig {
	if m != nil {
...
func (m *ClientConfig) GetHistogramParams() *vendor.HistogramParams {
	if m != nil {
...
type ClientStatus struct {
	Stats                *vendor.ClientStats `protobuf:"bytes,1,opt,name=stats,proto3" json:"stats,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *ClientStatus) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClientStatus) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClientStatus vendor.InternalMessageInfo

func (m *ClientStatus) GetStats() *vendor.ClientStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
func (m *Mark) String() string { return vendor.CompactTextString(m) }
...
func (dst *Mark) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Mark vendor.InternalMessageInfo
...
func (m *ClientArgs) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClientArgs) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClientArgs vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ClientArgs) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _ClientArgs_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*ClientArgs)
	// argtype
...
func _ClientArgs_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*ClientArgs)
	switch tag {
...
func _ClientArgs_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*ClientArgs)
	// argtype
	switch x := m.Argtype.(type) {
	case *ClientArgs_Setup:
		s := vendor.Size(x.Setup)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *ClientArgs_Mark:
		s := vendor.Size(x.Mark)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
type ServerConfig struct {
	...
	PayloadConfig *vendor.PayloadConfig `protobuf:"bytes,9,opt,name=payload_config,json=payloadConfig,proto3" json:"payload_config,omitempty"`
...
func (m *ServerConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerConfig vendor.InternalMessageInfo
...
func (m *ServerConfig) GetPayloadConfig() *vendor.PayloadConfig {
	if m != nil {
		return m.PayloadConfig
	}
	return nil
...
func (m *ServerArgs) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerArgs) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerArgs vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ServerArgs) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _ServerArgs_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*ServerArgs)
	// argtype
	switch x := m.Argtype.(type) {
...
func _ServerArgs_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*ServerArgs)
	switch tag {
	case 1: // argtype.setup
		if wire != vendor.WireBytes {
...
func _ServerArgs_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*ServerArgs)
	// argtype
	switch x := m.Argtype.(type) {
	case *ServerArgs_Setup:
...
type ServerStatus struct {
	Stats *vendor.ServerStats `protobuf:"bytes,1,opt,name=stats,proto3" json:"stats,omitempty"`
...
func (m *ServerStatus) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerStatus) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerStatus vendor.InternalMessageInfo

func (m *ServerStatus) GetStats() *vendor.ServerStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
func (m *CoreRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *CoreRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CoreRequest vendor.InternalMessageInfo
...
func (m *CoreResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *CoreResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CoreResponse vendor.InternalMessageInfo
...
func (m *Void) String() string { return vendor.CompactTextString(m) }
...
func (dst *Void) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Void vendor.InternalMessageInfo
...
func (m *Scenario) String() string { return vendor.CompactTextString(m) }
...
func (dst *Scenario) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Scenario vendor.InternalMessageInfo
...
func (m *Scenarios) String() string { return vendor.CompactTextString(m) }
...
func (dst *Scenarios) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Scenarios vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*PoissonParams)(nil), "grpc.testing.PoissonParams")
	vendor.RegisterType((*UniformParams)(nil), "grpc.testing.UniformParams")
	vendor.RegisterType((*DeterministicParams)(nil), "grpc.testing.DeterministicParams")
	vendor.RegisterType((*ParetoParams)(nil), "grpc.testing.ParetoParams")
	vendor.RegisterType((*ClosedLoopParams)(nil), "grpc.testing.ClosedLoopParams")
	vendor.RegisterType((*LoadParams)(nil), "grpc.testing.LoadParams")
	vendor.RegisterType((*SecurityParams)(nil), "grpc.testing.SecurityParams")
	vendor.RegisterType((*ClientConfig)(nil), "grpc.testing.ClientConfig")
	vendor.RegisterType((*ClientStatus)(nil), "grpc.testing.ClientStatus")
	vendor.RegisterType((*Mark)(nil), "grpc.testing.Mark")
	vendor.RegisterType((*ClientArgs)(nil), "grpc.testing.ClientArgs")
	vendor.RegisterType((*ServerConfig)(nil), "grpc.testing.ServerConfig")
	vendor.RegisterType((*ServerArgs)(nil), "grpc.testing.ServerArgs")
	vendor.RegisterType((*ServerStatus)(nil), "grpc.testing.ServerStatus")
	vendor.RegisterType((*CoreRequest)(nil), "grpc.testing.CoreRequest")
	vendor.RegisterType((*CoreResponse)(nil), "grpc.testing.CoreResponse")
	vendor.RegisterType((*Void)(nil), "grpc.testing.Void")
	vendor.RegisterType((*Scenario)(nil), "grpc.testing.Scenario")
	vendor.RegisterType((*Scenarios)(nil), "grpc.testing.Scenarios")
	vendor.RegisterEnum("grpc.testing.ClientType", ClientType_name, ClientType_value)
	vendor.RegisterEnum("grpc.testing.ServerType", ServerType_name, ServerType_value)
	vendor.RegisterEnum("grpc.testing.RpcType", RpcType_name, RpcType_value)
}

func init() { vendor.RegisterFile("control.proto", fileDescriptor_control_63d6a60a9ad7e299) }
