...
type BenchmarkServiceClient interface {
	...
	UnaryCall(ctx vendor.Context, in *vendor.SimpleRequest, opts ...grpc.CallOption) (*vendor.SimpleResponse, error)
	// One request followed by one response.
	// The server returns the client payload as-is.
	StreamingCall(ctx vendor.Context, opts ...grpc.CallOption) (BenchmarkService_StreamingCallClient, error)
	// Unconstrainted streaming.
	// Both server and client keep sending & receiving simultaneously.
	UnconstrainedStreamingCall(ctx vendor.Context, opts ...grpc.CallOption) (BenchmarkService_UnconstrainedStreamingCallClient, error)
}
...
func (c *benchmarkServiceClient) UnaryCall(ctx vendor.Context, in *vendor.SimpleRequest, opts ...grpc.CallOption) (*vendor.SimpleResponse, error) {
	out := new(vendor.SimpleResponse)
...
func (c *benchmarkServiceClient) StreamingCall(ctx vendor.Context, opts ...grpc.CallOption) (BenchmarkService_StreamingCallClient, error) {
...
type BenchmarkService_StreamingCallClient interface {
	Send(*vendor.SimpleRequest) error
	Recv() (*vendor.SimpleResponse, error)
	grpc.ClientStream
}
...
func (x *benchmarkServiceStreamingCallClient) Send(m *vendor.SimpleRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *benchmarkServiceStreamingCallClient) Recv() (*vendor.SimpleResponse, error) {
	m := new(vendor.SimpleResponse)
...
func (c *benchmarkServiceClient) UnconstrainedStreamingCall(ctx vendor.Context, opts ...grpc.CallOption) (BenchmarkService_UnconstrainedStreamingCallClient, error) {
...
func (x *benchmarkServiceUnconstrainedStreamingCallClient) Send(m *vendor.SimpleRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *benchmarkServiceUnconstrainedStreamingCallClient) Recv() (*vendor.SimpleResponse, error) {
	m := new(vendor.SimpleResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type BenchmarkServiceServer interface {
	// One request followed by one response.
	// The server returns the client payload as-is.
	UnaryCall(vendor.Context, *vendor.SimpleRequest) (*vendor.SimpleResponse, error)
	// One request followed by one response.
	// The server returns the client payload as-is.
...
func _BenchmarkService_UnaryCall_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(vendor.SimpleRequest)
	...
	handler := func(ctx vendor.Context, req interface{}) (interface{}, error) {
		return srv.(BenchmarkServiceServer).UnaryCall(ctx, req.(*vendor.SimpleRequest))
	}
...
type BenchmarkService_StreamingCallServer interface {
	Send(*vendor.SimpleResponse) error
	Recv() (*vendor.SimpleRequest, error)
	grpc.ServerStream
}
...
func (x *benchmarkServiceStreamingCallServer) Send(m *vendor.SimpleResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *benchmarkServiceStreamingCallServer) Recv() (*vendor.SimpleRequest, error) {
	m := new(vendor.SimpleRequest)
...
func (x *benchmarkServiceUnconstrainedStreamingCallServer) Send(m *vendor.SimpleResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *benchmarkServiceUnconstrainedStreamingCallServer) Recv() (*vendor.SimpleRequest, error) {
	m := new(vendor.SimpleRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type WorkerServiceClient interface {
	...
	// this RPC.
	RunServer(ctx vendor.Context, opts ...grpc.CallOption) (WorkerService_RunServerClient, error)
	...
	// and once the shutdown has finished, the OK status is sent to terminate
	// this RPC.
	RunClient(ctx vendor.Context, opts ...grpc.CallOption) (WorkerService_RunClientClient, error)
	// Just return the core count - unary call
	CoreCount(ctx vendor.Context, in *vendor.CoreRequest, opts ...grpc.CallOption) (*vendor.CoreResponse, error)
	// Quit this worker
	QuitWorker(ctx vendor.Context, in *vendor.Void, opts ...grpc.CallOption) (*vendor.Void, error)
}
...
func (c *workerServiceClient) RunServer(ctx vendor.Context, opts ...grpc.CallOption) (WorkerService_RunServerClient, error) {
...
type WorkerService_RunServerClient interface {
	Send(*vendor.ServerArgs) error
	Recv() (*vendor.ServerStatus, error)
	grpc.ClientStream
}
...
func (x *workerServiceRunServerClient) Send(m *vendor.ServerArgs) error {
	return x.ClientStream.SendMsg(m)
}

func (x *workerServiceRunServerClient) Recv() (*vendor.ServerStatus, error) {
	m := new(vendor.ServerStatus)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *workerServiceClient) RunClient(ctx vendor.Context, opts ...grpc.CallOption) (WorkerService_RunClientClient, error) {
...
type WorkerService_RunClientClient interface {
	Send(*vendor.ClientArgs) error
	Recv() (*vendor.ClientStatus, error)
	grpc.ClientStream
}
...
func (x *workerServiceRunClientClient) Send(m *vendor.ClientArgs) error {
	return x.ClientStream.SendMsg(m)
}

func (x *workerServiceRunClientClient) Recv() (*vendor.ClientStatus, error) {
	m := new(vendor.ClientStatus)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *workerServiceClient) CoreCount(ctx vendor.Context, in *vendor.CoreRequest, opts ...grpc.CallOption) (*vendor.CoreResponse, error) {
	out := new(vendor.CoreResponse)
...
func (c *workerServiceClient) QuitWorker(ctx vendor.Context, in *vendor.Void, opts ...grpc.CallOption) (*vendor.Void, error) {
	out := new(vendor.Void)
...
type WorkerServiceServer interface {
	...
	// Just return the core count - unary call
	CoreCount(vendor.Context, *vendor.CoreRequest) (*vendor.CoreResponse, error)
	// Quit this worker
	QuitWorker(vendor.Context, *vendor.Void) (*vendor.Void, error)
}
...
type WorkerService_RunServerServer interface {
	Send(*vendor.ServerStatus) error
	Recv() (*vendor.ServerArgs, error)
	grpc.ServerStream
}
...
func (x *workerServiceRunServerServer) Send(m *vendor.ServerStatus) error {
	return x.ServerStream.SendMsg(m)
}

func (x *workerServiceRunServerServer) Recv() (*vendor.ServerArgs, error) {
	m := new(vendor.ServerArgs)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type WorkerService_RunClientServer interface {
	Send(*vendor.ClientStatus) error
	Recv() (*vendor.ClientArgs, error)
	grpc.ServerStream
}
...
func (x *workerServiceRunClientServer) Send(m *vendor.ClientStatus) error {
	return x.ServerStream.SendMsg(m)
}

func (x *workerServiceRunClientServer) Recv() (*vendor.ClientArgs, error) {
	m := new(vendor.ClientArgs)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _WorkerService_CoreCount_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(vendor.CoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx vendor.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServiceServer).CoreCount(ctx, req.(*vendor.CoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _WorkerService_QuitWorker_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(vendor.Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	...
	handler := func(ctx vendor.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServiceServer).QuitWorker(ctx, req.(*vendor.Void))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { vendor.RegisterFile("services.proto", fileDescriptor_services_e4655369b5d7f4d0) }
