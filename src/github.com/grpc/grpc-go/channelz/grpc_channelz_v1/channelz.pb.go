...
func (x ChannelConnectivityState_State) String() string {
	return vendor.EnumName(ChannelConnectivityState_State_name, int32(x))
}
...
func (x ChannelTraceEvent_Severity) String() string {
	return vendor.EnumName(ChannelTraceEvent_Severity_name, int32(x))
}
...
func (m *Channel) String() string { return vendor.CompactTextString(m) }
...
func (dst *Channel) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Channel vendor.InternalMessageInfo
...
func (m *Subchannel) String() string { return vendor.CompactTextString(m) }
...
func (dst *Subchannel) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Subchannel vendor.InternalMessageInfo
...
func (m *ChannelConnectivityState) String() string { return vendor.CompactTextString(m) }
...
func (dst *ChannelConnectivityState) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ChannelConnectivityState vendor.InternalMessageInfo
...
type ChannelData struct {
	...
	LastCallStartedTimestamp *vendor.Timestamp `protobuf:"bytes,7,opt,name=last_call_started_timestamp,json=lastCallStartedTimestamp,proto3" json:"last_call_started_timestamp,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}          `json:"-"`
	XXX_unrecognized         []byte            `json:"-"`
	XXX_sizecache            int32             `json:"-"`
}
...
func (m *ChannelData) String() string { return vendor.CompactTextString(m) }
...
func (dst *ChannelData) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ChannelData vendor.InternalMessageInfo
...
func (m *ChannelData) GetLastCallStartedTimestamp() *vendor.Timestamp {
	if m != nil {
...
type ChannelTraceEvent struct {
	...
	Timestamp *vendor.Timestamp `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
...
func (m *ChannelTraceEvent) String() string { return vendor.CompactTextString(m) }
...
func (dst *ChannelTraceEvent) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ChannelTraceEvent vendor.InternalMessageInfo
...
func (m *ChannelTraceEvent) GetTimestamp() *vendor.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (*ChannelTraceEvent) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _ChannelTraceEvent_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*ChannelTraceEvent)
	switch tag {
	case 4: // child_ref.channel_ref
		if wire != vendor.WireBytes {
			return true, vendor.ErrInternalBadWireType
		}
		msg := new(ChannelRef)
...
func _ChannelTraceEvent_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*ChannelTraceEvent)
	// child_ref
	switch x := m.ChildRef.(type) {
	case *ChannelTraceEvent_ChannelRef:
		s := vendor.Size(x.ChannelRef)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *ChannelTraceEvent_SubchannelRef:
		s := vendor.Size(x.SubchannelRef)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
type ChannelTrace struct {
	...
	CreationTimestamp *vendor.Timestamp `protobuf:"bytes,2,opt,name=creation_timestamp,json=creationTimestamp,proto3" json:"creation_timestamp,omitempty"`
...
func (m *ChannelTrace) String() string { return vendor.CompactTextString(m) }
...
func (dst *ChannelTrace) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ChannelTrace vendor.InternalMessageInfo
...
func (m *ChannelTrace) GetCreationTimestamp() *vendor.Timestamp {
	if m != nil {
...
func (m *ChannelRef) String() string { return vendor.CompactTextString(m) }
...
func (dst *ChannelRef) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ChannelRef vendor.InternalMessageInfo
...
func (m *SubchannelRef) String() string { return vendor.CompactTextString(m) }
...
func (dst *SubchannelRef) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SubchannelRef vendor.InternalMessageInfo
...
func (m *SocketRef) String() string { return vendor.CompactTextString(m) }
...
func (dst *SocketRef) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SocketRef vendor.InternalMessageInfo
...
func (m *ServerRef) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerRef) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerRef vendor.InternalMessageInfo
...
func (m *Server) String() string { return vendor.CompactTextString(m) }
...
func (dst *Server) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Server vendor.InternalMessageInfo
...
type ServerData struct {
	...
	LastCallStartedTimestamp *vendor.Timestamp `protobuf:"bytes,5,opt,name=last_call_started_timestamp,json=lastCallStartedTimestamp,proto3" json:"last_call_started_timestamp,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}          `json:"-"`
	XXX_unrecognized         []byte            `json:"-"`
	XXX_sizecache            int32             `json:"-"`
}
...
func (m *ServerData) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerData) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerData vendor.InternalMessageInfo
...
func (m *ServerData) GetLastCallStartedTimestamp() *vendor.Timestamp {
	if m != nil {
		return m.LastCallStartedTimestamp
	}
	return nil
...
func (m *Socket) String() string { return vendor.CompactTextString(m) }
...
func (dst *Socket) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Socket vendor.InternalMessageInfo
...
type SocketData struct {
	...
	// servers.
	LastLocalStreamCreatedTimestamp *vendor.Timestamp `protobuf:"bytes,7,opt,name=last_local_stream_created_timestamp,json=lastLocalStreamCreatedTimestamp,proto3" json:"last_local_stream_created_timestamp,omitempty"`
	// The last time a stream was created by the remote endpoint.  Usually unset
	// for clients.
	LastRemoteStreamCreatedTimestamp *vendor.Timestamp `protobuf:"bytes,8,opt,name=last_remote_stream_created_timestamp,json=lastRemoteStreamCreatedTimestamp,proto3" json:"last_remote_stream_created_timestamp,omitempty"`
	// The last time a message was sent by this endpoint.
	LastMessageSentTimestamp *vendor.Timestamp `protobuf:"bytes,9,opt,name=last_message_sent_timestamp,json=lastMessageSentTimestamp,proto3" json:"last_message_sent_timestamp,omitempty"`
	// The last time a message was received by this endpoint.
	LastMessageReceivedTimestamp *vendor.Timestamp `protobuf:"bytes,10,opt,name=last_message_received_timestamp,json=lastMessageReceivedTimestamp,proto3" json:"last_message_received_timestamp,omitempty"`
	// The amount of window, granted to the local endpoint by the remote endpoint.
	// This may be slightly out of date due to network latency.  This does NOT
	// include stream level or TCP level flow control info.
	LocalFlowControlWindow *vendor.Int64Value `protobuf:"bytes,11,opt,name=local_flow_control_window,json=localFlowControlWindow,proto3" json:"local_flow_control_window,omitempty"`
	// The amount of window, granted to the remote endpoint by the local endpoint.
	// This may be slightly out of date due to network latency.  This does NOT
	// include stream level or TCP level flow control info.
	RemoteFlowControlWindow *vendor.Int64Value `protobuf:"bytes,12,opt,name=remote_flow_control_window,json=remoteFlowControlWindow,proto3" json:"remote_flow_control_window,omitempty"`
...
func (m *SocketData) String() string { return vendor.CompactTextString(m) }
...
func (dst *SocketData) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SocketData vendor.InternalMessageInfo
...
func (m *SocketData) GetLastLocalStreamCreatedTimestamp() *vendor.Timestamp {
	if m != nil {
...
func (m *SocketData) GetLastRemoteStreamCreatedTimestamp() *vendor.Timestamp {
	if m != nil {
...
func (m *SocketData) GetLastMessageSentTimestamp() *vendor.Timestamp {
	if m != nil {
...
func (m *SocketData) GetLastMessageReceivedTimestamp() *vendor.Timestamp {
	if m != nil {
...
func (m *SocketData) GetLocalFlowControlWindow() *vendor.Int64Value {
	if m != nil {
...
func (m *SocketData) GetRemoteFlowControlWindow() *vendor.Int64Value {
	if m != nil {
...
func (m *Address) String() string { return vendor.CompactTextString(m) }
...
func (dst *Address) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Address vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Address) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _Address_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*Address)
	// address
	switch x := m.Address.(type) {
	case *Address_TcpipAddress:
		b.EncodeVarint(1<<3 | vendor.WireBytes)
		if err := b.EncodeMessage(x.TcpipAddress); err != nil {
			return err
		}
	case *Address_UdsAddress_:
		b.EncodeVarint(2<<3 | vendor.WireBytes)
		if err := b.EncodeMessage(x.UdsAddress); err != nil {
			return err
		}
	case *Address_OtherAddress_:
		b.EncodeVarint(3<<3 | vendor.WireBytes)
...
func _Address_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*Address)
	switch tag {
...
func _Address_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*Address)
	// address
	switch x := m.Address.(type) {
	case *Address_TcpipAddress:
		s := vendor.Size(x.TcpipAddress)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *Address_UdsAddress_:
		s := vendor.Size(x.UdsAddress)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *Address_OtherAddress_:
		s := vendor.Size(x.OtherAddress)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *Address_TcpIpAddress) String() string { return vendor.CompactTextString(m) }
...
func (dst *Address_TcpIpAddress) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Address_TcpIpAddress vendor.InternalMessageInfo
...
func (m *Address_UdsAddress) String() string { return vendor.CompactTextString(m) }
...
func (dst *Address_UdsAddress) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Address_UdsAddress vendor.InternalMessageInfo
...
type Address_OtherAddress struct {
	...
	Value                *vendor.Any `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Address_OtherAddress) String() string { return vendor.CompactTextString(m) }
...
func (dst *Address_OtherAddress) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Address_OtherAddress vendor.InternalMessageInfo
...
func (m *Address_OtherAddress) GetValue() *vendor.Any {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *Security) String() string { return vendor.CompactTextString(m) }
...
func (dst *Security) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Security vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Security) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _Security_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*Security)
	// model
...
func _Security_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*Security)
	switch tag {
	case 1: // model.tls
		if wire != vendor.WireBytes {
...
func _Security_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*Security)
	// model
	switch x := m.Model.(type) {
	case *Security_Tls_:
...
func (m *Security_Tls) String() string { return vendor.CompactTextString(m) }
...
func (dst *Security_Tls) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Security_Tls vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Security_Tls) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _Security_Tls_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*Security_Tls)
	// cipher_suite
...
func _Security_Tls_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*Security_Tls)
	switch tag {
...
func _Security_Tls_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*Security_Tls)
	// cipher_suite
	switch x := m.CipherSuite.(type) {
	case *Security_Tls_StandardName:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.StandardName)))
		n += len(x.StandardName)
	case *Security_Tls_OtherName:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.OtherName)))
		n += len(x.OtherName)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
...
func (m *Security_OtherSecurity) String() string { return vendor.CompactTextString(m) }
...
func (dst *Security_OtherSecurity) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Security_OtherSecurity vendor.InternalMessageInfo
...
func (m *Security_OtherSecurity) GetValue() *vendor.Any {
	if m != nil {
		return m.Value
	}
	return nil
...
type SocketOption struct {
	...
	Additional           *vendor.Any `protobuf:"bytes,3,opt,name=additional,proto3" json:"additional,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *SocketOption) String() string { return vendor.CompactTextString(m) }
...
func (dst *SocketOption) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SocketOption vendor.InternalMessageInfo
...
func (m *SocketOption) GetAdditional() *vendor.Any {
	if m != nil {
		return m.Additional
	}
	return nil
...
type SocketOptionTimeout struct {
	Duration             *vendor.Duration `protobuf:"bytes,1,opt,name=duration,proto3" json:"duration,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *SocketOptionTimeout) String() string { return vendor.CompactTextString(m) }
...
func (dst *SocketOptionTimeout) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SocketOptionTimeout vendor.InternalMessageInfo

func (m *SocketOptionTimeout) GetDuration() *vendor.Duration {
	if m != nil {
		return m.Duration
	}
	return nil
...
type SocketOptionLinger struct {
	...
	Duration             *vendor.Duration `protobuf:"bytes,2,opt,name=duration,proto3" json:"duration,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *SocketOptionLinger) String() string { return vendor.CompactTextString(m) }
...
func (dst *SocketOptionLinger) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SocketOptionLinger vendor.InternalMessageInfo
...
func (m *SocketOptionLinger) GetDuration() *vendor.Duration {
	if m != nil {
		return m.Duration
	}
	return nil
...
func (m *SocketOptionTcpInfo) String() string { return vendor.CompactTextString(m) }
...
func (dst *SocketOptionTcpInfo) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SocketOptionTcpInfo vendor.InternalMessageInfo
...
func (m *GetTopChannelsRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetTopChannelsRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetTopChannelsRequest vendor.InternalMessageInfo
...
func (m *GetTopChannelsResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetTopChannelsResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetTopChannelsResponse vendor.InternalMessageInfo
...
func (m *GetServersRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetServersRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetServersRequest vendor.InternalMessageInfo
...
func (m *GetServersResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetServersResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetServersResponse vendor.InternalMessageInfo
...
func (m *GetServerRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetServerRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetServerRequest vendor.InternalMessageInfo
...
func (m *GetServerResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetServerResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetServerResponse vendor.InternalMessageInfo
...
func (m *GetServerSocketsRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetServerSocketsRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetServerSocketsRequest vendor.InternalMessageInfo
...
func (m *GetServerSocketsResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetServerSocketsResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetServerSocketsResponse vendor.InternalMessageInfo
...
func (m *GetChannelRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetChannelRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetChannelRequest vendor.InternalMessageInfo
...
func (m *GetChannelResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetChannelResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetChannelResponse vendor.InternalMessageInfo
...
func (m *GetSubchannelRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetSubchannelRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetSubchannelRequest vendor.InternalMessageInfo
...
func (m *GetSubchannelResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetSubchannelResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetSubchannelResponse vendor.InternalMessageInfo
...
func (m *GetSocketRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetSocketRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetSocketRequest vendor.InternalMessageInfo
...
func (m *GetSocketResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *GetSocketResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GetSocketResponse vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Channel)(nil), "grpc.channelz.v1.Channel")
	vendor.RegisterType((*Subchannel)(nil), "grpc.channelz.v1.Subchannel")
	vendor.RegisterType((*ChannelConnectivityState)(nil), "grpc.channelz.v1.ChannelConnectivityState")
	vendor.RegisterType((*ChannelData)(nil), "grpc.channelz.v1.ChannelData")
	vendor.RegisterType((*ChannelTraceEvent)(nil), "grpc.channelz.v1.ChannelTraceEvent")
	vendor.RegisterType((*ChannelTrace)(nil), "grpc.channelz.v1.ChannelTrace")
	vendor.RegisterType((*ChannelRef)(nil), "grpc.channelz.v1.ChannelRef")
	vendor.RegisterType((*SubchannelRef)(nil), "grpc.channelz.v1.SubchannelRef")
	vendor.RegisterType((*SocketRef)(nil), "grpc.channelz.v1.SocketRef")
	vendor.RegisterType((*ServerRef)(nil), "grpc.channelz.v1.ServerRef")
	vendor.RegisterType((*Server)(nil), "grpc.channelz.v1.Server")
	vendor.RegisterType((*ServerData)(nil), "grpc.channelz.v1.ServerData")
	vendor.RegisterType((*Socket)(nil), "grpc.channelz.v1.Socket")
	vendor.RegisterType((*SocketData)(nil), "grpc.channelz.v1.SocketData")
	vendor.RegisterType((*Address)(nil), "grpc.channelz.v1.Address")
	vendor.RegisterType((*Address_TcpIpAddress)(nil), "grpc.channelz.v1.Address.TcpIpAddress")
	vendor.RegisterType((*Address_UdsAddress)(nil), "grpc.channelz.v1.Address.UdsAddress")
	vendor.RegisterType((*Address_OtherAddress)(nil), "grpc.channelz.v1.Address.OtherAddress")
	vendor.RegisterType((*Security)(nil), "grpc.channelz.v1.Security")
	vendor.RegisterType((*Security_Tls)(nil), "grpc.channelz.v1.Security.Tls")
	vendor.RegisterType((*Security_OtherSecurity)(nil), "grpc.channelz.v1.Security.OtherSecurity")
	vendor.RegisterType((*SocketOption)(nil), "grpc.channelz.v1.SocketOption")
	vendor.RegisterType((*SocketOptionTimeout)(nil), "grpc.channelz.v1.SocketOptionTimeout")
	vendor.RegisterType((*SocketOptionLinger)(nil), "grpc.channelz.v1.SocketOptionLinger")
	vendor.RegisterType((*SocketOptionTcpInfo)(nil), "grpc.channelz.v1.SocketOptionTcpInfo")
	vendor.RegisterType((*GetTopChannelsRequest)(nil), "grpc.channelz.v1.GetTopChannelsRequest")
	vendor.RegisterType((*GetTopChannelsResponse)(nil), "grpc.channelz.v1.GetTopChannelsResponse")
	vendor.RegisterType((*GetServersRequest)(nil), "grpc.channelz.v1.GetServersRequest")
	vendor.RegisterType((*GetServersResponse)(nil), "grpc.channelz.v1.GetServersResponse")
	vendor.RegisterType((*GetServerRequest)(nil), "grpc.channelz.v1.GetServerRequest")
	vendor.RegisterType((*GetServerResponse)(nil), "grpc.channelz.v1.GetServerResponse")
	vendor.RegisterType((*GetServerSocketsRequest)(nil), "grpc.channelz.v1.GetServerSocketsRequest")
	vendor.RegisterType((*GetServerSocketsResponse)(nil), "grpc.channelz.v1.GetServerSocketsResponse")
	vendor.RegisterType((*GetChannelRequest)(nil), "grpc.channelz.v1.GetChannelRequest")
	vendor.RegisterType((*GetChannelResponse)(nil), "grpc.channelz.v1.GetChannelResponse")
	vendor.RegisterType((*GetSubchannelRequest)(nil), "grpc.channelz.v1.GetSubchannelRequest")
	vendor.RegisterType((*GetSubchannelResponse)(nil), "grpc.channelz.v1.GetSubchannelResponse")
	vendor.RegisterType((*GetSocketRequest)(nil), "grpc.channelz.v1.GetSocketRequest")
	vendor.RegisterType((*GetSocketResponse)(nil), "grpc.channelz.v1.GetSocketResponse")
	vendor.RegisterEnum("grpc.channelz.v1.ChannelConnectivityState_State", ChannelConnectivityState_State_name, ChannelConnectivityState_State_value)
	vendor.RegisterEnum("grpc.channelz.v1.ChannelTraceEvent_Severity", ChannelTraceEvent_Severity_name, ChannelTraceEvent_Severity_value)
}

// Reference imports to suppress errors if they are not otherwise used.
var _ vendor.Context
...
type ChannelzClient interface {
	...
	GetTopChannels(ctx vendor.Context, in *GetTopChannelsRequest, opts ...grpc.CallOption) (*GetTopChannelsResponse, error)
	// Gets all servers that exist in the process.
	GetServers(ctx vendor.Context, in *GetServersRequest, opts ...grpc.CallOption) (*GetServersResponse, error)
	// Returns a single Server, or else a NOT_FOUND code.
	GetServer(ctx vendor.Context, in *GetServerRequest, opts ...grpc.CallOption) (*GetServerResponse, error)
	// Gets all server sockets that exist in the process.
	GetServerSockets(ctx vendor.Context, in *GetServerSocketsRequest, opts ...grpc.CallOption) (*GetServerSocketsResponse, error)
	// Returns a single Channel, or else a NOT_FOUND code.
	GetChannel(ctx vendor.Context, in *GetChannelRequest, opts ...grpc.CallOption) (*GetChannelResponse, error)
	// Returns a single Subchannel, or else a NOT_FOUND code.
	GetSubchannel(ctx vendor.Context, in *GetSubchannelRequest, opts ...grpc.CallOption) (*GetSubchannelResponse, error)
	// Returns a single Socket or else a NOT_FOUND code.
	GetSocket(ctx vendor.Context, in *GetSocketRequest, opts ...grpc.CallOption) (*GetSocketResponse, error)
}
...
func (c *channelzClient) GetTopChannels(ctx vendor.Context, in *GetTopChannelsRequest, opts ...grpc.CallOption) (*GetTopChannelsResponse, error) {
...
func (c *channelzClient) GetServers(ctx vendor.Context, in *GetServersRequest, opts ...grpc.CallOption) (*GetServersResponse, error) {
...
func (c *channelzClient) GetServer(ctx vendor.Context, in *GetServerRequest, opts ...grpc.CallOption) (*GetServerResponse, error) {
...
func (c *channelzClient) GetServerSockets(ctx vendor.Context, in *GetServerSocketsRequest, opts ...grpc.CallOption) (*GetServerSocketsResponse, error) {
...
func (c *channelzClient) GetChannel(ctx vendor.Context, in *GetChannelRequest, opts ...grpc.CallOption) (*GetChannelResponse, error) {
...
func (c *channelzClient) GetSubchannel(ctx vendor.Context, in *GetSubchannelRequest, opts ...grpc.CallOption) (*GetSubchannelResponse, error) {
...
func (c *channelzClient) GetSocket(ctx vendor.Context, in *GetSocketRequest, opts ...grpc.CallOption) (*GetSocketResponse, error) {
...
type ChannelzServer interface {
	// Gets all root channels (i.e. channels the application has directly
	// created). This does not include subchannels nor non-top level channels.
	GetTopChannels(vendor.Context, *GetTopChannelsRequest) (*GetTopChannelsResponse, error)
	// Gets all servers that exist in the process.
	GetServers(vendor.Context, *GetServersRequest) (*GetServersResponse, error)
	// Returns a single Server, or else a NOT_FOUND code.
	GetServer(vendor.Context, *GetServerRequest) (*GetServerResponse, error)
	// Gets all server sockets that exist in the process.
	GetServerSockets(vendor.Context, *GetServerSocketsRequest) (*GetServerSocketsResponse, error)
	// Returns a single Channel, or else a NOT_FOUND code.
	GetChannel(vendor.Context, *GetChannelRequest) (*GetChannelResponse, error)
	// Returns a single Subchannel, or else a NOT_FOUND code.
	GetSubchannel(vendor.Context, *GetSubchannelRequest) (*GetSubchannelResponse, error)
	// Returns a single Socket or else a NOT_FOUND code.
	GetSocket(vendor.Context, *GetSocketRequest) (*GetSocketResponse, error)
}
...
func _Channelz_GetTopChannels_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx vendor.Context, req interface{}) (interface{}, error) {
		return srv.(ChannelzServer).GetTopChannels(ctx, req.(*GetTopChannelsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Channelz_GetServers_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func _Channelz_GetServer_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func _Channelz_GetServerSockets_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func _Channelz_GetChannel_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func _Channelz_GetSubchannel_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func _Channelz_GetSocket_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func init() {
	vendor.RegisterFile("grpc/channelz/v1/channelz.proto", fileDescriptor_channelz_449295370a82a4c0)
}
