...
func Test_parseFullServiceConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: &vendor.serviceConfig{
				LoadBalancingConfig: &[]map[string]*vendor.grpclbServiceConfig{
					{"grpclb": &vendor.grpclbServiceConfig{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := vendor.parseFullServiceConfig(tt.s); !reflect.DeepEqual(got, tt.want) {
...
func Test_parseServiceConfig(t *testing.T) {
	tests := []struct {
		name string
		s    string
		want *vendor.grpclbServiceConfig
	}{
		{
			name: "empty",
			s:    "",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := vendor.parseServiceConfig(tt.s); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("parseFullServiceConfig() = %+v, want %+v", got, tt.want)
			}
		})
	}
...
func Test_childIsPickFirst(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := vendor.childIsPickFirst(tt.s); got != tt.want {
