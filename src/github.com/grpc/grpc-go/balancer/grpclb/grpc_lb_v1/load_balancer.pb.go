...
func (m *LoadBalanceRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *LoadBalanceRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoadBalanceRequest vendor.InternalMessageInfo
...
func (*LoadBalanceRequest) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _LoadBalanceRequest_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _LoadBalanceRequest_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*LoadBalanceRequest)
	switch tag {
...
func _LoadBalanceRequest_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*LoadBalanceRequest)
	// load_balance_request_type
	switch x := m.LoadBalanceRequestType.(type) {
	case *LoadBalanceRequest_InitialRequest:
		s := vendor.Size(x.InitialRequest)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *LoadBalanceRequest_ClientStats:
		s := vendor.Size(x.ClientStats)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *InitialLoadBalanceRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *InitialLoadBalanceRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_InitialLoadBalanceRequest vendor.InternalMessageInfo
...
func (m *ClientStatsPerToken) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClientStatsPerToken) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClientStatsPerToken vendor.InternalMessageInfo
...
type ClientStats struct {
	...
	Timestamp *vendor.Timestamp `protobuf:"bytes,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
...
func (m *ClientStats) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClientStats) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClientStats vendor.InternalMessageInfo

func (m *ClientStats) GetTimestamp() *vendor.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (m *LoadBalanceResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *LoadBalanceResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoadBalanceResponse vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*LoadBalanceResponse) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _LoadBalanceResponse_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _LoadBalanceResponse_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*LoadBalanceResponse)
	switch tag {
...
func _LoadBalanceResponse_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*LoadBalanceResponse)
	// load_balance_response_type
	switch x := m.LoadBalanceResponseType.(type) {
	case *LoadBalanceResponse_InitialResponse:
		s := vendor.Size(x.InitialResponse)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *LoadBalanceResponse_ServerList:
		s := vendor.Size(x.ServerList)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
type InitialLoadBalanceResponse struct {
	...
	// positive.
	ClientStatsReportInterval *vendor.Duration `protobuf:"bytes,2,opt,name=client_stats_report_interval,json=clientStatsReportInterval,proto3" json:"client_stats_report_interval,omitempty"`
	XXX_NoUnkeyedLiteral      struct{}         `json:"-"`
	XXX_unrecognized          []byte           `json:"-"`
	XXX_sizecache             int32            `json:"-"`
}
...
func (m *InitialLoadBalanceResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *InitialLoadBalanceResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_InitialLoadBalanceResponse vendor.InternalMessageInfo
...
func (m *InitialLoadBalanceResponse) GetClientStatsReportInterval() *vendor.Duration {
	if m != nil {
...
func (m *ServerList) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerList) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerList vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*LoadBalanceRequest)(nil), "grpc.lb.v1.LoadBalanceRequest")
	vendor.RegisterType((*InitialLoadBalanceRequest)(nil), "grpc.lb.v1.InitialLoadBalanceRequest")
	vendor.RegisterType((*ClientStatsPerToken)(nil), "grpc.lb.v1.ClientStatsPerToken")
	vendor.RegisterType((*ClientStats)(nil), "grpc.lb.v1.ClientStats")
	vendor.RegisterType((*LoadBalanceResponse)(nil), "grpc.lb.v1.LoadBalanceResponse")
	vendor.RegisterType((*InitialLoadBalanceResponse)(nil), "grpc.lb.v1.InitialLoadBalanceResponse")
	vendor.RegisterType((*ServerList)(nil), "grpc.lb.v1.ServerList")
	vendor.RegisterType((*Server)(nil), "grpc.lb.v1.Server")
}
...
type LoadBalancerClient interface {
	...
	BalanceLoad(ctx vendor.Context, opts ...grpc.CallOption) (LoadBalancer_BalanceLoadClient, error)
}
...
func (c *loadBalancerClient) BalanceLoad(ctx vendor.Context, opts ...grpc.CallOption) (LoadBalancer_BalanceLoadClient, error) {
...
func init() {
	vendor.RegisterFile("grpc/lb/v1/load_balancer.proto", fileDescriptor_load_balancer_12026aec3f0251ba)
}
