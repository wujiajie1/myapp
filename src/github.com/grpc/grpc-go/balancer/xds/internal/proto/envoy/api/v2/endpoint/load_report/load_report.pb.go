...
func (m *UpstreamLocalityStats) String() string { return vendor.CompactTextString(m) }
...
func (dst *UpstreamLocalityStats) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UpstreamLocalityStats vendor.InternalMessageInfo
...
type UpstreamEndpointStats struct {
	...
	Metadata                *vendor.Struct             `protobuf:"bytes,6,opt,name=metadata,proto3" json:"metadata,omitempty"`
	TotalSuccessfulRequests uint64                     `protobuf:"varint,2,opt,name=total_successful_requests,json=totalSuccessfulRequests,proto3" json:"total_successful_requests,omitempty"`
	TotalRequestsInProgress uint64                     `protobuf:"varint,3,opt,name=total_requests_in_progress,json=totalRequestsInProgress,proto3" json:"total_requests_in_progress,omitempty"`
	TotalErrorRequests      uint64                     `protobuf:"varint,4,opt,name=total_error_requests,json=totalErrorRequests,proto3" json:"total_error_requests,omitempty"`
	LoadMetricStats         []*EndpointLoadMetricStats `protobuf:"bytes,5,rep,name=load_metric_stats,json=loadMetricStats,proto3" json:"load_metric_stats,omitempty"`
...
func (m *UpstreamEndpointStats) String() string { return vendor.CompactTextString(m) }
...
func (dst *UpstreamEndpointStats) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UpstreamEndpointStats vendor.InternalMessageInfo
...
func (m *UpstreamEndpointStats) GetMetadata() *vendor.Struct {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *EndpointLoadMetricStats) String() string { return vendor.CompactTextString(m) }
...
func (dst *EndpointLoadMetricStats) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_EndpointLoadMetricStats vendor.InternalMessageInfo
...
type ClusterStats struct {
	...
	LoadReportInterval    *vendor.Duration                `protobuf:"bytes,4,opt,name=load_report_interval,json=loadReportInterval,proto3" json:"load_report_interval,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                        `json:"-"`
	XXX_unrecognized      []byte                          `json:"-"`
	XXX_sizecache         int32                           `json:"-"`
}
...
func (m *ClusterStats) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClusterStats) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClusterStats vendor.InternalMessageInfo
...
func (m *ClusterStats) GetLoadReportInterval() *vendor.Duration {
	if m != nil {
...
func (m *ClusterStats_DroppedRequests) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClusterStats_DroppedRequests) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClusterStats_DroppedRequests vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*UpstreamLocalityStats)(nil), "envoy.api.v2.endpoint.UpstreamLocalityStats")
	vendor.RegisterType((*UpstreamEndpointStats)(nil), "envoy.api.v2.endpoint.UpstreamEndpointStats")
	vendor.RegisterType((*EndpointLoadMetricStats)(nil), "envoy.api.v2.endpoint.EndpointLoadMetricStats")
	vendor.RegisterType((*ClusterStats)(nil), "envoy.api.v2.endpoint.ClusterStats")
	vendor.RegisterType((*ClusterStats_DroppedRequests)(nil), "envoy.api.v2.endpoint.ClusterStats.DroppedRequests")
}

func init() {
	vendor.RegisterFile("envoy/api/v2/endpoint/load_report.proto", fileDescriptor_load_report_5485b60725c658b8)
}
