...
func (x TlsParameters_TlsProtocol) String() string {
	return vendor.EnumName(TlsParameters_TlsProtocol_name, int32(x))
}
...
func (m *TlsParameters) String() string { return vendor.CompactTextString(m) }
...
func (dst *TlsParameters) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_TlsParameters vendor.InternalMessageInfo
...
func (m *TlsCertificate) String() string { return vendor.CompactTextString(m) }
...
func (dst *TlsCertificate) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_TlsCertificate vendor.InternalMessageInfo
...
func (m *TlsSessionTicketKeys) String() string { return vendor.CompactTextString(m) }
...
func (dst *TlsSessionTicketKeys) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_TlsSessionTicketKeys vendor.InternalMessageInfo
...
type CertificateValidationContext struct {
	...
	RequireOcspStaple                 *vendor.BoolValue `protobuf:"bytes,5,opt,name=require_ocsp_staple,json=requireOcspStaple,proto3" json:"require_ocsp_staple,omitempty"`
	RequireSignedCertificateTimestamp *vendor.BoolValue `protobuf:"bytes,6,opt,name=require_signed_certificate_timestamp,json=requireSignedCertificateTimestamp,proto3" json:"require_signed_certificate_timestamp,omitempty"`
...
func (m *CertificateValidationContext) String() string { return vendor.CompactTextString(m) }
...
func (dst *CertificateValidationContext) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CertificateValidationContext vendor.InternalMessageInfo
...
func (m *CertificateValidationContext) GetRequireOcspStaple() *vendor.BoolValue {
	if m != nil {
...
func (m *CertificateValidationContext) GetRequireSignedCertificateTimestamp() *vendor.BoolValue {
	if m != nil {
...
func (m *CommonTlsContext) String() string { return vendor.CompactTextString(m) }
...
func (dst *CommonTlsContext) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CommonTlsContext vendor.InternalMessageInfo
...
func (*CommonTlsContext) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _CommonTlsContext_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _CommonTlsContext_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*CommonTlsContext)
	switch tag {
...
func _CommonTlsContext_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*CommonTlsContext)
	// validation_context_type
	switch x := m.ValidationContextType.(type) {
	case *CommonTlsContext_ValidationContext:
		s := vendor.Size(x.ValidationContext)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *CommonTlsContext_ValidationContextSdsSecretConfig:
		s := vendor.Size(x.ValidationContextSdsSecretConfig)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *CommonTlsContext_CombinedValidationContext:
		s := vendor.Size(x.CombinedValidationContext)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (dst *CommonTlsContext_CombinedCertificateValidationContext) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CommonTlsContext_CombinedCertificateValidationContext vendor.InternalMessageInfo
...
type UpstreamTlsContext struct {
	...
	MaxSessionKeys       *vendor.UInt32Value `protobuf:"bytes,4,opt,name=max_session_keys,json=maxSessionKeys,proto3" json:"max_session_keys,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *UpstreamTlsContext) String() string { return vendor.CompactTextString(m) }
...
func (dst *UpstreamTlsContext) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UpstreamTlsContext vendor.InternalMessageInfo
...
func (m *UpstreamTlsContext) GetMaxSessionKeys() *vendor.UInt32Value {
	if m != nil {
...
type DownstreamTlsContext struct {
	CommonTlsContext         *CommonTlsContext `protobuf:"bytes,1,opt,name=common_tls_context,json=commonTlsContext,proto3" json:"common_tls_context,omitempty"`
	RequireClientCertificate *vendor.BoolValue `protobuf:"bytes,2,opt,name=require_client_certificate,json=requireClientCertificate,proto3" json:"require_client_certificate,omitempty"`
	RequireSni               *vendor.BoolValue `protobuf:"bytes,3,opt,name=require_sni,json=requireSni,proto3" json:"require_sni,omitempty"`
...
func (m *DownstreamTlsContext) String() string { return vendor.CompactTextString(m) }
...
func (dst *DownstreamTlsContext) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DownstreamTlsContext vendor.InternalMessageInfo
...
func (m *DownstreamTlsContext) GetRequireClientCertificate() *vendor.BoolValue {
	if m != nil {
...
func (m *DownstreamTlsContext) GetRequireSni() *vendor.BoolValue {
	if m != nil {
		return m.RequireSni
	}
	return nil
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*DownstreamTlsContext) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _DownstreamTlsContext_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _DownstreamTlsContext_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*DownstreamTlsContext)
	switch tag {
...
func _DownstreamTlsContext_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*DownstreamTlsContext)
	// session_ticket_keys_type
	switch x := m.SessionTicketKeysType.(type) {
	case *DownstreamTlsContext_SessionTicketKeys:
		s := vendor.Size(x.SessionTicketKeys)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *DownstreamTlsContext_SessionTicketKeysSdsSecretConfig:
		s := vendor.Size(x.SessionTicketKeysSdsSecretConfig)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *SdsSecretConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *SdsSecretConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SdsSecretConfig vendor.InternalMessageInfo
...
func (m *Secret) String() string { return vendor.CompactTextString(m) }
...
func (dst *Secret) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Secret vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Secret) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _Secret_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*Secret)
	// type
...
func _Secret_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*Secret)
	switch tag {
...
func _Secret_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*Secret)
	// type
	switch x := m.Type.(type) {
	case *Secret_TlsCertificate:
		s := vendor.Size(x.TlsCertificate)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *Secret_SessionTicketKeys:
...
func init() {
	vendor.RegisterType((*TlsParameters)(nil), "envoy.api.v2.auth.TlsParameters")
	vendor.RegisterType((*TlsCertificate)(nil), "envoy.api.v2.auth.TlsCertificate")
	vendor.RegisterType((*TlsSessionTicketKeys)(nil), "envoy.api.v2.auth.TlsSessionTicketKeys")
	vendor.RegisterType((*CertificateValidationContext)(nil), "envoy.api.v2.auth.CertificateValidationContext")
	vendor.RegisterType((*CommonTlsContext)(nil), "envoy.api.v2.auth.CommonTlsContext")
	vendor.RegisterType((*CommonTlsContext_CombinedCertificateValidationContext)(nil), "envoy.api.v2.auth.CommonTlsContext.CombinedCertificateValidationContext")
	vendor.RegisterType((*UpstreamTlsContext)(nil), "envoy.api.v2.auth.UpstreamTlsContext")
	vendor.RegisterType((*DownstreamTlsContext)(nil), "envoy.api.v2.auth.DownstreamTlsContext")
	vendor.RegisterType((*SdsSecretConfig)(nil), "envoy.api.v2.auth.SdsSecretConfig")
	vendor.RegisterType((*Secret)(nil), "envoy.api.v2.auth.Secret")
	vendor.RegisterEnum("envoy.api.v2.auth.TlsParameters_TlsProtocol", TlsParameters_TlsProtocol_name, TlsParameters_TlsProtocol_value)
}

func init() { vendor.RegisterFile("envoy/api/v2/auth/cert.proto", fileDescriptor_cert_f82beca1d890b9d7) }
