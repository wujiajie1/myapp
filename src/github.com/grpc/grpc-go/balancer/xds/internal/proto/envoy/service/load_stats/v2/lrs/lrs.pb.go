...
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/endpoint/load_report"
...
func (m *LoadStatsRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *LoadStatsRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoadStatsRequest vendor.InternalMessageInfo
...
type LoadStatsResponse struct {
	...
	LoadReportingInterval     *vendor.Duration `protobuf:"bytes,2,opt,name=load_reporting_interval,json=loadReportingInterval,proto3" json:"load_reporting_interval,omitempty"`
...
func (m *LoadStatsResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *LoadStatsResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LoadStatsResponse vendor.InternalMessageInfo
...
func (m *LoadStatsResponse) GetLoadReportingInterval() *vendor.Duration {
	if m != nil {
...
func init() {
	vendor.RegisterType((*LoadStatsRequest)(nil), "envoy.service.load_stats.v2.LoadStatsRequest")
	vendor.RegisterType((*LoadStatsResponse)(nil), "envoy.service.load_stats.v2.LoadStatsResponse")
}
...
type LoadReportingServiceClient interface {
	StreamLoadStats(ctx vendor.Context, opts ...grpc.CallOption) (LoadReportingService_StreamLoadStatsClient, error)
}
...
func (c *loadReportingServiceClient) StreamLoadStats(ctx vendor.Context, opts ...grpc.CallOption) (LoadReportingService_StreamLoadStatsClient, error) {
...
func init() {
	vendor.RegisterFile("envoy/service/load_stats/v2/lrs.proto", fileDescriptor_lrs_0f8f2c1d40a1b9f7)
}
