...
func (x RoutingPriority) String() string {
	return vendor.EnumName(RoutingPriority_name, int32(x))
}
...
func (x RequestMethod) String() string {
	return vendor.EnumName(RequestMethod_name, int32(x))
}
...
func (x SocketOption_SocketState) String() string {
	return vendor.EnumName(SocketOption_SocketState_name, int32(x))
}
...
func (m *Locality) String() string { return vendor.CompactTextString(m) }
...
func (dst *Locality) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Locality vendor.InternalMessageInfo
...
type Node struct {
	...
	Metadata             *vendor.Struct `protobuf:"bytes,3,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
func (m *Node) String() string { return vendor.CompactTextString(m) }
...
func (dst *Node) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Node vendor.InternalMessageInfo
...
func (m *Node) GetMetadata() *vendor.Struct {
	if m != nil {
		return m.Metadata
	}
	return nil
...
type Metadata struct {
	FilterMetadata       map[string]*vendor.Struct `protobuf:"bytes,1,rep,name=filter_metadata,json=filterMetadata,proto3" json:"filter_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *Metadata) String() string { return vendor.CompactTextString(m) }
...
func (dst *Metadata) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Metadata vendor.InternalMessageInfo

func (m *Metadata) GetFilterMetadata() map[string]*vendor.Struct {
	if m != nil {
...
func (m *RuntimeUInt32) String() string { return vendor.CompactTextString(m) }
...
func (dst *RuntimeUInt32) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_RuntimeUInt32 vendor.InternalMessageInfo
...
func (m *HeaderValue) String() string { return vendor.CompactTextString(m) }
...
func (dst *HeaderValue) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HeaderValue vendor.InternalMessageInfo
...
type HeaderValueOption struct {
	...
	Append               *vendor.BoolValue `protobuf:"bytes,2,opt,name=append,proto3" json:"append,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *HeaderValueOption) String() string { return vendor.CompactTextString(m) }
...
func (dst *HeaderValueOption) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HeaderValueOption vendor.InternalMessageInfo
...
func (m *HeaderValueOption) GetAppend() *vendor.BoolValue {
	if m != nil {
		return m.Append
	}
	return nil
...
func (m *HeaderMap) String() string { return vendor.CompactTextString(m) }
...
func (dst *HeaderMap) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HeaderMap vendor.InternalMessageInfo
...
func (m *DataSource) String() string { return vendor.CompactTextString(m) }
...
func (dst *DataSource) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DataSource vendor.InternalMessageInfo
...
func (*DataSource) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _DataSource_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*DataSource)
	// specifier
...
func _DataSource_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*DataSource)
	switch tag {
...
func _DataSource_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*DataSource)
	// specifier
	switch x := m.Specifier.(type) {
	case *DataSource_Filename:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.Filename)))
		n += len(x.Filename)
	case *DataSource_InlineBytes:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.InlineBytes)))
		n += len(x.InlineBytes)
	case *DataSource_InlineString:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.InlineString)))
...
func (m *TransportSocket) String() string { return vendor.CompactTextString(m) }
...
func (dst *TransportSocket) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_TransportSocket vendor.InternalMessageInfo
...
func (m *TransportSocket) GetConfig() *vendor.Struct {
...
func (m *TransportSocket) GetTypedConfig() *vendor.Any {
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*TransportSocket) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _TransportSocket_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _TransportSocket_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*TransportSocket)
	switch tag {
...
func _TransportSocket_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*TransportSocket)
	// config_type
	switch x := m.ConfigType.(type) {
	case *TransportSocket_Config:
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*SocketOption) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _SocketOption_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*SocketOption)
	// value
	switch x := m.Value.(type) {
	case *SocketOption_IntValue:
		b.EncodeVarint(4<<3 | vendor.WireVarint)
...
func _SocketOption_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*SocketOption)
	switch tag {
...
func _SocketOption_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*SocketOption)
	// value
	switch x := m.Value.(type) {
	case *SocketOption_IntValue:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(x.IntValue))
	case *SocketOption_BufValue:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.BufValue)))
		n += len(x.BufValue)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
...
func (m *RuntimeFractionalPercent) String() string { return vendor.CompactTextString(m) }
...
func (dst *RuntimeFractionalPercent) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_RuntimeFractionalPercent vendor.InternalMessageInfo
...
func (m *ControlPlane) String() string { return vendor.CompactTextString(m) }
...
func (dst *ControlPlane) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ControlPlane vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Locality)(nil), "envoy.api.v2.core.Locality")
	vendor.RegisterType((*Node)(nil), "envoy.api.v2.core.Node")
	vendor.RegisterType((*Metadata)(nil), "envoy.api.v2.core.Metadata")
	vendor.RegisterMapType((map[string]*vendor.Struct)(nil), "envoy.api.v2.core.Metadata.FilterMetadataEntry")
	vendor.RegisterType((*RuntimeUInt32)(nil), "envoy.api.v2.core.RuntimeUInt32")
	vendor.RegisterType((*HeaderValue)(nil), "envoy.api.v2.core.HeaderValue")
	vendor.RegisterType((*HeaderValueOption)(nil), "envoy.api.v2.core.HeaderValueOption")
	vendor.RegisterType((*HeaderMap)(nil), "envoy.api.v2.core.HeaderMap")
	vendor.RegisterType((*DataSource)(nil), "envoy.api.v2.core.DataSource")
	vendor.RegisterType((*TransportSocket)(nil), "envoy.api.v2.core.TransportSocket")
	vendor.RegisterType((*SocketOption)(nil), "envoy.api.v2.core.SocketOption")
	vendor.RegisterType((*RuntimeFractionalPercent)(nil), "envoy.api.v2.core.RuntimeFractionalPercent")
	vendor.RegisterType((*ControlPlane)(nil), "envoy.api.v2.core.ControlPlane")
	vendor.RegisterEnum("envoy.api.v2.core.RoutingPriority", RoutingPriority_name, RoutingPriority_value)
	vendor.RegisterEnum("envoy.api.v2.core.RequestMethod", RequestMethod_name, RequestMethod_value)
	vendor.RegisterEnum("envoy.api.v2.core.SocketOption_SocketState", SocketOption_SocketState_name, SocketOption_SocketState_value)
}

func init() { vendor.RegisterFile("envoy/api/v2/core/base.proto", fileDescriptor_base_33c58439b08f821d) }
