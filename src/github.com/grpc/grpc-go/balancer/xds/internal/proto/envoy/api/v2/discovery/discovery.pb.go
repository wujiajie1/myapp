...
func (m *DiscoveryRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *DiscoveryRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DiscoveryRequest vendor.InternalMessageInfo
...
type DiscoveryResponse struct {
	VersionInfo          string             `protobuf:"bytes,1,opt,name=version_info,json=versionInfo,proto3" json:"version_info,omitempty"`
	Resources            []*vendor.Any      `protobuf:"bytes,2,rep,name=resources,proto3" json:"resources,omitempty"`
...
func (m *DiscoveryResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *DiscoveryResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DiscoveryResponse vendor.InternalMessageInfo
...
func (m *DiscoveryResponse) GetResources() []*vendor.Any {
	if m != nil {
		return m.Resources
	}
	return nil
...
func (m *DeltaDiscoveryRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *DeltaDiscoveryRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DeltaDiscoveryRequest vendor.InternalMessageInfo
...
func (m *DeltaDiscoveryResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *DeltaDiscoveryResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DeltaDiscoveryResponse vendor.InternalMessageInfo
...
type Resource struct {
	...
	Resource             *vendor.Any `protobuf:"bytes,2,opt,name=resource,proto3" json:"resource,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Resource) String() string { return vendor.CompactTextString(m) }
...
func (dst *Resource) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Resource vendor.InternalMessageInfo
...
func (m *Resource) GetResource() *vendor.Any {
	if m != nil {
		return m.Resource
	}
	return nil
...
func init() {
	vendor.RegisterType((*DiscoveryRequest)(nil), "envoy.api.v2.DiscoveryRequest")
	vendor.RegisterType((*DiscoveryResponse)(nil), "envoy.api.v2.DiscoveryResponse")
	vendor.RegisterType((*DeltaDiscoveryRequest)(nil), "envoy.api.v2.DeltaDiscoveryRequest")
	vendor.RegisterMapType((map[string]string)(nil), "envoy.api.v2.DeltaDiscoveryRequest.InitialResourceVersionsEntry")
	vendor.RegisterType((*DeltaDiscoveryResponse)(nil), "envoy.api.v2.DeltaDiscoveryResponse")
	vendor.RegisterType((*Resource)(nil), "envoy.api.v2.Resource")
}

func init() {
	vendor.RegisterFile("envoy/api/v2/discovery.proto", fileDescriptor_discovery_a1ffda4a09a0e500)
}
