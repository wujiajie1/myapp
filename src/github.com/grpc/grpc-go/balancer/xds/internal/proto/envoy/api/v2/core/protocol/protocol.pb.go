...
func (m *TcpProtocolOptions) String() string { return vendor.CompactTextString(m) }
...
func (dst *TcpProtocolOptions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_TcpProtocolOptions vendor.InternalMessageInfo

type HttpProtocolOptions struct {
	IdleTimeout          *vendor.Duration `protobuf:"bytes,1,opt,name=idle_timeout,json=idleTimeout,proto3" json:"idle_timeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *HttpProtocolOptions) String() string { return vendor.CompactTextString(m) }
...
func (dst *HttpProtocolOptions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HttpProtocolOptions vendor.InternalMessageInfo

func (m *HttpProtocolOptions) GetIdleTimeout() *vendor.Duration {
	if m != nil {
...
type Http1ProtocolOptions struct {
	AllowAbsoluteUrl      *vendor.BoolValue `protobuf:"bytes,1,opt,name=allow_absolute_url,json=allowAbsoluteUrl,proto3" json:"allow_absolute_url,omitempty"`
...
func (m *Http1ProtocolOptions) String() string { return vendor.CompactTextString(m) }
...
func (dst *Http1ProtocolOptions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Http1ProtocolOptions vendor.InternalMessageInfo

func (m *Http1ProtocolOptions) GetAllowAbsoluteUrl() *vendor.BoolValue {
	if m != nil {
...
type Http2ProtocolOptions struct {
	HpackTableSize              *vendor.UInt32Value `protobuf:"bytes,1,opt,name=hpack_table_size,json=hpackTableSize,proto3" json:"hpack_table_size,omitempty"`
	MaxConcurrentStreams        *vendor.UInt32Value `protobuf:"bytes,2,opt,name=max_concurrent_streams,json=maxConcurrentStreams,proto3" json:"max_concurrent_streams,omitempty"`
	InitialStreamWindowSize     *vendor.UInt32Value `protobuf:"bytes,3,opt,name=initial_stream_window_size,json=initialStreamWindowSize,proto3" json:"initial_stream_window_size,omitempty"`
	InitialConnectionWindowSize *vendor.UInt32Value `protobuf:"bytes,4,opt,name=initial_connection_window_size,json=initialConnectionWindowSize,proto3" json:"initial_connection_window_size,omitempty"`
...
func (m *Http2ProtocolOptions) String() string { return vendor.CompactTextString(m) }
...
func (dst *Http2ProtocolOptions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Http2ProtocolOptions vendor.InternalMessageInfo

func (m *Http2ProtocolOptions) GetHpackTableSize() *vendor.UInt32Value {
	if m != nil {
...
func (m *Http2ProtocolOptions) GetMaxConcurrentStreams() *vendor.UInt32Value {
	if m != nil {
...
func (m *Http2ProtocolOptions) GetInitialStreamWindowSize() *vendor.UInt32Value {
	if m != nil {
...
func (m *Http2ProtocolOptions) GetInitialConnectionWindowSize() *vendor.UInt32Value {
	if m != nil {
...
func (m *GrpcProtocolOptions) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcProtocolOptions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcProtocolOptions vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*TcpProtocolOptions)(nil), "envoy.api.v2.core.TcpProtocolOptions")
	vendor.RegisterType((*HttpProtocolOptions)(nil), "envoy.api.v2.core.HttpProtocolOptions")
	vendor.RegisterType((*Http1ProtocolOptions)(nil), "envoy.api.v2.core.Http1ProtocolOptions")
	vendor.RegisterType((*Http2ProtocolOptions)(nil), "envoy.api.v2.core.Http2ProtocolOptions")
	vendor.RegisterType((*GrpcProtocolOptions)(nil), "envoy.api.v2.core.GrpcProtocolOptions")
}

func init() {
	vendor.RegisterFile("envoy/api/v2/core/protocol.proto", fileDescriptor_protocol_2e969372c85b867d)
}
