...
type OutlierDetection struct {
	Consecutive_5Xx                    *vendor.UInt32Value `protobuf:"bytes,1,opt,name=consecutive_5xx,json=consecutive5xx,proto3" json:"consecutive_5xx,omitempty"`
	Interval                           *vendor.Duration    `protobuf:"bytes,2,opt,name=interval,proto3" json:"interval,omitempty"`
	BaseEjectionTime                   *vendor.Duration    `protobuf:"bytes,3,opt,name=base_ejection_time,json=baseEjectionTime,proto3" json:"base_ejection_time,omitempty"`
	MaxEjectionPercent                 *vendor.UInt32Value `protobuf:"bytes,4,opt,name=max_ejection_percent,json=maxEjectionPercent,proto3" json:"max_ejection_percent,omitempty"`
	EnforcingConsecutive_5Xx           *vendor.UInt32Value `protobuf:"bytes,5,opt,name=enforcing_consecutive_5xx,json=enforcingConsecutive5xx,proto3" json:"enforcing_consecutive_5xx,omitempty"`
	EnforcingSuccessRate               *vendor.UInt32Value `protobuf:"bytes,6,opt,name=enforcing_success_rate,json=enforcingSuccessRate,proto3" json:"enforcing_success_rate,omitempty"`
	SuccessRateMinimumHosts            *vendor.UInt32Value `protobuf:"bytes,7,opt,name=success_rate_minimum_hosts,json=successRateMinimumHosts,proto3" json:"success_rate_minimum_hosts,omitempty"`
	SuccessRateRequestVolume           *vendor.UInt32Value `protobuf:"bytes,8,opt,name=success_rate_request_volume,json=successRateRequestVolume,proto3" json:"success_rate_request_volume,omitempty"`
	SuccessRateStdevFactor             *vendor.UInt32Value `protobuf:"bytes,9,opt,name=success_rate_stdev_factor,json=successRateStdevFactor,proto3" json:"success_rate_stdev_factor,omitempty"`
	ConsecutiveGatewayFailure          *vendor.UInt32Value `protobuf:"bytes,10,opt,name=consecutive_gateway_failure,json=consecutiveGatewayFailure,proto3" json:"consecutive_gateway_failure,omitempty"`
	EnforcingConsecutiveGatewayFailure *vendor.UInt32Value `protobuf:"bytes,11,opt,name=enforcing_consecutive_gateway_failure,json=enforcingConsecutiveGatewayFailure,proto3" json:"enforcing_consecutive_gateway_failure,omitempty"`
...
func (m *OutlierDetection) String() string { return vendor.CompactTextString(m) }
...
func (dst *OutlierDetection) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_OutlierDetection vendor.InternalMessageInfo

func (m *OutlierDetection) GetConsecutive_5Xx() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetInterval() *vendor.Duration {
	if m != nil {
		return m.Interval
	}
	return nil
...
func (m *OutlierDetection) GetBaseEjectionTime() *vendor.Duration {
	if m != nil {
...
func (m *OutlierDetection) GetMaxEjectionPercent() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetEnforcingConsecutive_5Xx() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetEnforcingSuccessRate() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetSuccessRateMinimumHosts() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetSuccessRateRequestVolume() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetSuccessRateStdevFactor() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetConsecutiveGatewayFailure() *vendor.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetEnforcingConsecutiveGatewayFailure() *vendor.UInt32Value {
	if m != nil {
...
func init() {
	vendor.RegisterType((*OutlierDetection)(nil), "envoy.api.v2.cluster.OutlierDetection")
}

func init() {
	vendor.RegisterFile("envoy/api/v2/cluster/outlier_detection.proto", fileDescriptor_outlier_detection_c374e0b25113dd85)
}
