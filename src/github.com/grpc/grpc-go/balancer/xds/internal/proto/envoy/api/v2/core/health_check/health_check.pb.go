...
func (x HealthStatus) String() string {
	return vendor.EnumName(HealthStatus_name, int32(x))
}
...
type HealthCheck struct {
	Timeout               *vendor.Duration    `protobuf:"bytes,1,opt,name=timeout,proto3" json:"timeout,omitempty"`
	Interval              *vendor.Duration    `protobuf:"bytes,2,opt,name=interval,proto3" json:"interval,omitempty"`
	IntervalJitter        *vendor.Duration    `protobuf:"bytes,3,opt,name=interval_jitter,json=intervalJitter,proto3" json:"interval_jitter,omitempty"`
	...
	UnhealthyThreshold    *vendor.UInt32Value `protobuf:"bytes,4,opt,name=unhealthy_threshold,json=unhealthyThreshold,proto3" json:"unhealthy_threshold,omitempty"`
	HealthyThreshold      *vendor.UInt32Value `protobuf:"bytes,5,opt,name=healthy_threshold,json=healthyThreshold,proto3" json:"healthy_threshold,omitempty"`
	AltPort               *vendor.UInt32Value `protobuf:"bytes,6,opt,name=alt_port,json=altPort,proto3" json:"alt_port,omitempty"`
	ReuseConnection       *vendor.BoolValue   `protobuf:"bytes,7,opt,name=reuse_connection,json=reuseConnection,proto3" json:"reuse_connection,omitempty"`
	...
	NoTrafficInterval            *vendor.Duration            `protobuf:"bytes,12,opt,name=no_traffic_interval,json=noTrafficInterval,proto3" json:"no_traffic_interval,omitempty"`
	UnhealthyInterval            *vendor.Duration            `protobuf:"bytes,14,opt,name=unhealthy_interval,json=unhealthyInterval,proto3" json:"unhealthy_interval,omitempty"`
	UnhealthyEdgeInterval        *vendor.Duration            `protobuf:"bytes,15,opt,name=unhealthy_edge_interval,json=unhealthyEdgeInterval,proto3" json:"unhealthy_edge_interval,omitempty"`
	HealthyEdgeInterval          *vendor.Duration            `protobuf:"bytes,16,opt,name=healthy_edge_interval,json=healthyEdgeInterval,proto3" json:"healthy_edge_interval,omitempty"`
...
func (m *HealthCheck) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheck) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheck vendor.InternalMessageInfo

func (m *HealthCheck) GetTimeout() *vendor.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *HealthCheck) GetInterval() *vendor.Duration {
	if m != nil {
		return m.Interval
	}
	return nil
...
func (m *HealthCheck) GetIntervalJitter() *vendor.Duration {
	if m != nil {
...
func (m *HealthCheck) GetUnhealthyThreshold() *vendor.UInt32Value {
	if m != nil {
...
func (m *HealthCheck) GetHealthyThreshold() *vendor.UInt32Value {
	if m != nil {
...
func (m *HealthCheck) GetAltPort() *vendor.UInt32Value {
	if m != nil {
		return m.AltPort
	}
	return nil
...
func (m *HealthCheck) GetReuseConnection() *vendor.BoolValue {
	if m != nil {
...
func (m *HealthCheck) GetNoTrafficInterval() *vendor.Duration {
	if m != nil {
...
func (m *HealthCheck) GetUnhealthyInterval() *vendor.Duration {
	if m != nil {
...
func (m *HealthCheck) GetUnhealthyEdgeInterval() *vendor.Duration {
	if m != nil {
...
func (m *HealthCheck) GetHealthyEdgeInterval() *vendor.Duration {
	if m != nil {
...
func (*HealthCheck) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _HealthCheck_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*HealthCheck)
	// health_checker
...
func _HealthCheck_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*HealthCheck)
	switch tag {
...
func _HealthCheck_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*HealthCheck)
	// health_checker
	switch x := m.HealthChecker.(type) {
	case *HealthCheck_HttpHealthCheck_:
		s := vendor.Size(x.HttpHealthCheck)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *HealthCheck_TcpHealthCheck_:
		s := vendor.Size(x.TcpHealthCheck)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *HealthCheck_GrpcHealthCheck_:
		s := vendor.Size(x.GrpcHealthCheck)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *HealthCheck_CustomHealthCheck_:
		s := vendor.Size(x.CustomHealthCheck)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *HealthCheck_Payload) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheck_Payload) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheck_Payload vendor.InternalMessageInfo
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*HealthCheck_Payload) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _HealthCheck_Payload_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _HealthCheck_Payload_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*HealthCheck_Payload)
	switch tag {
	case 1: // payload.text
		if wire != vendor.WireBytes {
...
func _HealthCheck_Payload_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*HealthCheck_Payload)
	// payload
	switch x := m.Payload.(type) {
	case *HealthCheck_Payload_Text:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.Text)))
		n += len(x.Text)
	case *HealthCheck_Payload_Binary:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.Binary)))
		n += len(x.Binary)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
...
func (m *HealthCheck_HttpHealthCheck) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheck_HttpHealthCheck) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheck_HttpHealthCheck vendor.InternalMessageInfo
...
func (m *HealthCheck_TcpHealthCheck) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheck_TcpHealthCheck) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheck_TcpHealthCheck vendor.InternalMessageInfo
...
func (m *HealthCheck_RedisHealthCheck) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheck_RedisHealthCheck) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheck_RedisHealthCheck vendor.InternalMessageInfo
...
func (m *HealthCheck_GrpcHealthCheck) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheck_GrpcHealthCheck) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheck_GrpcHealthCheck vendor.InternalMessageInfo
...
func (m *HealthCheck_CustomHealthCheck) String() string { return vendor.CompactTextString(m) }
...
func (dst *HealthCheck_CustomHealthCheck) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_HealthCheck_CustomHealthCheck vendor.InternalMessageInfo
...
func (m *HealthCheck_CustomHealthCheck) GetConfig() *vendor.Struct {
...
func (m *HealthCheck_CustomHealthCheck) GetTypedConfig() *vendor.Any {
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*HealthCheck_CustomHealthCheck) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _HealthCheck_CustomHealthCheck_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _HealthCheck_CustomHealthCheck_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*HealthCheck_CustomHealthCheck)
	switch tag {
...
func _HealthCheck_CustomHealthCheck_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*HealthCheck_CustomHealthCheck)
	// config_type
	switch x := m.ConfigType.(type) {
	case *HealthCheck_CustomHealthCheck_Config:
...
func init() {
	vendor.RegisterType((*HealthCheck)(nil), "envoy.api.v2.core.HealthCheck")
	vendor.RegisterType((*HealthCheck_Payload)(nil), "envoy.api.v2.core.HealthCheck.Payload")
	vendor.RegisterType((*HealthCheck_HttpHealthCheck)(nil), "envoy.api.v2.core.HealthCheck.HttpHealthCheck")
	vendor.RegisterType((*HealthCheck_TcpHealthCheck)(nil), "envoy.api.v2.core.HealthCheck.TcpHealthCheck")
	vendor.RegisterType((*HealthCheck_RedisHealthCheck)(nil), "envoy.api.v2.core.HealthCheck.RedisHealthCheck")
	vendor.RegisterType((*HealthCheck_GrpcHealthCheck)(nil), "envoy.api.v2.core.HealthCheck.GrpcHealthCheck")
	vendor.RegisterType((*HealthCheck_CustomHealthCheck)(nil), "envoy.api.v2.core.HealthCheck.CustomHealthCheck")
	vendor.RegisterEnum("envoy.api.v2.core.HealthStatus", HealthStatus_name, HealthStatus_value)
}

func init() {
	vendor.RegisterFile("envoy/api/v2/core/health_check.proto", fileDescriptor_health_check_96ed99a3bbe98749)
}
