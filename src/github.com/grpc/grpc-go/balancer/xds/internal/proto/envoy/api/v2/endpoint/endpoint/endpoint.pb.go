...
func (m *Endpoint_HealthCheckConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Endpoint_HealthCheckConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Endpoint_HealthCheckConfig vendor.InternalMessageInfo
...
type LbEndpoint struct {
	...
	LoadBalancingWeight  *vendor.UInt32Value         `protobuf:"bytes,4,opt,name=load_balancing_weight,json=loadBalancingWeight,proto3" json:"load_balancing_weight,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *LbEndpoint) String() string { return vendor.CompactTextString(m) }
...
func (dst *LbEndpoint) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LbEndpoint vendor.InternalMessageInfo
...
func (m *LbEndpoint) GetLoadBalancingWeight() *vendor.UInt32Value {
	if m != nil {
...
func (*LbEndpoint) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _LbEndpoint_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*LbEndpoint)
	// host_identifier
...
func _LbEndpoint_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*LbEndpoint)
	switch tag {
...
func _LbEndpoint_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*LbEndpoint)
	// host_identifier
	switch x := m.HostIdentifier.(type) {
	case *LbEndpoint_Endpoint:
		s := vendor.Size(x.Endpoint)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *LbEndpoint_EndpointName:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.EndpointName)))
...
type LocalityLbEndpoints struct {
	...
	LoadBalancingWeight  *vendor.UInt32Value `protobuf:"bytes,3,opt,name=load_balancing_weight,json=loadBalancingWeight,proto3" json:"load_balancing_weight,omitempty"`
...
func (m *LocalityLbEndpoints) String() string { return vendor.CompactTextString(m) }
...
func (dst *LocalityLbEndpoints) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_LocalityLbEndpoints vendor.InternalMessageInfo
...
func (m *LocalityLbEndpoints) GetLoadBalancingWeight() *vendor.UInt32Value {
	if m != nil {
		return m.LoadBalancingWeight
	}
	return nil
...
func init() {
	vendor.RegisterType((*Endpoint)(nil), "envoy.api.v2.endpoint.Endpoint")
	vendor.RegisterType((*Endpoint_HealthCheckConfig)(nil), "envoy.api.v2.endpoint.Endpoint.HealthCheckConfig")
	vendor.RegisterType((*LbEndpoint)(nil), "envoy.api.v2.endpoint.LbEndpoint")
	vendor.RegisterType((*LocalityLbEndpoints)(nil), "envoy.api.v2.endpoint.LocalityLbEndpoints")
}

func init() {
	vendor.RegisterFile("envoy/api/v2/endpoint/endpoint.proto", fileDescriptor_endpoint_2d1a533d75f3064c)
}
