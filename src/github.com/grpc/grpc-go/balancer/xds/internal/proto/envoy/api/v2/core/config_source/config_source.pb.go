...
import "fmt"
import "math"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/core/grpc_service"
...
func (x ApiConfigSource_ApiType) String() string {
	return vendor.EnumName(ApiConfigSource_ApiType_name, int32(x))
}
...
type ApiConfigSource struct {
	...
	RefreshDelay         *vendor.Duration            `protobuf:"bytes,3,opt,name=refresh_delay,json=refreshDelay,proto3" json:"refresh_delay,omitempty"`
	RequestTimeout       *vendor.Duration            `protobuf:"bytes,5,opt,name=request_timeout,json=requestTimeout,proto3" json:"request_timeout,omitempty"`
...
func (m *ApiConfigSource) String() string { return vendor.CompactTextString(m) }
...
func (dst *ApiConfigSource) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ApiConfigSource vendor.InternalMessageInfo
...
func (m *ApiConfigSource) GetRefreshDelay() *vendor.Duration {
	if m != nil {
...
func (m *ApiConfigSource) GetRequestTimeout() *vendor.Duration {
	if m != nil {
...
func (m *AggregatedConfigSource) String() string { return vendor.CompactTextString(m) }
...
func (dst *AggregatedConfigSource) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_AggregatedConfigSource vendor.InternalMessageInfo

type RateLimitSettings struct {
	MaxTokens            *vendor.UInt32Value `protobuf:"bytes,1,opt,name=max_tokens,json=maxTokens,proto3" json:"max_tokens,omitempty"`
	FillRate             *vendor.DoubleValue `protobuf:"bytes,2,opt,name=fill_rate,json=fillRate,proto3" json:"fill_rate,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *RateLimitSettings) String() string { return vendor.CompactTextString(m) }
...
func (dst *RateLimitSettings) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_RateLimitSettings vendor.InternalMessageInfo

func (m *RateLimitSettings) GetMaxTokens() *vendor.UInt32Value {
	if m != nil {
		return m.MaxTokens
	}
	return nil
...
func (m *RateLimitSettings) GetFillRate() *vendor.DoubleValue {
	if m != nil {
		return m.FillRate
	}
	return nil
...
type ConfigSource struct {
	...
	InitialFetchTimeout   *vendor.Duration                     `protobuf:"bytes,4,opt,name=initial_fetch_timeout,json=initialFetchTimeout,proto3" json:"initial_fetch_timeout,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                             `json:"-"`
	XXX_unrecognized      []byte                               `json:"-"`
	XXX_sizecache         int32                                `json:"-"`
}
...
func (m *ConfigSource) String() string { return vendor.CompactTextString(m) }
...
func (dst *ConfigSource) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ConfigSource vendor.InternalMessageInfo
...
func (m *ConfigSource) GetInitialFetchTimeout() *vendor.Duration {
	if m != nil {
...
func (*ConfigSource) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _ConfigSource_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*ConfigSource)
...
func _ConfigSource_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*ConfigSource)
	switch tag {
...
func _ConfigSource_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*ConfigSource)
	// config_source_specifier
	switch x := m.ConfigSourceSpecifier.(type) {
	case *ConfigSource_Path:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.Path)))
		n += len(x.Path)
	case *ConfigSource_ApiConfigSource:
		s := vendor.Size(x.ApiConfigSource)
		n += 1 // tag and wire
...
func init() {
	vendor.RegisterType((*ApiConfigSource)(nil), "envoy.api.v2.core.ApiConfigSource")
	vendor.RegisterType((*AggregatedConfigSource)(nil), "envoy.api.v2.core.AggregatedConfigSource")
	vendor.RegisterType((*RateLimitSettings)(nil), "envoy.api.v2.core.RateLimitSettings")
	vendor.RegisterType((*ConfigSource)(nil), "envoy.api.v2.core.ConfigSource")
	vendor.RegisterEnum("envoy.api.v2.core.ApiConfigSource_ApiType", ApiConfigSource_ApiType_name, ApiConfigSource_ApiType_value)
}

func init() {
	vendor.RegisterFile("envoy/api/v2/core/config_source.proto", fileDescriptor_config_source_d368846786cd1f7d)
}
