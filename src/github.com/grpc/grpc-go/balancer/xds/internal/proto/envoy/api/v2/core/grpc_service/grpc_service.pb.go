...
type GrpcService struct {
	...
	Timeout              *vendor.Duration              `protobuf:"bytes,3,opt,name=timeout,proto3" json:"timeout,omitempty"`
...
func (m *GrpcService) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcService) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService vendor.InternalMessageInfo
...
func (m *GrpcService) GetTimeout() *vendor.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (*GrpcService) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _GrpcService_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*GrpcService)
	// target_specifier
...
func _GrpcService_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*GrpcService)
	switch tag {
...
func _GrpcService_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*GrpcService)
	// target_specifier
	switch x := m.TargetSpecifier.(type) {
	case *GrpcService_EnvoyGrpc_:
		s := vendor.Size(x.EnvoyGrpc)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcService_GoogleGrpc_:
		s := vendor.Size(x.GoogleGrpc)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *GrpcService_EnvoyGrpc) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcService_EnvoyGrpc) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_EnvoyGrpc vendor.InternalMessageInfo
...
type GrpcService_GoogleGrpc struct {
	...
	Config                 *vendor.Struct                             `protobuf:"bytes,6,opt,name=config,proto3" json:"config,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                                   `json:"-"`
	XXX_unrecognized       []byte                                     `json:"-"`
	XXX_sizecache          int32                                      `json:"-"`
}
...
func (m *GrpcService_GoogleGrpc) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcService_GoogleGrpc) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc vendor.InternalMessageInfo
...
func (m *GrpcService_GoogleGrpc) GetConfig() *vendor.Struct {
	if m != nil {
		return m.Config
	}
	return nil
...
func (m *GrpcService_GoogleGrpc_SslCredentials) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcService_GoogleGrpc_SslCredentials) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc_SslCredentials vendor.InternalMessageInfo
...
func (dst *GrpcService_GoogleGrpc_GoogleLocalCredentials) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc_GoogleLocalCredentials vendor.InternalMessageInfo
...
func (m *GrpcService_GoogleGrpc_ChannelCredentials) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcService_GoogleGrpc_ChannelCredentials) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc_ChannelCredentials vendor.InternalMessageInfo
...
type GrpcService_GoogleGrpc_ChannelCredentials_GoogleDefault struct {
	GoogleDefault *vendor.Empty `protobuf:"bytes,2,opt,name=google_default,json=googleDefault,proto3,oneof"`
}
...
func (m *GrpcService_GoogleGrpc_ChannelCredentials) GetGoogleDefault() *vendor.Empty {
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*GrpcService_GoogleGrpc_ChannelCredentials) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _GrpcService_GoogleGrpc_ChannelCredentials_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _GrpcService_GoogleGrpc_ChannelCredentials_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*GrpcService_GoogleGrpc_ChannelCredentials)
	switch tag {
...
func _GrpcService_GoogleGrpc_ChannelCredentials_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*GrpcService_GoogleGrpc_ChannelCredentials)
	// credential_specifier
	switch x := m.CredentialSpecifier.(type) {
	case *GrpcService_GoogleGrpc_ChannelCredentials_SslCredentials:
		s := vendor.Size(x.SslCredentials)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcService_GoogleGrpc_ChannelCredentials_GoogleDefault:
		s := vendor.Size(x.GoogleDefault)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcService_GoogleGrpc_ChannelCredentials_LocalCredentials:
		s := vendor.Size(x.LocalCredentials)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *GrpcService_GoogleGrpc_CallCredentials) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcService_GoogleGrpc_CallCredentials) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc_CallCredentials vendor.InternalMessageInfo
...
type GrpcService_GoogleGrpc_CallCredentials_GoogleComputeEngine struct {
	GoogleComputeEngine *vendor.Empty `protobuf:"bytes,2,opt,name=google_compute_engine,json=googleComputeEngine,proto3,oneof"`
}
...
func (m *GrpcService_GoogleGrpc_CallCredentials) GetGoogleComputeEngine() *vendor.Empty {
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*GrpcService_GoogleGrpc_CallCredentials) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _GrpcService_GoogleGrpc_CallCredentials_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _GrpcService_GoogleGrpc_CallCredentials_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*GrpcService_GoogleGrpc_CallCredentials)
	switch tag {
...
func _GrpcService_GoogleGrpc_CallCredentials_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*GrpcService_GoogleGrpc_CallCredentials)
	// credential_specifier
	switch x := m.CredentialSpecifier.(type) {
	case *GrpcService_GoogleGrpc_CallCredentials_AccessToken:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.AccessToken)))
		n += len(x.AccessToken)
	case *GrpcService_GoogleGrpc_CallCredentials_GoogleComputeEngine:
		s := vendor.Size(x.GoogleComputeEngine)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcService_GoogleGrpc_CallCredentials_GoogleRefreshToken:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.GoogleRefreshToken)))
		n += len(x.GoogleRefreshToken)
	case *GrpcService_GoogleGrpc_CallCredentials_ServiceAccountJwtAccess:
		s := vendor.Size(x.ServiceAccountJwtAccess)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcService_GoogleGrpc_CallCredentials_GoogleIam:
		s := vendor.Size(x.GoogleIam)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcService_GoogleGrpc_CallCredentials_FromPlugin:
		s := vendor.Size(x.FromPlugin)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (dst *GrpcService_GoogleGrpc_CallCredentials_ServiceAccountJWTAccessCredentials) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc_CallCredentials_ServiceAccountJWTAccessCredentials vendor.InternalMessageInfo
...
func (dst *GrpcService_GoogleGrpc_CallCredentials_GoogleIAMCredentials) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc_CallCredentials_GoogleIAMCredentials vendor.InternalMessageInfo
...
func (dst *GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin vendor.InternalMessageInfo
...
type GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_Config struct {
	Config *vendor.Struct `protobuf:"bytes,2,opt,name=config,proto3,oneof"`
}

type GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_TypedConfig struct {
	TypedConfig *vendor.Any `protobuf:"bytes,3,opt,name=typed_config,json=typedConfig,proto3,oneof"`
}
...
func (m *GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin) GetConfig() *vendor.Struct {
...
func (m *GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin) GetTypedConfig() *vendor.Any {
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin)
	switch tag {
...
func _GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin)
	// config_type
	switch x := m.ConfigType.(type) {
	case *GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_Config:
		s := vendor.Size(x.Config)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin_TypedConfig:
		s := vendor.Size(x.TypedConfig)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
func init() {
	vendor.RegisterType((*GrpcService)(nil), "envoy.api.v2.core.GrpcService")
	vendor.RegisterType((*GrpcService_EnvoyGrpc)(nil), "envoy.api.v2.core.GrpcService.EnvoyGrpc")
	vendor.RegisterType((*GrpcService_GoogleGrpc)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc")
	vendor.RegisterType((*GrpcService_GoogleGrpc_SslCredentials)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc.SslCredentials")
	vendor.RegisterType((*GrpcService_GoogleGrpc_GoogleLocalCredentials)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc.GoogleLocalCredentials")
	vendor.RegisterType((*GrpcService_GoogleGrpc_ChannelCredentials)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc.ChannelCredentials")
	vendor.RegisterType((*GrpcService_GoogleGrpc_CallCredentials)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc.CallCredentials")
	vendor.RegisterType((*GrpcService_GoogleGrpc_CallCredentials_ServiceAccountJWTAccessCredentials)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc.CallCredentials.ServiceAccountJWTAccessCredentials")
	vendor.RegisterType((*GrpcService_GoogleGrpc_CallCredentials_GoogleIAMCredentials)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc.CallCredentials.GoogleIAMCredentials")
	vendor.RegisterType((*GrpcService_GoogleGrpc_CallCredentials_MetadataCredentialsFromPlugin)(nil), "envoy.api.v2.core.GrpcService.GoogleGrpc.CallCredentials.MetadataCredentialsFromPlugin")
}

func init() {
	vendor.RegisterFile("envoy/api/v2/core/grpc_service.proto", fileDescriptor_grpc_service_b85549433708d753)
}
