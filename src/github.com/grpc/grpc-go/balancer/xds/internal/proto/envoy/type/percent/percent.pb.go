...
func (x FractionalPercent_DenominatorType) String() string {
	return vendor.EnumName(FractionalPercent_DenominatorType_name, int32(x))
}
...
func (m *Percent) String() string { return vendor.CompactTextString(m) }
...
func (dst *Percent) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Percent vendor.InternalMessageInfo
...
func (m *FractionalPercent) String() string { return vendor.CompactTextString(m) }
...
func (dst *FractionalPercent) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_FractionalPercent vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Percent)(nil), "envoy.type.Percent")
	vendor.RegisterType((*FractionalPercent)(nil), "envoy.type.FractionalPercent")
	vendor.RegisterEnum("envoy.type.FractionalPercent_DenominatorType", FractionalPercent_DenominatorType_name, FractionalPercent_DenominatorType_value)
}

func init() { vendor.RegisterFile("envoy/type/percent.proto", fileDescriptor_percent_cd85ccaca181f641) }
