...
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/auth/cert"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/cluster/circuit_breaker"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/cluster/outlier_detection"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/core/address"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/core/base"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/core/config_source"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/core/health_check"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/core/protocol"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/discovery"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/eds"
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/type/percent"
...
func (x Cluster_DiscoveryType) String() string {
	return vendor.EnumName(Cluster_DiscoveryType_name, int32(x))
}
...
func (x Cluster_LbPolicy) String() string {
	return vendor.EnumName(Cluster_LbPolicy_name, int32(x))
}
...
func (x Cluster_DnsLookupFamily) String() string {
	return vendor.EnumName(Cluster_DnsLookupFamily_name, int32(x))
}
...
func (x Cluster_ClusterProtocolSelection) String() string {
	return vendor.EnumName(Cluster_ClusterProtocolSelection_name, int32(x))
}
...
func (x Cluster_LbSubsetConfig_LbSubsetFallbackPolicy) String() string {
	return vendor.EnumName(Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_name, int32(x))
}
...
func (x Cluster_RingHashLbConfig_HashFunction) String() string {
	return vendor.EnumName(Cluster_RingHashLbConfig_HashFunction_name, int32(x))
}
...
type Cluster struct {
	...
	ConnectTimeout                *vendor.Duration                    `protobuf:"bytes,4,opt,name=connect_timeout,json=connectTimeout,proto3" json:"connect_timeout,omitempty"`
	PerConnectionBufferLimitBytes *vendor.UInt32Value                 `protobuf:"bytes,5,opt,name=per_connection_buffer_limit_bytes,json=perConnectionBufferLimitBytes,proto3" json:"per_connection_buffer_limit_bytes,omitempty"`
	...
	MaxRequestsPerConnection      *vendor.UInt32Value                 `protobuf:"bytes,9,opt,name=max_requests_per_connection,json=maxRequestsPerConnection,proto3" json:"max_requests_per_connection,omitempty"`
	...
	ExtensionProtocolOptions      map[string]*vendor.Struct           `protobuf:"bytes,35,rep,name=extension_protocol_options,json=extensionProtocolOptions,proto3" json:"extension_protocol_options,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	TypedExtensionProtocolOptions map[string]*vendor.Any              `protobuf:"bytes,36,rep,name=typed_extension_protocol_options,json=typedExtensionProtocolOptions,proto3" json:"typed_extension_protocol_options,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	DnsRefreshRate                *vendor.Duration                    `protobuf:"bytes,16,opt,name=dns_refresh_rate,json=dnsRefreshRate,proto3" json:"dns_refresh_rate,omitempty"`
	...
	CleanupInterval               *vendor.Duration                    `protobuf:"bytes,20,opt,name=cleanup_interval,json=cleanupInterval,proto3" json:"cleanup_interval,omitempty"`
...
func (m *Cluster) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster vendor.InternalMessageInfo
...
func (m *Cluster) GetConnectTimeout() *vendor.Duration {
	if m != nil {
...
func (m *Cluster) GetPerConnectionBufferLimitBytes() *vendor.UInt32Value {
	if m != nil {
...
func (m *Cluster) GetMaxRequestsPerConnection() *vendor.UInt32Value {
	if m != nil {
...
func (m *Cluster) GetExtensionProtocolOptions() map[string]*vendor.Struct {
	if m != nil {
...
func (m *Cluster) GetTypedExtensionProtocolOptions() map[string]*vendor.Any {
	if m != nil {
...
func (m *Cluster) GetDnsRefreshRate() *vendor.Duration {
	if m != nil {
...
func (m *Cluster) GetCleanupInterval() *vendor.Duration {
	if m != nil {
...
func (*Cluster) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _Cluster_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*Cluster)
	// cluster_discovery_type
	switch x := m.ClusterDiscoveryType.(type) {
	case *Cluster_Type:
		b.EncodeVarint(2<<3 | vendor.WireVarint)
		b.EncodeVarint(uint64(x.Type))
	case *Cluster_ClusterType:
		b.EncodeVarint(38<<3 | vendor.WireBytes)
...
func _Cluster_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*Cluster)
	switch tag {
	case 2: // cluster_discovery_type.type
		if wire != vendor.WireVarint {
...
func _Cluster_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*Cluster)
	// cluster_discovery_type
	switch x := m.ClusterDiscoveryType.(type) {
	case *Cluster_Type:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(x.Type))
	case *Cluster_ClusterType:
		s := vendor.Size(x.ClusterType)
		n += 2 // tag and wire
	...
	switch x := m.LbConfig.(type) {
	case *Cluster_RingHashLbConfig_:
		s := vendor.Size(x.RingHashLbConfig)
		n += 2 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *Cluster_OriginalDstLbConfig_:
		s := vendor.Size(x.OriginalDstLbConfig)
		n += 2 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *Cluster_LeastRequestLbConfig_:
		s := vendor.Size(x.LeastRequestLbConfig)
		n += 2 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
type Cluster_CustomClusterType struct {
	Name                 string      `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	TypedConfig          *vendor.Any `protobuf:"bytes,2,opt,name=typed_config,json=typedConfig,proto3" json:"typed_config,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Cluster_CustomClusterType) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_CustomClusterType) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_CustomClusterType vendor.InternalMessageInfo
...
func (m *Cluster_CustomClusterType) GetTypedConfig() *vendor.Any {
	if m != nil {
...
func (m *Cluster_EdsClusterConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_EdsClusterConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_EdsClusterConfig vendor.InternalMessageInfo
...
type Cluster_LbSubsetConfig struct {
	...
	DefaultSubset        *vendor.Struct                                `protobuf:"bytes,2,opt,name=default_subset,json=defaultSubset,proto3" json:"default_subset,omitempty"`
...
func (m *Cluster_LbSubsetConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_LbSubsetConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_LbSubsetConfig vendor.InternalMessageInfo
...
func (m *Cluster_LbSubsetConfig) GetDefaultSubset() *vendor.Struct {
	if m != nil {
...
func (m *Cluster_LbSubsetConfig_LbSubsetSelector) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_LbSubsetConfig_LbSubsetSelector) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_LbSubsetConfig_LbSubsetSelector vendor.InternalMessageInfo
...
type Cluster_LeastRequestLbConfig struct {
	ChoiceCount          *vendor.UInt32Value `protobuf:"bytes,1,opt,name=choice_count,json=choiceCount,proto3" json:"choice_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *Cluster_LeastRequestLbConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_LeastRequestLbConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_LeastRequestLbConfig vendor.InternalMessageInfo

func (m *Cluster_LeastRequestLbConfig) GetChoiceCount() *vendor.UInt32Value {
	if m != nil {
...
type Cluster_RingHashLbConfig struct {
	MinimumRingSize      *vendor.UInt64Value                   `protobuf:"bytes,1,opt,name=minimum_ring_size,json=minimumRingSize,proto3" json:"minimum_ring_size,omitempty"`
	...
	MaximumRingSize      *vendor.UInt64Value                   `protobuf:"bytes,4,opt,name=maximum_ring_size,json=maximumRingSize,proto3" json:"maximum_ring_size,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                              `json:"-"`
	XXX_unrecognized     []byte                                `json:"-"`
	XXX_sizecache        int32                                 `json:"-"`
}
...
func (m *Cluster_RingHashLbConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_RingHashLbConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_RingHashLbConfig vendor.InternalMessageInfo

func (m *Cluster_RingHashLbConfig) GetMinimumRingSize() *vendor.UInt64Value {
	if m != nil {
...
func (m *Cluster_RingHashLbConfig) GetMaximumRingSize() *vendor.UInt64Value {
	if m != nil {
...
func (m *Cluster_OriginalDstLbConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_OriginalDstLbConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_OriginalDstLbConfig vendor.InternalMessageInfo
...
type Cluster_CommonLbConfig struct {
	...
	UpdateMergeWindow       *vendor.Duration                                 `protobuf:"bytes,4,opt,name=update_merge_window,json=updateMergeWindow,proto3" json:"update_merge_window,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                                         `json:"-"`
	XXX_unrecognized        []byte                                           `json:"-"`
	XXX_sizecache           int32                                            `json:"-"`
}
...
func (m *Cluster_CommonLbConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_CommonLbConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_CommonLbConfig vendor.InternalMessageInfo
...
func (m *Cluster_CommonLbConfig) GetUpdateMergeWindow() *vendor.Duration {
	if m != nil {
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Cluster_CommonLbConfig) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _Cluster_CommonLbConfig_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
...
func _Cluster_CommonLbConfig_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*Cluster_CommonLbConfig)
	switch tag {
...
func _Cluster_CommonLbConfig_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*Cluster_CommonLbConfig)
	// locality_config_specifier
	switch x := m.LocalityConfigSpecifier.(type) {
	case *Cluster_CommonLbConfig_ZoneAwareLbConfig_:
		s := vendor.Size(x.ZoneAwareLbConfig)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *Cluster_CommonLbConfig_LocalityWeightedLbConfig_:
		s := vendor.Size(x.LocalityWeightedLbConfig)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
type Cluster_CommonLbConfig_ZoneAwareLbConfig struct {
	...
	MinClusterSize       *vendor.UInt64Value `protobuf:"bytes,2,opt,name=min_cluster_size,json=minClusterSize,proto3" json:"min_cluster_size,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *Cluster_CommonLbConfig_ZoneAwareLbConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *Cluster_CommonLbConfig_ZoneAwareLbConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_CommonLbConfig_ZoneAwareLbConfig vendor.InternalMessageInfo
...
func (m *Cluster_CommonLbConfig_ZoneAwareLbConfig) GetMinClusterSize() *vendor.UInt64Value {
	if m != nil {
...
func (m *Cluster_CommonLbConfig_LocalityWeightedLbConfig) String() string {
	return vendor.CompactTextString(m)
}
...
func (dst *Cluster_CommonLbConfig_LocalityWeightedLbConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Cluster_CommonLbConfig_LocalityWeightedLbConfig vendor.InternalMessageInfo
...
func (m *UpstreamBindConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *UpstreamBindConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UpstreamBindConfig vendor.InternalMessageInfo
...
func (m *UpstreamConnectionOptions) String() string { return vendor.CompactTextString(m) }
...
func (dst *UpstreamConnectionOptions) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_UpstreamConnectionOptions vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Cluster)(nil), "envoy.api.v2.Cluster")
	vendor.RegisterMapType((map[string]*vendor.Struct)(nil), "envoy.api.v2.Cluster.ExtensionProtocolOptionsEntry")
	vendor.RegisterMapType((map[string]*vendor.Any)(nil), "envoy.api.v2.Cluster.TypedExtensionProtocolOptionsEntry")
	vendor.RegisterType((*Cluster_CustomClusterType)(nil), "envoy.api.v2.Cluster.CustomClusterType")
	vendor.RegisterType((*Cluster_EdsClusterConfig)(nil), "envoy.api.v2.Cluster.EdsClusterConfig")
	vendor.RegisterType((*Cluster_LbSubsetConfig)(nil), "envoy.api.v2.Cluster.LbSubsetConfig")
	vendor.RegisterType((*Cluster_LbSubsetConfig_LbSubsetSelector)(nil), "envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector")
	vendor.RegisterType((*Cluster_LeastRequestLbConfig)(nil), "envoy.api.v2.Cluster.LeastRequestLbConfig")
	vendor.RegisterType((*Cluster_RingHashLbConfig)(nil), "envoy.api.v2.Cluster.RingHashLbConfig")
	vendor.RegisterType((*Cluster_OriginalDstLbConfig)(nil), "envoy.api.v2.Cluster.OriginalDstLbConfig")
	vendor.RegisterType((*Cluster_CommonLbConfig)(nil), "envoy.api.v2.Cluster.CommonLbConfig")
	vendor.RegisterType((*Cluster_CommonLbConfig_ZoneAwareLbConfig)(nil), "envoy.api.v2.Cluster.CommonLbConfig.ZoneAwareLbConfig")
	vendor.RegisterType((*Cluster_CommonLbConfig_LocalityWeightedLbConfig)(nil), "envoy.api.v2.Cluster.CommonLbConfig.LocalityWeightedLbConfig")
	vendor.RegisterType((*UpstreamBindConfig)(nil), "envoy.api.v2.UpstreamBindConfig")
	vendor.RegisterType((*UpstreamConnectionOptions)(nil), "envoy.api.v2.UpstreamConnectionOptions")
	vendor.RegisterEnum("envoy.api.v2.Cluster_DiscoveryType", Cluster_DiscoveryType_name, Cluster_DiscoveryType_value)
	vendor.RegisterEnum("envoy.api.v2.Cluster_LbPolicy", Cluster_LbPolicy_name, Cluster_LbPolicy_value)
	vendor.RegisterEnum("envoy.api.v2.Cluster_DnsLookupFamily", Cluster_DnsLookupFamily_name, Cluster_DnsLookupFamily_value)
	vendor.RegisterEnum("envoy.api.v2.Cluster_ClusterProtocolSelection", Cluster_ClusterProtocolSelection_name, Cluster_ClusterProtocolSelection_value)
	vendor.RegisterEnum("envoy.api.v2.Cluster_LbSubsetConfig_LbSubsetFallbackPolicy", Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_name, Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_value)
	vendor.RegisterEnum("envoy.api.v2.Cluster_RingHashLbConfig_HashFunction", Cluster_RingHashLbConfig_HashFunction_name, Cluster_RingHashLbConfig_HashFunction_value)
}
...
type ClusterDiscoveryServiceClient interface {
	StreamClusters(ctx vendor.Context, opts ...grpc.CallOption) (ClusterDiscoveryService_StreamClustersClient, error)
	DeltaClusters(ctx vendor.Context, opts ...grpc.CallOption) (ClusterDiscoveryService_DeltaClustersClient, error)
	FetchClusters(ctx vendor.Context, in *discovery.DiscoveryRequest, opts ...grpc.CallOption) (*discovery.DiscoveryResponse, error)
}
...
func (c *clusterDiscoveryServiceClient) StreamClusters(ctx vendor.Context, opts ...grpc.CallOption) (ClusterDiscoveryService_StreamClustersClient, error) {
...
func (c *clusterDiscoveryServiceClient) DeltaClusters(ctx vendor.Context, opts ...grpc.CallOption) (ClusterDiscoveryService_DeltaClustersClient, error) {
...
func (c *clusterDiscoveryServiceClient) FetchClusters(ctx vendor.Context, in *discovery.DiscoveryRequest, opts ...grpc.CallOption) (*discovery.DiscoveryResponse, error) {
...
type ClusterDiscoveryServiceServer interface {
	...
	FetchClusters(vendor.Context, *discovery.DiscoveryRequest) (*discovery.DiscoveryResponse, error)
}
...
func _ClusterDiscoveryService_FetchClusters_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func init() { vendor.RegisterFile("envoy/api/v2/cds.proto", fileDescriptor_cds_1dff7e464f9f9a10) }
