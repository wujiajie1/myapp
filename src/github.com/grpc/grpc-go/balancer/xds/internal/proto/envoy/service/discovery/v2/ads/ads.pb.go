...
func (m *AdsDummy) String() string { return vendor.CompactTextString(m) }
...
func (dst *AdsDummy) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_AdsDummy vendor.InternalMessageInfo

func init() {
	vendor.RegisterType((*AdsDummy)(nil), "envoy.service.discovery.v2.AdsDummy")
}
...
type AggregatedDiscoveryServiceClient interface {
	StreamAggregatedResources(ctx vendor.Context, opts ...grpc.CallOption) (AggregatedDiscoveryService_StreamAggregatedResourcesClient, error)
	DeltaAggregatedResources(ctx vendor.Context, opts ...grpc.CallOption) (AggregatedDiscoveryService_DeltaAggregatedResourcesClient, error)
}
...
func (c *aggregatedDiscoveryServiceClient) StreamAggregatedResources(ctx vendor.Context, opts ...grpc.CallOption) (AggregatedDiscoveryService_StreamAggregatedResourcesClient, error) {
...
func (c *aggregatedDiscoveryServiceClient) DeltaAggregatedResources(ctx vendor.Context, opts ...grpc.CallOption) (AggregatedDiscoveryService_DeltaAggregatedResourcesClient, error) {
...
func init() {
	vendor.RegisterFile("envoy/service/discovery/v2/ads.proto", fileDescriptor_ads_e4cd1a296681dd94)
}
