...
func (m *CircuitBreakers) String() string { return vendor.CompactTextString(m) }
...
func (dst *CircuitBreakers) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CircuitBreakers vendor.InternalMessageInfo
...
type CircuitBreakers_Thresholds struct {
	...
	MaxConnections       *vendor.UInt32Value  `protobuf:"bytes,2,opt,name=max_connections,json=maxConnections,proto3" json:"max_connections,omitempty"`
	MaxPendingRequests   *vendor.UInt32Value  `protobuf:"bytes,3,opt,name=max_pending_requests,json=maxPendingRequests,proto3" json:"max_pending_requests,omitempty"`
	MaxRequests          *vendor.UInt32Value  `protobuf:"bytes,4,opt,name=max_requests,json=maxRequests,proto3" json:"max_requests,omitempty"`
	MaxRetries           *vendor.UInt32Value  `protobuf:"bytes,5,opt,name=max_retries,json=maxRetries,proto3" json:"max_retries,omitempty"`
	TrackRemaining       bool                 `protobuf:"varint,6,opt,name=track_remaining,json=trackRemaining,proto3" json:"track_remaining,omitempty"`
	MaxConnectionPools   *vendor.UInt32Value  `protobuf:"bytes,7,opt,name=max_connection_pools,json=maxConnectionPools,proto3" json:"max_connection_pools,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *CircuitBreakers_Thresholds) String() string { return vendor.CompactTextString(m) }
...
func (dst *CircuitBreakers_Thresholds) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CircuitBreakers_Thresholds vendor.InternalMessageInfo
...
func (m *CircuitBreakers_Thresholds) GetMaxConnections() *vendor.UInt32Value {
	if m != nil {
...
func (m *CircuitBreakers_Thresholds) GetMaxPendingRequests() *vendor.UInt32Value {
	if m != nil {
...
func (m *CircuitBreakers_Thresholds) GetMaxRequests() *vendor.UInt32Value {
	if m != nil {
...
func (m *CircuitBreakers_Thresholds) GetMaxRetries() *vendor.UInt32Value {
	if m != nil {
		return m.MaxRetries
	}
	return nil
...
func (m *CircuitBreakers_Thresholds) GetMaxConnectionPools() *vendor.UInt32Value {
	if m != nil {
...
func init() {
	vendor.RegisterType((*CircuitBreakers)(nil), "envoy.api.v2.cluster.CircuitBreakers")
	vendor.RegisterType((*CircuitBreakers_Thresholds)(nil), "envoy.api.v2.cluster.CircuitBreakers.Thresholds")
}

func init() {
	vendor.RegisterFile("envoy/api/v2/cluster/circuit_breaker.proto", fileDescriptor_circuit_breaker_dc7392708e718eb5)
}
