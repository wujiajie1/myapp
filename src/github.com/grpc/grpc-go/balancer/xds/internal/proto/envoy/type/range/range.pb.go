...
func (m *Int64Range) String() string { return vendor.CompactTextString(m) }
...
func (dst *Int64Range) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Int64Range vendor.InternalMessageInfo
...
func (m *DoubleRange) String() string { return vendor.CompactTextString(m) }
...
func (dst *DoubleRange) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_DoubleRange vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Int64Range)(nil), "envoy.type.Int64Range")
	vendor.RegisterType((*DoubleRange)(nil), "envoy.type.DoubleRange")
}

func init() { vendor.RegisterFile("envoy/type/range.proto", fileDescriptor_range_b0dd53fd27ccc9b2) }
