...
func (x SocketAddress_Protocol) String() string {
	return vendor.EnumName(SocketAddress_Protocol_name, int32(x))
}
...
func (m *Pipe) String() string { return vendor.CompactTextString(m) }
...
func (dst *Pipe) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Pipe vendor.InternalMessageInfo
...
func (m *SocketAddress) String() string { return vendor.CompactTextString(m) }
...
func (dst *SocketAddress) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SocketAddress vendor.InternalMessageInfo
...
func (*SocketAddress) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _SocketAddress_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*SocketAddress)
	// port_specifier
	switch x := m.PortSpecifier.(type) {
	case *SocketAddress_PortValue:
		b.EncodeVarint(3<<3 | vendor.WireVarint)
...
func _SocketAddress_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*SocketAddress)
	switch tag {
...
func _SocketAddress_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*SocketAddress)
	// port_specifier
	switch x := m.PortSpecifier.(type) {
	case *SocketAddress_PortValue:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(x.PortValue))
	case *SocketAddress_NamedPort:
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(len(x.NamedPort)))
		n += len(x.NamedPort)
	case nil:
	default:
...
type TcpKeepalive struct {
	KeepaliveProbes      *vendor.UInt32Value `protobuf:"bytes,1,opt,name=keepalive_probes,json=keepaliveProbes,proto3" json:"keepalive_probes,omitempty"`
	KeepaliveTime        *vendor.UInt32Value `protobuf:"bytes,2,opt,name=keepalive_time,json=keepaliveTime,proto3" json:"keepalive_time,omitempty"`
	KeepaliveInterval    *vendor.UInt32Value `protobuf:"bytes,3,opt,name=keepalive_interval,json=keepaliveInterval,proto3" json:"keepalive_interval,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *TcpKeepalive) String() string { return vendor.CompactTextString(m) }
...
func (dst *TcpKeepalive) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_TcpKeepalive vendor.InternalMessageInfo

func (m *TcpKeepalive) GetKeepaliveProbes() *vendor.UInt32Value {
	if m != nil {
...
func (m *TcpKeepalive) GetKeepaliveTime() *vendor.UInt32Value {
	if m != nil {
...
func (m *TcpKeepalive) GetKeepaliveInterval() *vendor.UInt32Value {
	if m != nil {
...
type BindConfig struct {
	...
	Freebind             *vendor.BoolValue    `protobuf:"bytes,2,opt,name=freebind,proto3" json:"freebind,omitempty"`
...
func (m *BindConfig) String() string { return vendor.CompactTextString(m) }
...
func (dst *BindConfig) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_BindConfig vendor.InternalMessageInfo
...
func (m *BindConfig) GetFreebind() *vendor.BoolValue {
	if m != nil {
		return m.Freebind
	}
	return nil
...
func _Address_OneofSizer(msg vendor.Message) (n int) {
	...
	switch x := m.Address.(type) {
	case *Address_SocketAddress:
		s := vendor.Size(x.SocketAddress)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *Address_Pipe:
		s := vendor.Size(x.Pipe)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case nil:
...
type CidrRange struct {
	...
	PrefixLen            *vendor.UInt32Value `protobuf:"bytes,2,opt,name=prefix_len,json=prefixLen,proto3" json:"prefix_len,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *CidrRange) String() string { return vendor.CompactTextString(m) }
...
func (dst *CidrRange) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_CidrRange vendor.InternalMessageInfo
...
func (m *CidrRange) GetPrefixLen() *vendor.UInt32Value {
	if m != nil {
		return m.PrefixLen
	}
	return nil
...
func init() {
	vendor.RegisterType((*Pipe)(nil), "envoy.api.v2.core.Pipe")
	vendor.RegisterType((*SocketAddress)(nil), "envoy.api.v2.core.SocketAddress")
	vendor.RegisterType((*TcpKeepalive)(nil), "envoy.api.v2.core.TcpKeepalive")
	vendor.RegisterType((*BindConfig)(nil), "envoy.api.v2.core.BindConfig")
	vendor.RegisterType((*Address)(nil), "envoy.api.v2.core.Address")
	vendor.RegisterType((*CidrRange)(nil), "envoy.api.v2.core.CidrRange")
	vendor.RegisterEnum("envoy.api.v2.core.SocketAddress_Protocol", SocketAddress_Protocol_name, SocketAddress_Protocol_value)
}

func init() {
	vendor.RegisterFile("envoy/api/v2/core/address.proto", fileDescriptor_address_b91d58d2da3489da)
}
