...
import "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2/endpoint/endpoint"
...
func (m *ClusterLoadAssignment) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClusterLoadAssignment) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClusterLoadAssignment vendor.InternalMessageInfo
...
type ClusterLoadAssignment_Policy struct {
	...
	OverprovisioningFactor *vendor.UInt32Value                          `protobuf:"bytes,3,opt,name=overprovisioning_factor,json=overprovisioningFactor,proto3" json:"overprovisioning_factor,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                                     `json:"-"`
	XXX_unrecognized       []byte                                       `json:"-"`
	XXX_sizecache          int32                                        `json:"-"`
}
...
func (m *ClusterLoadAssignment_Policy) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClusterLoadAssignment_Policy) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClusterLoadAssignment_Policy vendor.InternalMessageInfo
...
func (m *ClusterLoadAssignment_Policy) GetOverprovisioningFactor() *vendor.UInt32Value {
	if m != nil {
...
func (m *ClusterLoadAssignment_Policy_DropOverload) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClusterLoadAssignment_Policy_DropOverload) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClusterLoadAssignment_Policy_DropOverload vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*ClusterLoadAssignment)(nil), "envoy.api.v2.ClusterLoadAssignment")
	vendor.RegisterMapType((map[string]*endpoint.Endpoint)(nil), "envoy.api.v2.ClusterLoadAssignment.NamedEndpointsEntry")
	vendor.RegisterType((*ClusterLoadAssignment_Policy)(nil), "envoy.api.v2.ClusterLoadAssignment.Policy")
	vendor.RegisterType((*ClusterLoadAssignment_Policy_DropOverload)(nil), "envoy.api.v2.ClusterLoadAssignment.Policy.DropOverload")
}
...
type EndpointDiscoveryServiceClient interface {
	StreamEndpoints(ctx vendor.Context, opts ...grpc.CallOption) (EndpointDiscoveryService_StreamEndpointsClient, error)
	FetchEndpoints(ctx vendor.Context, in *discovery.DiscoveryRequest, opts ...grpc.CallOption) (*discovery.DiscoveryResponse, error)
}
...
func (c *endpointDiscoveryServiceClient) StreamEndpoints(ctx vendor.Context, opts ...grpc.CallOption) (EndpointDiscoveryService_StreamEndpointsClient, error) {
...
func (c *endpointDiscoveryServiceClient) FetchEndpoints(ctx vendor.Context, in *discovery.DiscoveryRequest, opts ...grpc.CallOption) (*discovery.DiscoveryResponse, error) {
...
type EndpointDiscoveryServiceServer interface {
	...
	FetchEndpoints(vendor.Context, *discovery.DiscoveryRequest) (*discovery.DiscoveryResponse, error)
}
...
func _EndpointDiscoveryService_FetchEndpoints_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func init() { vendor.RegisterFile("envoy/api/v2/eds.proto", fileDescriptor_eds_fb0a999149ff4153) }
