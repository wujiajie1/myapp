...
func (x GrpcLogEntry_EventType) String() string {
	return vendor.EnumName(GrpcLogEntry_EventType_name, int32(x))
}
...
func (x GrpcLogEntry_Logger) String() string {
	return vendor.EnumName(GrpcLogEntry_Logger_name, int32(x))
}
...
func (x Address_Type) String() string {
	return vendor.EnumName(Address_Type_name, int32(x))
}
...
func (m *GrpcLogEntry) String() string { return vendor.CompactTextString(m) }
...
func (dst *GrpcLogEntry) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_GrpcLogEntry vendor.InternalMessageInfo

func (m *GrpcLogEntry) GetTimestamp() *vendor.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (*GrpcLogEntry) XXX_OneofFuncs() (func(msg vendor.Message, b *vendor.Buffer) error, func(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error), func(msg vendor.Message) (n int), []interface{}) {
...
func _GrpcLogEntry_OneofMarshaler(msg vendor.Message, b *vendor.Buffer) error {
	m := msg.(*GrpcLogEntry)
	// payload
...
func _GrpcLogEntry_OneofUnmarshaler(msg vendor.Message, tag, wire int, b *vendor.Buffer) (bool, error) {
	m := msg.(*GrpcLogEntry)
	switch tag {
...
func _GrpcLogEntry_OneofSizer(msg vendor.Message) (n int) {
	m := msg.(*GrpcLogEntry)
	// payload
	switch x := m.Payload.(type) {
	case *GrpcLogEntry_ClientHeader:
		s := vendor.Size(x.ClientHeader)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcLogEntry_ServerHeader:
		s := vendor.Size(x.ServerHeader)
		n += 1 // tag and wire
		n += vendor.SizeVarint(uint64(s))
		n += s
	case *GrpcLogEntry_Message:
...
type ClientHeader struct {
	...
	// the RPC timeout
	Timeout              *vendor.Duration `protobuf:"bytes,4,opt,name=timeout,proto3" json:"timeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ClientHeader) String() string { return vendor.CompactTextString(m) }
...
func (dst *ClientHeader) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ClientHeader vendor.InternalMessageInfo
...
func (m *ClientHeader) GetTimeout() *vendor.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *ServerHeader) String() string { return vendor.CompactTextString(m) }
...
func (dst *ServerHeader) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ServerHeader vendor.InternalMessageInfo
...
func (m *Trailer) String() string { return vendor.CompactTextString(m) }
...
func (dst *Trailer) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Trailer vendor.InternalMessageInfo
...
func (m *Message) String() string { return vendor.CompactTextString(m) }
...
func (dst *Message) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Message vendor.InternalMessageInfo
...
func (m *MetadataEntry) String() string { return vendor.CompactTextString(m) }
...
func (dst *MetadataEntry) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_MetadataEntry vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*GrpcLogEntry)(nil), "grpc.binarylog.v1.GrpcLogEntry")
	vendor.RegisterType((*ClientHeader)(nil), "grpc.binarylog.v1.ClientHeader")
	vendor.RegisterType((*ServerHeader)(nil), "grpc.binarylog.v1.ServerHeader")
	vendor.RegisterType((*Trailer)(nil), "grpc.binarylog.v1.Trailer")
	vendor.RegisterType((*Message)(nil), "grpc.binarylog.v1.Message")
	vendor.RegisterType((*Metadata)(nil), "grpc.binarylog.v1.Metadata")
	vendor.RegisterType((*MetadataEntry)(nil), "grpc.binarylog.v1.MetadataEntry")
	vendor.RegisterType((*Address)(nil), "grpc.binarylog.v1.Address")
	vendor.RegisterEnum("grpc.binarylog.v1.GrpcLogEntry_EventType", GrpcLogEntry_EventType_name, GrpcLogEntry_EventType_value)
	vendor.RegisterEnum("grpc.binarylog.v1.GrpcLogEntry_Logger", GrpcLogEntry_Logger_name, GrpcLogEntry_Logger_value)
	vendor.RegisterEnum("grpc.binarylog.v1.Address_Type", Address_Type_name, Address_Type_value)
}

func init() {
	vendor.RegisterFile("grpc/binarylog/grpc_binarylog_v1/binarylog.proto", fileDescriptor_binarylog_264c8c9c551ce911)
}
