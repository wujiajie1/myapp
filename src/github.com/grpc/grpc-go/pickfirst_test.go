...
func (vendor.s) TestOneBackendPickfirst(t *testing.T) {
...
func (vendor.s) TestBackendsPickfirst(t *testing.T) {
	r, rcleanup := manual.GenerateAndRegisterManualResolver()
	defer rcleanup()
...
func (vendor.s) TestNewAddressWhileBlockingPickfirst(t *testing.T) {
	r, rcleanup := manual.GenerateAndRegisterManualResolver()
	defer rcleanup()
...
func (vendor.s) TestCloseWithPendingRPCPickfirst(t *testing.T) {
	r, rcleanup := manual.GenerateAndRegisterManualResolver()
	defer rcleanup()

	numServers := 1
	_, _, scleanup := vendor.startServers(t, numServers, math.MaxInt32)
	defer scleanup()
...
func (vendor.s) TestOneServerDownPickfirst(t *testing.T) {
	r, rcleanup := manual.GenerateAndRegisterManualResolver()
	defer rcleanup()
	...
	cc, err := vendor.Dial(r.Scheme()+":///test.server", vendor.WithInsecure(), vendor.WithCodec(vendor.testCodec{}), vendor.WithWaitForHandshake())
	if err != nil {
		t.Fatalf("failed to dial: %v", err)
	}
	defer cc.Close()
...
func (vendor.s) TestAllServersDownPickfirst(t *testing.T) {
	r, rcleanup := manual.GenerateAndRegisterManualResolver()
	defer rcleanup()
...
func (vendor.s) TestAddressesRemovedPickfirst(t *testing.T) {
	r, rcleanup := manual.GenerateAndRegisterManualResolver()
	defer rcleanup()
