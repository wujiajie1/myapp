...
func (x PayloadType) String() string {
	return vendor.EnumName(PayloadType_name, int32(x))
}
...
func (dst *Empty) XXX_Merge(src vendor.Message) {
...
func (m *Payload) String() string { return vendor.CompactTextString(m) }
...
func (dst *Payload) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Payload vendor.InternalMessageInfo
...
func (m *EchoStatus) String() string { return vendor.CompactTextString(m) }
...
func (dst *EchoStatus) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_EchoStatus vendor.InternalMessageInfo
...
func (m *SimpleRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *SimpleRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SimpleRequest vendor.InternalMessageInfo
...
func (m *SimpleResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *SimpleResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_SimpleResponse vendor.InternalMessageInfo
...
func (m *StreamingInputCallRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *StreamingInputCallRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StreamingInputCallRequest vendor.InternalMessageInfo
...
func (m *StreamingInputCallResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *StreamingInputCallResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StreamingInputCallResponse vendor.InternalMessageInfo
...
func (m *ResponseParameters) String() string { return vendor.CompactTextString(m) }
...
func (dst *ResponseParameters) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_ResponseParameters vendor.InternalMessageInfo
...
func (m *StreamingOutputCallRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *StreamingOutputCallRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StreamingOutputCallRequest vendor.InternalMessageInfo
...
func (m *StreamingOutputCallResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *StreamingOutputCallResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_StreamingOutputCallResponse vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Empty)(nil), "grpc.testing.Empty")
	vendor.RegisterType((*Payload)(nil), "grpc.testing.Payload")
	vendor.RegisterType((*EchoStatus)(nil), "grpc.testing.EchoStatus")
	vendor.RegisterType((*SimpleRequest)(nil), "grpc.testing.SimpleRequest")
	vendor.RegisterType((*SimpleResponse)(nil), "grpc.testing.SimpleResponse")
	vendor.RegisterType((*StreamingInputCallRequest)(nil), "grpc.testing.StreamingInputCallRequest")
	vendor.RegisterType((*StreamingInputCallResponse)(nil), "grpc.testing.StreamingInputCallResponse")
	vendor.RegisterType((*ResponseParameters)(nil), "grpc.testing.ResponseParameters")
	vendor.RegisterType((*StreamingOutputCallRequest)(nil), "grpc.testing.StreamingOutputCallRequest")
	vendor.RegisterType((*StreamingOutputCallResponse)(nil), "grpc.testing.StreamingOutputCallResponse")
	vendor.RegisterEnum("grpc.testing.PayloadType", PayloadType_name, PayloadType_value)
}
...
type TestServiceClient interface {
	...
	EmptyCall(ctx vendor.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
	// One request followed by one response.
	// The server returns the client payload as-is.
	UnaryCall(ctx vendor.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
	// One request followed by a sequence of responses (streamed download).
	// The server returns the payload with client desired type and sizes.
	StreamingOutputCall(ctx vendor.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error)
	// A sequence of requests followed by one response (streamed upload).
	// The server returns the aggregated size of client payload as the result.
	StreamingInputCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_StreamingInputCallClient, error)
	// A sequence of requests with each request served by the server immediately.
	// As one request could lead to multiple responses, this interface
	// demonstrates the idea of full duplexing.
	FullDuplexCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_FullDuplexCallClient, error)
	// A sequence of requests followed by a sequence of responses.
	// The server buffers all the client requests and then serves them in order. A
	// stream of responses are returned to the client when the server starts with
	// first request.
	HalfDuplexCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_HalfDuplexCallClient, error)
}
...
func (c *testServiceClient) EmptyCall(ctx vendor.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *testServiceClient) UnaryCall(ctx vendor.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
...
func (c *testServiceClient) StreamingOutputCall(ctx vendor.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error) {
...
func (c *testServiceClient) StreamingInputCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_StreamingInputCallClient, error) {
...
func (c *testServiceClient) FullDuplexCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_FullDuplexCallClient, error) {
...
func (c *testServiceClient) HalfDuplexCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_HalfDuplexCallClient, error) {
...
type TestServiceServer interface {
	// One empty request followed by one empty response.
	EmptyCall(vendor.Context, *Empty) (*Empty, error)
	// One request followed by one response.
	// The server returns the client payload as-is.
	UnaryCall(vendor.Context, *SimpleRequest) (*SimpleResponse, error)
	// One request followed by a sequence of responses (streamed download).
	// The server returns the payload with client desired type and sizes.
...
func _TestService_EmptyCall_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
...
func _TestService_UnaryCall_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
type UnimplementedServiceClient interface {
	...
	UnimplementedCall(ctx vendor.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *unimplementedServiceClient) UnimplementedCall(ctx vendor.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type UnimplementedServiceServer interface {
	// A call that no server should implement
	UnimplementedCall(vendor.Context, *Empty) (*Empty, error)
}
...
func _UnimplementedService_UnimplementedCall_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
...
func init() { vendor.RegisterFile("grpc_testing/test.proto", fileDescriptor_test_56dd6f68792c8a57) }
