...
type TestServiceClient interface {
	...
	// Client stream
	ClientStreamCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_ClientStreamCallClient, error)
	// Server stream
	ServerStreamCall(ctx vendor.Context, in *SimpleRequest, opts ...grpc.CallOption) (TestService_ServerStreamCallClient, error)
}
...
func (c *testServiceClient) ClientStreamCall(ctx vendor.Context, opts ...grpc.CallOption) (TestService_ClientStreamCallClient, error) {
...
func (c *testServiceClient) ServerStreamCall(ctx vendor.Context, in *SimpleRequest, opts ...grpc.CallOption) (TestService_ServerStreamCallClient, error) {
...
func init() { vendor.RegisterFile("grpc_testing/test.proto", fileDescriptor_test_dd7ffeaa75513a0a) }
