...
func (s *server) SayHello(ctx vendor.Context, in *pb.HelloRequest) (*pb.HelloReply, error) {
...
// SayHello implements helloworld.GreeterServer
func (s *slowServer) SayHello(ctx vendor.Context, in *pb.HelloRequest) (*pb.HelloReply, error) {
