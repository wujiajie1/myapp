...
func (m *EchoRequest) String() string { return vendor.CompactTextString(m) }
...
func (dst *EchoRequest) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_EchoRequest vendor.InternalMessageInfo
...
func (m *EchoResponse) String() string { return vendor.CompactTextString(m) }
...
func (dst *EchoResponse) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_EchoResponse vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*EchoRequest)(nil), "grpc.examples.echo.EchoRequest")
	vendor.RegisterType((*EchoResponse)(nil), "grpc.examples.echo.EchoResponse")
}
...
type EchoClient interface {
	...
	UnaryEcho(ctx vendor.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error)
	// ServerStreamingEcho is server side streaming.
	ServerStreamingEcho(ctx vendor.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error)
	// ClientStreamingEcho is client side streaming.
	ClientStreamingEcho(ctx vendor.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error)
	// BidirectionalStreamingEcho is bidi streaming.
	BidirectionalStreamingEcho(ctx vendor.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamingEchoClient, error)
}
...
func (c *echoClient) UnaryEcho(ctx vendor.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
...
func (c *echoClient) ServerStreamingEcho(ctx vendor.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error) {
...
func (c *echoClient) ClientStreamingEcho(ctx vendor.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error) {
...
func (c *echoClient) BidirectionalStreamingEcho(ctx vendor.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamingEchoClient, error) {
...
type EchoServer interface {
	// UnaryEcho is unary echo.
	UnaryEcho(vendor.Context, *EchoRequest) (*EchoResponse, error)
	// ServerStreamingEcho is server side streaming.
...
func _Echo_UnaryEcho_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoRequest)
...
func init() { vendor.RegisterFile("echo.proto", fileDescriptor_echo_9d6886b3223721ca) }
