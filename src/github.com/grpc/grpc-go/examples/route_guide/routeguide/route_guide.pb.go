...
func (m *Point) String() string { return vendor.CompactTextString(m) }
...
func (dst *Point) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Point vendor.InternalMessageInfo
...
func (m *Rectangle) String() string { return vendor.CompactTextString(m) }
...
func (dst *Rectangle) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Rectangle vendor.InternalMessageInfo
...
func (m *Feature) String() string { return vendor.CompactTextString(m) }
...
func (dst *Feature) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_Feature vendor.InternalMessageInfo
...
func (m *RouteNote) String() string { return vendor.CompactTextString(m) }
...
func (dst *RouteNote) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_RouteNote vendor.InternalMessageInfo
...
func (m *RouteSummary) String() string { return vendor.CompactTextString(m) }
...
func (dst *RouteSummary) XXX_Merge(src vendor.Message) {
...
var xxx_messageInfo_RouteSummary vendor.InternalMessageInfo
...
func init() {
	vendor.RegisterType((*Point)(nil), "routeguide.Point")
	vendor.RegisterType((*Rectangle)(nil), "routeguide.Rectangle")
	vendor.RegisterType((*Feature)(nil), "routeguide.Feature")
	vendor.RegisterType((*RouteNote)(nil), "routeguide.RouteNote")
	vendor.RegisterType((*RouteSummary)(nil), "routeguide.RouteSummary")
}
...
type RouteGuideClient interface {
	...
	// position.
	GetFeature(ctx vendor.Context, in *Point, opts ...grpc.CallOption) (*Feature, error)
	...
	ListFeatures(ctx vendor.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error)
	// A client-to-server streaming RPC.
	//
	// Accepts a stream of Points on a route being traversed, returning a
	// RouteSummary when traversal is completed.
	RecordRoute(ctx vendor.Context, opts ...grpc.CallOption) (RouteGuide_RecordRouteClient, error)
	// A Bidirectional streaming RPC.
	//
	// Accepts a stream of RouteNotes sent while a route is being traversed,
	// while receiving other RouteNotes (e.g. from other users).
	RouteChat(ctx vendor.Context, opts ...grpc.CallOption) (RouteGuide_RouteChatClient, error)
}
...
func (c *routeGuideClient) GetFeature(ctx vendor.Context, in *Point, opts ...grpc.CallOption) (*Feature, error) {
	out := new(Feature)
...
func (c *routeGuideClient) ListFeatures(ctx vendor.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error) {
...
func (c *routeGuideClient) RecordRoute(ctx vendor.Context, opts ...grpc.CallOption) (RouteGuide_RecordRouteClient, error) {
...
func (c *routeGuideClient) RouteChat(ctx vendor.Context, opts ...grpc.CallOption) (RouteGuide_RouteChatClient, error) {
...
type RouteGuideServer interface {
	...
	// A feature with an empty name is returned if there's no feature at the given
	// position.
	GetFeature(vendor.Context, *Point) (*Feature, error)
	// A server-to-client streaming RPC.
	//
	// Obtains the Features available within the given Rectangle.  Results are
	// streamed rather than returned at once (e.g. in a response message with a
...
func _RouteGuide_GetFeature_Handler(srv interface{}, ctx vendor.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Point)
...
func init() { vendor.RegisterFile("route_guide.proto", fileDescriptor_route_guide_dc79de2de4c66c19) }
