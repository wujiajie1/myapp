...
func (_m *MockRouteGuideClient) GetFeature(_param0 vendor.Context, _param1 *routeguide.Point, _param2 ...grpc.CallOption) (*routeguide.Feature, error) {
...
func (_m *MockRouteGuideClient) ListFeatures(_param0 vendor.Context, _param1 *routeguide.Rectangle, _param2 ...grpc.CallOption) (routeguide.RouteGuide_ListFeaturesClient, error) {
	_s := []interface{}{_param0, _param1}
	for _, _x := range _param2 {
		_s = append(_s, _x)
	}
...
func (_m *MockRouteGuideClient) RecordRoute(_param0 vendor.Context, _param1 ...grpc.CallOption) (routeguide.RouteGuide_RecordRouteClient, error) {
...
func (_m *MockRouteGuideClient) RouteChat(_param0 vendor.Context, _param1 ...grpc.CallOption) (routeguide.RouteGuide_RouteChatClient, error) {
	_s := []interface{}{_param0}
	for _, _x := range _param1 {
		_s = append(_s, _x)
	}
...
func (_m *MockRouteGuide_RouteChatClient) Context() vendor.Context {
	ret := _m.ctrl.Call(_m, "Context")
	ret0, _ := ret[0].(vendor.Context)
	return ret0
}
