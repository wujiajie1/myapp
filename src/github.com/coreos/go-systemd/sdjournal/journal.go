...
func NewJournal() (j *Journal, err error) {
	...
	sd_journal_open, err := coreos.getFunction("sd_journal_open")
	if err != nil {
		return nil, err
	}
...
func NewJournalFromDir(path string) (j *Journal, err error) {
	...
	sd_journal_open_directory, err := coreos.getFunction("sd_journal_open_directory")
	if err != nil {
		return nil, err
	}
...
func NewJournalFromFiles(paths ...string) (j *Journal, err error) {
	...
	sd_journal_open_files, err := coreos.getFunction("sd_journal_open_files")
	if err != nil {
		return nil, err
	}
...
func (j *Journal) Close() error {
	sd_journal_close, err := coreos.getFunction("sd_journal_close")
	if err != nil {
		return err
	}
...
func (j *Journal) AddMatch(match string) error {
	sd_journal_add_match, err := coreos.getFunction("sd_journal_add_match")
	if err != nil {
		return err
	}
...
func (j *Journal) AddDisjunction() error {
	sd_journal_add_disjunction, err := coreos.getFunction("sd_journal_add_disjunction")
	if err != nil {
		return err
	}
...
func (j *Journal) AddConjunction() error {
	sd_journal_add_conjunction, err := coreos.getFunction("sd_journal_add_conjunction")
	if err != nil {
		return err
	}
...
func (j *Journal) FlushMatches() {
	sd_journal_flush_matches, err := coreos.getFunction("sd_journal_flush_matches")
	if err != nil {
		return
	}
...
func (j *Journal) Next() (uint64, error) {
	sd_journal_next, err := coreos.getFunction("sd_journal_next")
	if err != nil {
		return 0, err
	}
...
func (j *Journal) NextSkip(skip uint64) (uint64, error) {
	sd_journal_next_skip, err := coreos.getFunction("sd_journal_next_skip")
	if err != nil {
		return 0, err
	}
...
func (j *Journal) Previous() (uint64, error) {
	sd_journal_previous, err := coreos.getFunction("sd_journal_previous")
	if err != nil {
		return 0, err
	}
...
func (j *Journal) PreviousSkip(skip uint64) (uint64, error) {
	sd_journal_previous_skip, err := coreos.getFunction("sd_journal_previous_skip")
	if err != nil {
		return 0, err
	}
...
func (j *Journal) getData(field string) (unsafe.Pointer, C.int, error) {
	sd_journal_get_data, err := coreos.getFunction("sd_journal_get_data")
	if err != nil {
		return nil, 0, err
	}
...
func (j *Journal) GetEntry() (*JournalEntry, error) {
	sd_journal_get_realtime_usec, err := coreos.getFunction("sd_journal_get_realtime_usec")
	if err != nil {
		return nil, err
	}

	sd_journal_get_monotonic_usec, err := coreos.getFunction("sd_journal_get_monotonic_usec")
	if err != nil {
		return nil, err
	}

	sd_journal_get_cursor, err := coreos.getFunction("sd_journal_get_cursor")
	if err != nil {
		return nil, err
	}

	sd_journal_restart_data, err := coreos.getFunction("sd_journal_restart_data")
	if err != nil {
		return nil, err
	}

	sd_journal_enumerate_data, err := coreos.getFunction("sd_journal_enumerate_data")
	if err != nil {
		return nil, err
	}
...
func (j *Journal) SetDataThreshold(threshold uint64) error {
	sd_journal_set_data_threshold, err := coreos.getFunction("sd_journal_set_data_threshold")
	if err != nil {
		return err
	}
...
func (j *Journal) TestCursor(cursor string) error {
	sd_journal_test_cursor, err := coreos.getFunction("sd_journal_test_cursor")
	if err != nil {
		return err
	}
...
func (j *Journal) SeekHead() error {
	sd_journal_seek_head, err := coreos.getFunction("sd_journal_seek_head")
	if err != nil {
		return err
	}
...
func (j *Journal) SeekTail() error {
	sd_journal_seek_tail, err := coreos.getFunction("sd_journal_seek_tail")
	if err != nil {
		return err
	}
...
func (j *Journal) SeekRealtimeUsec(usec uint64) error {
	sd_journal_seek_realtime_usec, err := coreos.getFunction("sd_journal_seek_realtime_usec")
	if err != nil {
		return err
	}
...
func (j *Journal) SeekCursor(cursor string) error {
	sd_journal_seek_cursor, err := coreos.getFunction("sd_journal_seek_cursor")
	if err != nil {
		return err
	}
...
func (j *Journal) Wait(timeout time.Duration) int {
	...
	sd_journal_wait, err := coreos.getFunction("sd_journal_wait")
	if err != nil {
		return -1
	}
...
func (j *Journal) GetUsage() (uint64, error) {
	...
	sd_journal_get_usage, err := coreos.getFunction("sd_journal_get_usage")
	if err != nil {
		return 0, err
	}
...
func (j *Journal) GetUniqueValues(field string) ([]string, error) {
	...
	sd_journal_query_unique, err := coreos.getFunction("sd_journal_query_unique")
	if err != nil {
		return nil, err
	}

	sd_journal_enumerate_unique, err := coreos.getFunction("sd_journal_enumerate_unique")
	if err != nil {
		return nil, err
	}

	sd_journal_restart_unique, err := coreos.getFunction("sd_journal_restart_unique")
	if err != nil {
		return nil, err
	}
...
func (j *Journal) GetCatalog() (string, error) {
	sd_journal_get_catalog, err := coreos.getFunction("sd_journal_get_catalog")
	if err != nil {
		return "", err
	}
