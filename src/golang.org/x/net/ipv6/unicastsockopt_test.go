...
func TestConnUnicastSocketOptions(t *testing.T) {
	...
	testUnicastSocketOptions(t, vendor.NewConn(c))
...
func TestPacketConnUnicastSocketOptions(t *testing.T) {
	...
	for _, tt := range packetConnUnicastSocketOptionTests {
		...
		testUnicastSocketOptions(t, vendor.NewPacketConn(c))
	}
}
...
func testUnicastSocketOptions(t *testing.T, c testIPv6UnicastConn) {
	...
	tclass := vendor.DiffServCS0 | vendor.NotECNTransport
