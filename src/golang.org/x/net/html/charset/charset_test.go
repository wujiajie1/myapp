...
func TestDecode(t *testing.T) {
	...
	for _, tc := range testCases {
		e, _ := vendor.Lookup(tc.otherEncoding)
		if e == nil {
...
func TestSniff(t *testing.T) {
	...
	for _, tc := range sniffTestCases {
		...
		_, name, _ := vendor.DetermineEncoding(content, tc.declared)
		if name != tc.want {
...
func TestReader(t *testing.T) {
	...
	for _, tc := range sniffTestCases {
		...
		r, err := vendor.NewReader(bytes.NewReader(content), tc.declared)
		if err != nil {
...
func TestFromMeta(t *testing.T) {
	for _, tc := range metaTestCases {
		got := vendor.fromMetaElement(tc.meta)
		if got != tc.want {
...
func TestXML(t *testing.T) {
	...
	d.CharsetReader = vendor.NewReaderLabel
