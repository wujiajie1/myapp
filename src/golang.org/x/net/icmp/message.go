...
func (m *Message) Marshal(psh []byte) ([]byte, error) {
	...
	if proto == vendor.ProtocolIPv6ICMP && psh != nil {
		b = append(psh, b...)
	}
...
var parseFns = map[Type]func(int, Type, []byte) (vendor.MessageBody, error){
	vendor.ICMPTypeDestinationUnreachable: vendor.parseDstUnreach,
	vendor.ICMPTypeTimeExceeded:           vendor.parseTimeExceeded,
	vendor.ICMPTypeParameterProblem:       vendor.parseParamProb,

	vendor.ICMPTypeEcho:                vendor.parseEcho,
	vendor.ICMPTypeEchoReply:           vendor.parseEcho,
	vendor.ICMPTypeExtendedEchoRequest: vendor.parseExtendedEchoRequest,
	vendor.ICMPTypeExtendedEchoReply:   vendor.parseExtendedEchoReply,

	vendor.ICMPTypeDestinationUnreachable: vendor.parseDstUnreach,
	vendor.ICMPTypePacketTooBig:           vendor.parsePacketTooBig,
	vendor.ICMPTypeTimeExceeded:           vendor.parseTimeExceeded,
	vendor.ICMPTypeParameterProblem:       vendor.parseParamProb,

	vendor.ICMPTypeEchoRequest:         vendor.parseEcho,
	vendor.ICMPTypeEchoReply:           vendor.parseEcho,
	vendor.ICMPTypeExtendedEchoRequest: vendor.parseExtendedEchoRequest,
	vendor.ICMPTypeExtendedEchoReply:   vendor.parseExtendedEchoReply,
}
...
func ParseMessage(proto int, b []byte) (*Message, error) {
	...
	if fn, ok := parseFns[m.Type]; !ok {
		m.Body, err = vendor.parseRawBody(proto, b[4:])
	} else {
