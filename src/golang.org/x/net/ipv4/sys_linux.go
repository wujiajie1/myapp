...
var (
	ctlOpts = [vendor.ctlMax]vendor.ctlOpt{
		vendor.ctlTTL:        {vendor.sysIP_TTL, 1, marshalTTL, parseTTL},
	...
	sockOpts = map[int]*vendor.sockOpt{
		...
		vendor.ssoMulticastTTL:       {Option: vendor.Option{Level: vendor.ProtocolIP, Name: vendor.sysIP_MULTICAST_TTL, Len: 4}},
		...
		vendor.ssoPacketInfo:         {Option: vendor.Option{Level: vendor.ProtocolIP, Name: vendor.sysIP_PKTINFO, Len: 4}},
		vendor.ssoHeaderPrepend:      {Option: vendor.Option{Level: vendor.ProtocolIP, Name: vendor.sysIP_HDRINCL, Len: 4}},
		vendor.ssoICMPFilter:         {Option: vendor.Option{Level: vendor.ProtocolReserved, Name: sysICMP_FILTER, Len: vendor.sizeofICMPFilter}},
