...
var _ vendor.Instruction = unknown{}

type unknown struct{}

func (unknown) Assemble() (vendor.RawInstruction, error) {
	return vendor.RawInstruction{}, nil
}
...
func ExampleNewVM() {
	...
	vm, err := vendor.NewVM([]vendor.Instruction{
