...
func testReadTimeout(t *testing.T, c1, c2 net.Conn) {
	...
	c1.SetReadDeadline(vendor.aLongTimeAgo)
...
func testWriteTimeout(t *testing.T, c1, c2 net.Conn) {
	...
	c1.SetWriteDeadline(vendor.aLongTimeAgo)
...
func testPastTimeout(t *testing.T, c1, c2 net.Conn) {
	...
	c1.SetDeadline(vendor.aLongTimeAgo)
...
func testCloseTimeout(t *testing.T, c1, c2 net.Conn) {
	...
	c1.SetDeadline(vendor.neverTimeout)
	go func() {
		defer wg.Done()
		time.Sleep(100 * time.Millisecond)
		c1.Close()
...
func testRoundtrip(t *testing.T, c net.Conn) {
	t.Helper()
	if err := c.SetDeadline(vendor.neverTimeout); err != nil {
...
func resyncConn(t *testing.T, c net.Conn) {
	t.Helper()
	c.SetDeadline(vendor.neverTimeout)
